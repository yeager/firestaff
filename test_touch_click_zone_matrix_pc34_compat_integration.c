...
int main(void) {
    ...
    if (!expect_zone(0u, 1u, 68u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 234, 125, 28, 21, "movement.turn_left")) ok = 0;
    if (!expect_zone(1u, 3u, 70u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 263, 125, 27, 21, "movement.forward")) ok = 0;
    if (!expect_zone(13u, 111u, 11u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 233, 77, 87, 45, "action.parent")) ok = 0;
    if (!expect_zone(15u, 113u, 82u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 234, 86, 85, 11, "action.row0")) ok = 0;
    if (!expect_zone(19u, 117u, 90u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 255, 86, 20, 35, "action.icon1")) ok = 0;
    if (!expect_zone(23u, 101u, 245u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 235, 51, 13, 11, "spell.symbol1")) ok = 0;
    if (!expect_zone(29u, 108u, 252u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 234, 63, 70, 11, "spell.cast")) ok = 0;
    if (!expect_zone(36u, 21u, 212u, TOUCH_CLICK_COORD_SCREEN_RELATIVE_PC34_COMPAT, 24, 10, 16, 16, "champion0.action_hand")) ok = 0;
    if (!expect_zone(50u, 70u, 545u, TOUCH_CLICK_COORD_VIEWPORT_RELATIVE_PC34_COMPAT, 56, 13, 16, 16, "inventory.mouth")) ok = 0;
