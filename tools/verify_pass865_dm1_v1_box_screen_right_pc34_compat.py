...
PASS = "pass865_dm1_v1_box_screen_right_pc34_compat"
STATUS = "PASS865_DM1_V1_BOX_SCREEN_RIGHT_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_screen_right_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_screen_right_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_screen_right_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_screen_right_table_pc34",
    "DATA.C:110",
    "DATA.C:532",
    "G0062_ai_Graphic562_Box_ScreenRight",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_screen_right_pc34_compat",
    "src/dm1/dm1_v1_box_screen_right_pc34_compat.c",
    "NAME dm1_v1_box_screen_right_pc34_compat",
    "verify_pass865_dm1_v1_box_screen_right_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (110, "G0062_ai_Graphic562_Box_ScreenRight"),
        (532, "G0062_ai_Graphic562_Box_ScreenRight"),
        (1351, "G0062_ai_Graphic562_Box_ScreenRight"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_box_screen_right_table_pc34"]),
