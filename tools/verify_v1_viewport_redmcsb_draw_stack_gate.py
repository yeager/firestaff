...
def verify_redmcsb() -> list[str]:
    ...
    rel = require_in_order(
        ...
        [
            ...
            ("creature section after objects", "/* Draw creatures */"),
            ("single centered creature waits for all object cells", "wait until second pass (for a front view door) or until all cells have been drawn so the creature is drawn over all the objects on the floor"),
