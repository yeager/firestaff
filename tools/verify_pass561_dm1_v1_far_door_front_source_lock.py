...
LOCAL = [
    ("firestaff-far-door-front-metadata", ROOT / "src/dm1/dm1_v1_viewport_3d_pc34_compat.c", "932-933", ["DM1_VIEW_SQUARE_D3L2, 0x0218, 0x0349", "DUNVIEW.C:6270 floor ornament under far rear pass", "DM1_VIEW_SQUARE_D3R2, 0x0128, 0x0439", "DUNVIEW.C:6337 floor ornament under mirrored far rear pass"]),
    ...
    ("firestaff-source-evidence-string", ROOT / "src/dm1/dm1_v1_viewport_3d_pc34_compat.c", "3913-3914", ["DUNVIEW.C:6270-6286 D3L2 far door-front occlusion", "DUNVIEW.C:6337-6353 D3R2 mirrored far door-front occlusion"]),
]
def span(path, lines):
