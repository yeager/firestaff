#!/usr/bin/env python3
"""pass835 DM1 V1 box-title-strikes-back-destination contract."""
...
PASS = "pass835_dm1_v1_box_title_strikes_back_destination_pc34_compat"
STATUS = "PASS835_DM1_V1_BOX_TITLE_STRIKES_BACK_DESTINATION_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_title_strikes_back_destination_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_title_strikes_back_destination_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_title_strikes_back_destination_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_title_strikes_back_destination_table_pc34",
    "dm1_v1_box_title_strikes_back_destination_get_pc34",
    "dm1_v1_box_title_strikes_back_destination_x_pc34",
    "kSBDX",
    "kSBDY",
    "kSBDW",
    "kSBDH",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_box_title_strikes_back_destination_pc34_compat",
    "src/dm1/dm1_v1_box_title_strikes_back_destination_pc34_compat.c",
    "NAME dm1_v1_box_title_strikes_back_destination_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (9, "G0003_ai_Graphic562_Box_Title_StrikesBack_Destination"),
        (125, "G0003_ai_Graphic562_Box_Title_StrikesBack_Destination"),
        (545, "G0003_ai_Graphic562_Box_Title_StrikesBack_Destination"),
    ],
    "TITLE.C": [
        (233, "G0003_ai_Graphic562_Box_Title_StrikesBack_Destination"),
        (236, "G0003_ai_Graphic562_Box_Title_StrikesBack_Destination"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "{0, 319, 118, 174}. The {X, Y, W, H} byte-coordinate sub-"
            "rectangle for the Strikes Back title-view backdrop blit "
            "during the door-opening animation. Read sites: "
            "TITLE.C:233/236 F0132_VIDEO_Blit(Strikes Back title "
            "dungeon-view backdrop, G0003, 0, 0, byteWidth, byteWidth, "
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:125/551 + TITLE.C:233/236 line "
        ...
        "nonOverlap": [
            ...
            "Not pass798-832 (Graphics.dat init-table gates batches "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0003_ai_Graphic562_"
        "Box_Title_StrikesBack_Destination[4] = {0, 319, 118, 174}. The "
        "{X, Y, W, H} byte-coordinate sub-rectangle for the "
        "Strikes Back title-view backdrop blit during the door-"
        "opening animation. Read sites: TITLE.C:233/236 "
        "F0132_VIDEO_Blit.",
        "- Runtime assertion floor: 53 assertions in `tests/test_dm1_v1_"
        "box_title_strikes_back_destination_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:125/551, ENTRANCE.C:"
            "178/181/184/187 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_title_strikes_back_destination_pc34_compat")])
    ]
