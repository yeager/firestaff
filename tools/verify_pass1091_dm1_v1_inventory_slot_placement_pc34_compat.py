#!/usr/bin/env python3
"""pass1091 DM1 V1 inventory slot placement rules gate."""
...
PASS = "pass1091_dm1_v1_inventory_slot_placement_pc34_compat"
STATUS = "PASS1091_DM1_V1_INVENTORY_SLOT_PLACEMENT_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_inventory_slot_placement_pc34_compat.c"
HDR = ROOT / "include/dm1_v1_inventory_slot_placement_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_inventory_slot_placement_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "dm1_v1_inventory_slot_placement_probe_pc34",
    "DATA.C:1049-1087",
    "DATA.C:436-466",
    "CHAMPION.C:684-710",
    "CHAMPION.C:1546",
    "G0038_ai_Graphic562_SlotMasks",
    "G0057_ai_Graphic562_SlotDropOrder",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_inventory_slot_placement_pc34_compat",
    "src/dm1/dm1_v1_inventory_slot_placement_pc34_compat.c",
    "NAME dm1_v1_inventory_slot_placement_pc34_compat",
    "verify_pass1091_dm1_v1_inventory_slot_placement_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (1049, "G0038_ai_Graphic562_SlotMasks"),
        (1056, "MASK0x0100_POUCH_AND_PASS_THROUGH_DOORS"),
        (1061, "MASK0x0100_POUCH_AND_PASS_THROUGH_DOORS"),
        (1079, "MASK0xFFFF_ANY_SLOT"),
        (436, "G0057_ai_Graphic562_SlotDropOrder"),
        (466, "G0057_ai_Graphic562_SlotDropOrder"),
    ],
    "CHAMPION.C": [
        (684, "F0302"),
        (697, "AllowedSlots"),
        (701, "F0302"),
        (1546, "G0057_ai_Graphic562_SlotDropOrder"),
    ],
}
...
def resolve_build_dir(binary_name=""):
    ...
    if env_build:
        configured = Path(env_build).expanduser()
        if (configured / "CMakeCache.txt").exists() and (
                not binary_name or (configured / binary_name).exists()):
            return configured
...
def write_outputs(local_checks, redmcsb_checks, runs):
    ...
    manifest = {
        ...
        "scope": "DM1 V1 inventory hand/sheathe/backpack placement rules "
                 "(six rules: hand / body / pouch / quiver / backpack / "
                 "container-reject) routed through DATA.C G0038 SlotMasks "
                 "+ DATA.C G0057 SlotDropOrder reverse priority + CHAMPION.C "
                 "F0302:684-710 leader-hand/slot swap contract.",
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "nonOverlap": [
            ...
            "Not pass809 (slot masks table).",
            "Not pass863 (slot drop order table).",
            "Not pass792 (steal-from-slot-indices).",
            "Not earlier hand/belt/quiver/pouch/backpack inventory gates.",
        ],
    }
