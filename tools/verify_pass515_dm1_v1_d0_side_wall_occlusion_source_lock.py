...
FIRESTAFF_CHECKS = [
    {"id":"firestaff_existing_d0_side_wall_specs_cite_return_lines","path":ROOT/"src/dm1/dm1_v1_viewport_3d_pc34_compat.c","lines":"1244-1248","claim":"Existing runtime metadata records direct D0 side-wall return evidence.","ordered":[
    ...
    {"id":"firestaff_existing_d0_side_occlusion_orders_are_single_back_cells","path":ROOT/"src/dm1/dm1_v1_viewport_3d_pc34_compat.c","lines":"1026-1029","claim":"Open D0 side lanes use one back cell each; wall is a separate return path.","ordered":[
    ...
    {"id":"firestaff_viewport_test_covers_d0_side_wall_specs","path":ROOT/"tests/test_dm1_v1_viewport_3d_pc34_compat.c","lines":"851-855","claim":"Focused runtime test asserts D0 side return lines and zone/wall pairing.","ordered":[
