...
FIRESTAFF_CHECKS = [
    {"id":"firestaff_existing_d0_side_wall_specs_cite_return_lines","path":ROOT/"src/dm1/dm1_v1_viewport_3d_pc34_compat.c","lines":"473-474","claim":"Existing runtime metadata records direct D0 side-wall return evidence.","ordered":[
