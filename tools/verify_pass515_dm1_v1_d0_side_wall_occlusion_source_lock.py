...
FIRESTAFF_CHECKS = [
    {"id":"firestaff_existing_d0_side_wall_specs_cite_return_lines","path":ROOT/"dm1_v1_viewport_3d_pc34_compat.c","lines":"289-310","claim":"Existing runtime metadata records direct D0 side-wall return evidence.","ordered":[
    ...
    {"id":"firestaff_existing_d0_side_occlusion_orders_are_single_back_cells","path":ROOT/"dm1_v1_viewport_3d_pc34_compat.c","lines":"146-167","claim":"Open D0 side lanes use one back cell each; wall is a separate return path.","ordered":[
    ...
    {"id":"firestaff_viewport_test_covers_d0_side_wall_specs","path":ROOT/"test_dm1_v1_viewport_3d_pc34_compat.c","lines":"237-258","claim":"Focused runtime test asserts D0 side return lines and zone/wall pairing.","ordered":[
