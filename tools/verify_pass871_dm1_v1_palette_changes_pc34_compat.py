...
PASS = "pass871_dm1_v1_palette_changes_pc34_compat"
STATUS = "PASS871_DM1_V1_PALETTE_CHANGES_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_changes_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_changes_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_changes_pc34_compat.c"
...
ANCHORS = [
    "DATA.C:421/2145/2152/2454",
    "IO.C cursor/champion-icon blit path",
]

LOCAL_NEEDLES = [
    "dm1_v1_palette_changes_table_pc34",
    "DATA.C:421",
    "IO.C:2145",
    "G4011_auc_PaletteChanges",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_changes_pc34_compat",
    "src/dm1/dm1_v1_palette_changes_pc34_compat.c",
    "NAME dm1_v1_palette_changes_pc34_compat",
    "verify_pass871_dm1_v1_palette_changes_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (421, "G4011_auc_PaletteChanges"),
    ],
    "IO.C": [
        (2145, "G4011_auc_PaletteChanges"),
        (2152, "G4011_auc_PaletteChanges"),
        (2454, "G4011_auc_PaletteChanges"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_palette_changes_table_pc34"]),
