...
LOCAL = [
    ...
    # lives at src lines 1008-1022; the runtime-test table and its
    ...
    ("firestaff-mirrored-door-front-metadata", ROOT / "src/dm1/dm1_v1_viewport_3d_pc34_compat.c", "1008-1022", [
    ...
    ("firestaff-mirrored-door-front-runtime-test", ROOT / "tests/test_dm1_v1_viewport_3d_pc34_compat.c", "1743-1810", [
