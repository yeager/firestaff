...
PASS = "pass868_dm1_v1_print_text_masks1_pc34_compat"
STATUS = "PASS868_DM1_V1_PRINT_TEXT_MASKS1_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_print_text_masks1_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/print_text_masks1_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_print_text_masks1_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_print_text_masks1_table_pc34",
    "DATA.C:113",
    "DATA.C:535",
    "G0065_al_Graphic562_PrintTextMasks1",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_print_text_masks1_pc34_compat",
    "src/dm1/dm1_v1_print_text_masks1_pc34_compat.c",
    "NAME dm1_v1_print_text_masks1_pc34_compat",
    "verify_pass868_dm1_v1_print_text_masks1_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (113, "G0065_al_Graphic562_PrintTextMasks1"),
        (535, "G0065_al_Graphic562_PrintTextMasks1"),
        (1356, "G0065_al_Graphic562_PrintTextMasks1"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_print_text_masks1_table_pc34"]),
