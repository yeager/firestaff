#!/usr/bin/env python3
"""DM1 V1 entrance_closed_door_left contract (PASS841)."""
...
PASS = "pass841_dm1_v1_entrance_closed_door_left_pc34_compat"
STATUS = "PASS841_DM1_V1_ENTRANCE_CLOSED_DOOR_LEFT_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_entrance_closed_door_left_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/entrance_closed_door_left_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_entrance_closed_door_left_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_entrance_closed_door_left_table_pc34",
    "dm1_v1_entrance_closed_door_left_get_pc34",
    "dm1_v1_entrance_closed_door_left_x_pc34",
    "dm1_v1_entrance_closed_door_left_y_pc34",
    "dm1_v1_entrance_closed_door_left_w_pc34",
    "dm1_v1_entrance_closed_door_left_h_pc34",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_entrance_closed_door_left_pc34_compat",
    "src/dm1/dm1_v1_entrance_closed_door_left_pc34_compat.c",
    "NAME dm1_v1_entrance_closed_door_left_pc34_compat",
    "verify_" + PASS,
]
...
def main():
    checks = [
        ...
        check_needles('header', HDR, ['dm1_v1_entrance_closed_door_left_table_pc34']),
        check_needles('test', TEST, ['test_table_values', 'test_components_non_negative']),
        check_needles('cmake', CMAKE, CMAKE_NEEDLES),
    ]
    runs = [run([str(ROOT / "build" / "test_dm1_v1_entrance_closed_door_left_pc34_compat")])]
    ...
    manifest = {
        ...
        'scope': 'DM1 V1 entrance_closed_door_left contract.',
        'anchors': ANCHORS,
        'redmcsbRoot': str(RED),
        'sourceChecks': checks,
