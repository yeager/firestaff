...
LOCAL_LOCKS=[("src/dm1/dm1_v1_input_command_queue_pc34_compat.c","case 0xAB35: case 0x9B41: case 0x9B54: case 0x004C:"),("src/dm1/dm1_v1_input_command_queue_pc34_compat.c","result.movementDisabledGate = 1;"),("tests/test_dm1_v1_input_command_queue_pc34_compat.c","pc34 table up arrow moves forward"),("tests/test_dm1_v1_input_command_queue_pc34_compat.c","redmcsb queue holds five commands"),("tests/test_dm1_v1_input_command_queue_pc34_compat.c","projectile matching direction keeps command queued")]
