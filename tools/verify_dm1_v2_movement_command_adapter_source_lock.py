...
FIRESTAFF_REQUIRED = [
    ...
    (ROOT / 'include/dm1_v2_movement_command_adapter_pc34.h', 'DM1_V2_MOVEMENT_ROUTE_V1_SOURCE'),
    (ROOT / 'include/dm1_v2_movement_command_adapter_pc34.h', 'dm1_v2_movement_command_route_for_presentation'),
    (ROOT / 'tests/test_dm1_v2_movement_command_adapter_pc34.c', 'COMMAND.C dispatches C001/C002'),
    (ROOT / 'tests/test_dm1_v2_movement_command_adapter_pc34.c', 'DEFS.H:238-243 owns the V1 command ids'),
    (ROOT / 'tests/test_dm1_v2_movement_command_adapter_pc34.c', 'COMMAND.C:2045-2155 consumes those ids'),
