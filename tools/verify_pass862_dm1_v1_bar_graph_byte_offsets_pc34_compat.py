...
PASS = "pass862_dm1_v1_bar_graph_byte_offsets_pc34_compat"
STATUS = "PASS862_DM1_V1_BAR_GRAPH_BYTE_OFFSETS_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_bar_graph_byte_offsets_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/bar_graph_byte_offsets_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_bar_graph_byte_offsets_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_bar_graph_byte_offsets_table_pc34",
    "DATA.C:99",
    "CHAMDRAW.C:204",
    "G0056_aaui_Graphic562_BarGraphByteOffsets",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_bar_graph_byte_offsets_pc34_compat",
    "src/dm1/dm1_v1_bar_graph_byte_offsets_pc34_compat.c",
    "NAME dm1_v1_bar_graph_byte_offsets_pc34_compat",
    "verify_pass862_dm1_v1_bar_graph_byte_offsets_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (99, "G0056_aaui_Graphic562_BarGraphByteOffsets"),
        (104, "G0056_aaui_Graphic562_BarGraphByteOffsets"),
    ],
    "CHAMDRAW.C": [
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_bar_graph_byte_offsets_table_pc34"]),
