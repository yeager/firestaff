...
def firestaff_rows() -> list[dict[str, str]]:
    ...
    checks = [
        ...
        ("src/dm1/dm1_v1_movement_command_core_pc34_compat.c", "DM1_V1_MovementCommandCore_ProcessOnePc34Compat", files["core"], ["dm1_v1_apply_pre_step_stamina_plan", "dm1_v1_dungeon_resolve_stairs_transition_pc34", "F0708_MOVEMENT_IsPartyStepBlockedByGroup_Compat", "DM1_V1_InputCommandQueue_DiscardAllInputPc34Compat(queue);", "DM1_V1_MovementTiming_ApplySuccessfulStepPc34Compat"], "stamina/stairs/group/input-discard/timing command seam."),
