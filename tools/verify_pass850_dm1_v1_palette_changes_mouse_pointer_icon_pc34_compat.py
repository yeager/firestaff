#!/usr/bin/env python3
"""pass850 DM1 V1 palette-changes-mouse-pointer-icon contract."""
...
PASS = "pass850_dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat"
STATUS = "PASS850_DM1_V1_PALETTE_CHANGES_MOUSE_POINTER_ICON_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_changes_mouse_pointer_icon_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_palette_changes_mouse_pointer_icon_table_pc34",
    "dm1_v1_palette_changes_mouse_pointer_icon_get_pc34",
    "kTableSize",
    "kOutOfRange",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat",
    "src/dm1/dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat.c",
    "NAME dm1_v1_palette_changes_mouse_pointer_icon_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (40, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (181, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (583, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
    ],
    "IO.C": [
        (164, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (2140, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (2167, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (2176, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
        (2443, "G0044_auc_Graphic562_PaletteChanges_MousePointerIcon"),
    ],
}
