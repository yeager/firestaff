...
PASS = "pass870_dm1_v1_palette_changes_cursor_mask_pc34_compat"
STATUS = "PASS870_DM1_V1_PALETTE_CHANGES_CURSOR_MASK_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_changes_cursor_mask_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_changes_cursor_mask_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_changes_cursor_mask_pc34_compat.c"
...
ANCHORS = [
    "DATA.C:420/2144/2151",
    "IO.C cursor blit path",
]

LOCAL_NEEDLES = [
    "dm1_v1_palette_changes_cursor_mask_table_pc34",
    "DATA.C:420",
    "IO.C:2144",
    "G4010_auc_PaletteChanges_CursorMask",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_changes_cursor_mask_pc34_compat",
    "src/dm1/dm1_v1_palette_changes_cursor_mask_pc34_compat.c",
    "NAME dm1_v1_palette_changes_cursor_mask_pc34_compat",
    "verify_pass870_dm1_v1_palette_changes_cursor_mask_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (420, "G4010_auc_PaletteChanges_CursorMask"),
    ],
    "IO.C": [
        (2144, "G4010_auc_PaletteChanges_CursorMask"),
        (2151, "G4010_auc_PaletteChanges_CursorMask"),
    ],
}
...
def resolve_build_dir(binary_name=""):
    ...
    candidates = ([Path(configured)] if configured else []) + [ROOT / "build", ROOT / "builds" / "nv1-build",
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_palette_changes_cursor_mask_table_pc34"]),
