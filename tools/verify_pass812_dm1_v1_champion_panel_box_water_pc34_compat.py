#!/usr/bin/env python3
"""pass812 DM1 V1 champion-panel-box-water contract."""
...
PASS = "pass812_dm1_v1_champion_panel_box_water_pc34_compat"
STATUS = "PASS812_DM1_V1_CHAMPION_PANEL_BOX_WATER_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_champion_panel_box_water_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/champion_panel_box_water_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_panel_box_water_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_champion_panel_box_water_table_pc34",
    "dm1_v1_champion_panel_box_water_get_pc34",
    "dm1_v1_champion_panel_box_water_x_pc34",
    "kWaterX",
    "kWaterY",
    "kWaterW",
    "kWaterH",
    "kFoodX",
    "G0036_ai_Graphic562_Box_Water",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_champion_panel_box_water_pc34_compat",
    "src/dm1/dm1_v1_champion_panel_box_water_pc34_compat.c",
    "NAME dm1_v1_champion_panel_box_water_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (42, "G0036_ai_Graphic562_Box_Water"),
        (318, "G0036_ai_Graphic562_Box_Water"),
        (1036, "G0036_ai_Graphic562_Box_Water"),
    ],
    "PANEL.C": [
        (1586, "G0036_ai_Graphic562_Box_Water"),
        (1590, "G0036_ai_Graphic562_Box_Water"),
        (1594, "G0036_ai_Graphic562_Box_Water"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0036_ai_Graphic562_Box_Water[4] = {112, 159, 83, 91}. "
            "The {X, Y, W, H} pixel-coordinate rectangle for the "
            "water status label blit (paired with food label G0035 "
            "which shares the same X). Read sites: PANEL.C:1586/1590/"
            "1594 F0344_INVENTORY_DrawPanel — blit C031_GRAPHIC_"
            "WATER_LABEL into G0036's box with byte widths C024/C032/"
            "C024 for English/German/French localizations."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:318/1036 + PANEL.C:1586/1590/1594 line "
        ...
        "nonOverlap": [
            ...
            "Not pass798-811 (Graphics.dat init-table gates batches "
            "1+2+3+4).",
        ],
    }
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0036_ai_Graphic562_"
        "Box_Water[4] = {112, 159, 83, 91}. The {X, Y, W, H} pixel-"
        "coordinate rectangle for the water status label blit "
        "(paired with food label G0035, same X). PANEL.C F0344_"
        "INVENTORY_DrawPanel calls M519_F0020_MAIN_BlitToViewport("
        "C031_GRAPHIC_WATER_LABEL, G0036, byteWidth, C12_COLOR_"
        "DARKEST_GRAY, 9) with byte widths C024/C032/C024 for "
        "English/German/French localizations.",
        "- Runtime assertion floor: 48 assertions in `tests/test_dm1_v1_"
        "champion_panel_box_water_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:318/1036, PANEL.C:"
            "1586/1590/1594 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_champion_panel_box_water_pc34_compat")])
    ]
