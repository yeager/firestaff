#!/usr/bin/env python3
"""pass830 DM1 V1 box-spell-area contract."""
...
PASS = "pass830_dm1_v1_box_spell_area_pc34_compat"
STATUS = "PASS830_DM1_V1_BOX_SPELL_AREA_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_spell_area_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_spell_area_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_spell_area_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_spell_area_table_pc34",
    "dm1_v1_box_spell_area_get_pc34",
    "dm1_v1_box_spell_area_x_pc34",
    "kSpellX",
    "kSpellY",
    "kSpellW",
    "kSpellH",
    "G0000_ai_Graphic562_Box_SpellArea",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_spell_area_pc34_compat",
    "src/dm1/dm1_v1_box_spell_area_pc34_compat.c",
    "NAME dm1_v1_box_spell_area_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (6, "G0000_ai_Graphic562_Box_SpellArea"),
        (119, "G0000_ai_Graphic562_Box_SpellArea"),
        (539, "G0000_ai_Graphic562_Box_SpellArea"),
    ],
    "CASTER.C": [
        (24, "G0000_ai_Graphic562_Box_SpellArea"),
        (31, "G0000_ai_Graphic562_Box_SpellArea"),
    ],
    "STARTUP2.C": [
        (376, "G0000_ai_Graphic562_Box_SpellArea"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0000_ai_Graphic562_Box_SpellArea[4] = {224, 319, 42, 74}. "
            "The {X, Y, W, H} byte-coordinate sub-rectangle for the "
            "spell-area background blit on the champion panel. Read "
            "sites: CASTER.C:24 M520_F0021_MAIN_BlitToScreen (spell-"
            "area background blit), CASTER.C:31 M524_FillScreenBox "
            "(clear), STARTUP2.C:376 F0136_VIDEO_HatchScreenBox (hatch)."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:119/539 + CASTER.C:24/31 + STARTUP2.C:376 "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0000_ai_Graphic562_"
        "Box_SpellArea[4] = {224, 319, 42, 74}. The {X, Y, W, H} "
        "byte-coordinate sub-rectangle for the spell-area background "
        "blit on the champion panel. Read sites: CASTER.C:24/31 + "
        "STARTUP2.C:376 (spell-area blit + clear + hatch).",
        "- Runtime assertion floor: 54 assertions in `tests/test_dm1_v1_"
        "box_spell_area_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:119/539, CASTER.C:24/"
            "31, STARTUP2.C:376 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_spell_area_pc34_compat")])
    ]
