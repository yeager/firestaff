#!/usr/bin/env python3
"""pass837 DM1 V1 box-title-presents contract."""
...
PASS = "pass837_dm1_v1_box_title_presents_pc34_compat"
STATUS = "PASS837_DM1_V1_BOX_TITLE_PRESENTS_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_title_presents_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_title_presents_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_title_presents_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_title_presents_table_pc34",
    "dm1_v1_box_title_presents_get_pc34",
    "dm1_v1_box_title_presents_x_pc34",
    "kPresX",
    "kPresY",
    "kPresW",
    "kPresH",
    "G0005_ai_Graphic562_Box_Title_Presents",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_title_presents_pc34_compat",
    "src/dm1/dm1_v1_box_title_presents_pc34_compat.c",
    "NAME dm1_v1_box_title_presents_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (10, "G0005_ai_Graphic562_Box_Title_Presents"),
        (127, "G0005_ai_Graphic562_Box_Title_Presents"),
        (547, "G0005_ai_Graphic562_Box_Title_Presents"),
    ],
    "TITLE.C": [
        (126, "G0005_ai_Graphic562_Box_Title_Presents"),
        (129, "G0005_ai_Graphic562_Box_Title_Presents"),
        (321, "G0005_ai_Graphic562_Box_Title_Presents"),
        (324, "G0005_ai_Graphic562_Box_Title_Presents"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0005_ai_Graphic562_Box_Title_Presents[4] = "
            "{0, 319, 90, 105}. The {X, Y, W, H} byte-coordinate sub-"
            "rectangle for the Title-Presents title screen source "
            "blit. Read sites: TITLE.C:126/129/321/324 F0132_VIDEO_"
            "Blit(Title Presents source, G0005, 0, 80, C160_BYTE_"
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:129/547 + TITLE.C:126/129/321/324 line "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0005_ai_Graphic562_"
        "Box_Title_Presents[4] = {0, 319, 90, 105}. The "
        "{X, Y, W, H} byte-coordinate sub-rectangle for the "
        "Title-Presents title screen source blit. Read sites: "
        "TITLE.C:126/129/321/324 F0132_VIDEO_Blit.",
        "- Runtime assertion floor: 53 assertions in `tests/test_dm1_v1_"
        "box_title_presents_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:129/547, TITLE.C:"
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_title_presents_pc34_compat")])
    ]
