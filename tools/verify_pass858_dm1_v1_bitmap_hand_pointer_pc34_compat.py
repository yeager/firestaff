...
PASS = "pass858_dm1_v1_bitmap_hand_pointer_pc34_compat"
STATUS = "PASS858_DM1_V1_BITMAP_HAND_POINTER_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_bitmap_hand_pointer_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/bitmap_hand_pointer_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_bitmap_hand_pointer_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "DATA.C:385",
    "DATA.C:410",
    "G0043_auc_Graphic562_Bitmap_HandPointer",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_bitmap_hand_pointer_pc34_compat",
    "src/dm1/dm1_v1_bitmap_hand_pointer_pc34_compat.c",
    "NAME dm1_v1_bitmap_hand_pointer_pc34_compat",
    "verify_pass858_dm1_v1_bitmap_hand_pointer_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (65, "G0043_auc_Graphic562_Bitmap_HandPointer"),
        (385, "G0043_auc_Graphic562_Bitmap_HandPointer"),
        (410, "G0043_auc_Graphic562_Bitmap_HandPointer"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_bitmap_hand_pointer_plane_pc34"]),
