#!/usr/bin/env python3
"""pass851 DM1 V1 palette-changes-mouse-pointer-icon-shadow contract."""
...
PASS = "pass851_dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat"
STATUS = "PASS851_DM1_V1_PALETTE_CHANGES_MOUSE_POINTER_ICON_SHADOW_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_changes_mouse_pointer_icon_shadow_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_palette_changes_mouse_pointer_icon_shadow_table_pc34",
    "dm1_v1_palette_changes_mouse_pointer_icon_shadow_get_pc34",
    "kTableSize",
    "kOutOfRange",
    "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat",
    "src/dm1/dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat.c",
    "NAME dm1_v1_palette_changes_mouse_pointer_icon_shadow_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (41, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
        (183, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
        (585, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
    ],
    "IO.C": [
        (165, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
        (1708, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
        (1711, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
        (2041, "G0045_auc_Graphic562_PaletteChanges_MousePointerIconShadow"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, [LOCAL_NEEDLES[0]]),
        check_needles("test_entry_and_assertions", TEST,
                      ["test_table_values", "test_lookup_function",
                       "test_first_last_specific", "test_entry_12_specific",
                       "test_run_accepted", "assertions passed"]),
