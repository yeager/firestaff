#!/usr/bin/env python3
"""pass817 DM1 V1 champion-portrait-box-mouth contract."""
...
PASS = "pass817_dm1_v1_champion_portrait_box_mouth_pc34_compat"
STATUS = "PASS817_DM1_V1_CHAMPION_PORTRAIT_BOX_MOUTH_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_champion_portrait_box_mouth_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/champion_portrait_box_mouth_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_portrait_box_mouth_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_champion_portrait_box_mouth_table_pc34",
    "dm1_v1_champion_portrait_box_mouth_get_pc34",
    "dm1_v1_champion_portrait_box_mouth_x_pc34",
    "kMouthX",
    "kMouthY",
    "kMouthW",
    "kMouthH",
    "G0048_ai_Graphic562_Box_Mouth",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_champion_portrait_box_mouth_pc34_compat",
    "src/dm1/dm1_v1_champion_portrait_box_mouth_pc34_compat.c",
    "NAME dm1_v1_champion_portrait_box_mouth_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (79, "G0048_ai_Graphic562_Box_Mouth"),
        (423, "G0048_ai_Graphic562_Box_Mouth"),
        (1095, "G0048_ai_Graphic562_Box_Mouth"),
    ],
    "CHAMDRAW.C": [
        (914, "G0048_ai_Graphic562_Box_Mouth"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "champion-portrait mouth-overlay blit. Read site: "
            "CHAMDRAW.C:914 F0294_CHAMPION_DrawChampionPortraitMouth "
            "blits the mouth graphic into G0048's box with byte "
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:423/1095 + CHAMDRAW.C:914 line numbers "
    ...
    lines = [
        ...
        "Box_Mouth[4] = {55, 72, 12, 29}. The {X, Y, W, H} pixel-"
        "coordinate rectangle for the champion-portrait mouth-overlay "
        "blit. CHAMDRAW.C F0294_CHAMPION_DrawChampionPortraitMouth "
        "calls M519_F0020_MAIN_BlitToViewport(nativeBitmap, "
        "G0048, C016_BYTE_WIDTH, C12_COLOR_DARKEST_GRAY, 18) to "
        "blit the mouth graphic on top of the portrait when the "
        "champion is mid-action.",
        "- Runtime assertion floor: 52 assertions in `tests/test_dm1_v1_"
        "champion_portrait_box_mouth_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:423/1095, "
            "CHAMDRAW.C:914 in next source refresh."
        )
...
def main() -> int:
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, [
            "dm1_v1_champion_portrait_box_mouth_table_pc34",
            "DM1_V1_ChampionPortraitBoxMouthResultPc34",
        ]),
        check_needles(
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_champion_portrait_box_mouth_pc34_compat")])
    ]
