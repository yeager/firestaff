...
FIRESTAFF_CHECKS = [
    ...
    },
    {
        ...
        "lines": "1-9999",
        "claim": "Current runtime assertions cover source-row clipping and the D3 through D0 side-wall pixel routes, including their ReDMCSB frame and source-clip evidence.",
        "ordered": [
            ...
            "wall_clip_draw.source_offset_last_row",
