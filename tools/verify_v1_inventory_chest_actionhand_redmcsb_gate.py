...
SOURCE_RANGES = [
    ...
    {"file": "m11_game_view.c", "start": 18885, "end": 18895},
    {"file": "m11_game_view.c", "start": 19054, "end": 19072},
]
...
def verify_firestaff_seam() -> list[str]:
    ...
    require_excerpt("m11_game_view.c", 18885, 18895, ["m11_object_icon_index_for_thing", "m11_draw_dm_object_icon_index"])
    require_excerpt("m11_game_view.c", 19054, 19072, ["M11_GameView_GetV1InventorySourceSlotBoxForChampionSlot", "m11_draw_dm_object_icon_index", "return;"])
    return [
