...
SOURCE_RANGES = [
    ...
    {"file": "m11_game_view.c", "start": 18881, "end": 18891},
    {"file": "m11_game_view.c", "start": 19050, "end": 19068},
]
...
def verify_firestaff_seam() -> list[str]:
    ...
    require_excerpt("m11_game_view.c", 18881, 18891, ["m11_object_icon_index_for_thing", "m11_draw_dm_object_icon_index"])
    require_excerpt("m11_game_view.c", 19050, 19068, ["M11_GameView_GetV1InventorySourceSlotBoxForChampionSlot", "m11_draw_dm_object_icon_index", "return;"])
    return [
