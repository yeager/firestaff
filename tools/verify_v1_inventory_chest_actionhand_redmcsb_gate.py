...
SOURCE_RANGES = [
    ...
    {"file": "m11_game_view.c", "start": 19614, "end": 19616},
    {"file": "m11_game_view.c", "start": 19815, "end": 19831},
]
...
def verify_firestaff_seam() -> list[str]:
    ...
    require_excerpt("m11_game_view.c", 19614, 19616, ["m11_object_icon_index_for_thing", "m11_draw_dm_object_icon_index"])
    require_excerpt("m11_game_view.c", 19815, 19831, ["M11_GameView_GetV1InventorySourceSlotBoxForChampionSlot", "m11_draw_dm_object_icon_index", "return;"])
    return [
