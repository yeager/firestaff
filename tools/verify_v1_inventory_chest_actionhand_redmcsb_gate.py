...
SOURCE_RANGES = [
    ...
    {"file": "m11_game_view.c", "start": 19472, "end": 19483},
    {"file": "m11_game_view.c", "start": 19641, "end": 19659},
]
...
def verify_firestaff_seam() -> list[str]:
    ...
    require_excerpt("m11_game_view.c", 19472, 19483, ["m11_object_icon_index_for_thing", "m11_draw_dm_object_icon_index"])
    require_excerpt("m11_game_view.c", 19641, 19659, ["M11_GameView_GetV1InventorySourceSlotBoxForChampionSlot", "m11_draw_dm_object_icon_index", "return;"])
    return [
