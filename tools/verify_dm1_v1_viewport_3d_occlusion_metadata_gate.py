...
DEFAULT_REDMCSB = Path.home() / ".firestaff/data/firestaff-redmcsb-source/ReDMCSB_WIP20210206/Toolchains/Common/Source/DUNVIEW.C"
...
DOOR_CASES: tuple[tuple[str, tuple[int, int], tuple[str, ...], tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "DUNVIEW.C:6443 floor ornament under rear pass",
            "DUNVIEW.C:6444 pass1 rear cells before left frame",
    ...
    (
        ...
        (
            ...
            "DUNVIEW.C:6722 floor ornament under rear pass",
            "DUNVIEW.C:6723 pass1 rear cells before frame",
            "DUNVIEW.C:6737-6739 optional button before door panel",
