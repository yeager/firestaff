#!/usr/bin/env python3
"""Verify pass812 — DM1 V1 chest close while party rotate pickup pending."""
...
TEST = ROOT / "tests/test_dm1_v1_chest_close_while_party_rotate_pickup_pending_pc34_compat.c"
...
RED = (
    ...
    "PANEL.C F0347:1639-1691 (C09_SLOT_BOX_INVENTORY_ACTION_HAND click to "
    "F0302 for the action-hand pickup); "
    "COMMAND.C F0359:1985-1990 (inactive panel side routes); "
    "DEFS.H: C30..C37, C537..C545, G0425, G0426"
)
NEEDLES_T = [
    "F0333", "F0334",
    ...
    "F0359",
    "G0426",
    "C040", "C30", "C34", "C38", "C53", "C54",
    "party", "rotate", "pickup", "close"
]
NEEDLES_H = [
    "F0333", "F0334",
    "F0284", "F0297", "F0298", "F0300", "F0301", "F0302",
...
NEEDLES_C = [
    "test_dm1_v1_chest_close_while_party_rotate_pickup_pending_pc34_compat",
    "src/dm1/dm1_v1_chest_close_while_party_rotate_pickup_pending_pc34_compat.c",
    "NAME dm1_v1_chest_close_while_party_rotate_pickup_pending_pc34_compat",
    f"verify_{PASS}",
]
