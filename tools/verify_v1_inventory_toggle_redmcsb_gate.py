...
RANGES = [
    ...
    ("m11_game_view.c",5188,5191), ("m11_game_view.c",20411,20417),
]
...
def verify_firestaff() -> list[str]:
    ...
    excerpt("m11_game_view.c",20411,20417,["M11_GameView_ToggleInventoryPanel","inventoryPanelActive","inventorySelectedSlot = 0"])
    return notes
