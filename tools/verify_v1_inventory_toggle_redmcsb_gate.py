...
RANGES = [
    ...
    ("m11_game_view.c",5376,5379), ("m11_game_view.c",20934,20941),
]
...
def verify_firestaff() -> list[str]:
    ...
    excerpt("m11_game_view.c",20934,20941,["M11_GameView_ToggleInventoryPanel","inventoryPanelActive","inventorySelectedSlot = 0"])
    return notes
