...
RANGES = [
    ...
    ("m11_game_view.c",5507,5509), ("m11_game_view.c",21170,21175),
]
...
def verify_firestaff() -> list[str]:
    ...
    excerpt("m11_game_view.c",5507,5509,["M12_MENU_INPUT_INVENTORY_TOGGLE","mapOverlayActive = 0","M11_GameView_ToggleInventoryPanel"])
    excerpt("m11_game_view.c",21170,21175,["M11_GameView_ToggleInventoryPanel","inventoryPanelActive","inventorySelectedSlot = 0"])
    return notes
