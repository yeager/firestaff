...
RANGES = [
    ...
    ("m11_game_view.c",5200,5203), ("m11_game_view.c",20600,20610),
]
...
def verify_firestaff() -> list[str]:
    ...
    excerpt("m11_game_view.c",5200,5203,["M12_MENU_INPUT_INVENTORY_TOGGLE","mapOverlayActive = 0","M11_GameView_ToggleInventoryPanel"])
    excerpt("m11_game_view.c",20600,20610,["M11_GameView_ToggleInventoryPanel","inventoryPanelActive","inventorySelectedSlot = 0"])
    return notes
