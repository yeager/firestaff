...
ANCHORS = [
    ...
    {"id": "firestaff_m12_launch_intent_accepts_available_csb", "role": "firestaff_positive", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "7440-7513", "needles": ["M12_StartupMenu_GetLaunchIntent", "m12_game_supported(intent.gameId)", "M12_AssetStatus_GameAvailable(&state->assetStatus, intent.gameId)", "version && version->matched ? 1 : 0"]},
