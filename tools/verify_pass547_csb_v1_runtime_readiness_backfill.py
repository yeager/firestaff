...
ANCHORS = [
    ...
    {"id": "firestaff_m12_launch_guard_supports_csb", "role": "firestaff_positive", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "2327-2337", "needles": ["All five catalogued games now have runtime launch boundaries", "strcmp(gameId, \"csb\") == 0"]},
    {"id": "firestaff_m12_launch_intent_accepts_available_csb", "role": "firestaff_positive", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "7440-7512", "needles": ["M12_StartupMenu_GetLaunchIntent", "m12_game_supported(intent.gameId)", "M12_AssetStatus_GameAvailable(&state->assetStatus, intent.gameId)", "version && version->matched ? 1 : 0"]},
    {"id": "firestaff_m11_csb_handoff_to_game_loop", "role": "firestaff_positive", "path": ROOT / "src/engine/m11_game_view.c", "lines": "6673-6705", "needles": ["FS_GAME_CSB path in firestaff_game_loop.c", "CSB READY (FS LOOP)", "CSB READY: gameId=csb dataDir=%s"]},
