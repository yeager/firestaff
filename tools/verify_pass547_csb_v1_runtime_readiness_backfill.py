...
ANCHORS = [
    ...
    {"id": "firestaff_m12_launch_guard_still_blocks_csb", "role": "firestaff_guard", "path": ROOT / "menu_startup_m12.c", "lines": "1408-1414", "needles": ["Only DM1 is launch-supported", "strcmp(gameId, \"dm1\") == 0"]},
    {"id": "firestaff_m11_original_handoff_is_dm1_title_first", "role": "firestaff_blocker", "path": ROOT / "main_loop_m11.c", "lines": "196-270", "needles": ["m11_find_title_dat_for_intro", "M12_AssetStatus_GetVersionCount(\"dm1\")", "_canonical/dm1/TITLE"]},
    {"id": "firestaff_m11_runtime_open_runs_original_dm1_handoff", "role": "firestaff_blocker", "path": ROOT / "main_loop_m11.c", "lines": "698-728", "needles": ["m11_open_requested_launch", "m11_play_redmcsb_title_intro_if_available", "M11_GameView_OpenSelectedMenuEntry", "m11_play_redmcsb_entrance_transition"]},
    {"id": "firestaff_m11_builtin_csb_path_is_not_atari_csb_manifest", "role": "firestaff_blocker", "path": ROOT / "m11_game_view.c", "lines": "1003-1015", "needles": ["m11_resolve_builtin_dungeon_path", "strcmp(gameId, \"csb\") == 0", "\"CSB.DAT\""]},
