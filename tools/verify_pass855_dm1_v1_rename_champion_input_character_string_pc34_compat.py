...
SRC = ROOT / "src/dm1/dm1_v1_rename_champion_input_character_string_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/rename_champion_input_character_string_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_rename_champion_input_character_string_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "DATA.C:90",
    "DATA.C:429",
    "G0052_ac_Graphic562_RenameChampionInputCharacterString",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_rename_champion_input_character_string_pc34_compat",
    "src/dm1/dm1_v1_rename_champion_input_character_string_pc34_compat.c",
    "NAME dm1_v1_rename_champion_input_character_string_pc34_compat",
    "verify_pass855_dm1_v1_rename_champion_input_character_string_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (90, "G0052_ac_Graphic562_RenameChampionInputCharacterString"),
        (429, "G0052_ac_Graphic562_RenameChampionInputCharacterString"),
        (1105, "G0052_ac_Graphic562_RenameChampionInputCharacterString"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_rename_champion_input_character_string_table_pc34"]),
