...
PASS = "pass853_dm1_v1_wound_defense_factor_pc34_compat"
STATUS = "PASS853_DM1_V1_WOUND_DEFENSE_FACTOR_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_wound_defense_factor_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/wound_defense_factor_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_wound_defense_factor_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "DATA.C:427",
    "CHAMPION.C:1346",
    "G0050_auc_Graphic562_WoundDefenseFactor",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_wound_defense_factor_pc34_compat",
    "src/dm1/dm1_v1_wound_defense_factor_pc34_compat.c",
    "NAME dm1_v1_wound_defense_factor_pc34_compat",
    "verify_pass853_dm1_v1_wound_defense_factor_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (88, "G0050_auc_Graphic562_WoundDefenseFactor"),
        (427, "G0050_auc_Graphic562_WoundDefenseFactor"),
        (1103, "G0050_auc_Graphic562_WoundDefenseFactor"),
    ],
    "CHAMPION.C": [
        (1346, "G0050_auc_Graphic562_WoundDefenseFactor"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_wound_defense_factor_table_pc34"]),
