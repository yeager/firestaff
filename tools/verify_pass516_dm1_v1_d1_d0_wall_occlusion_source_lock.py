...
LOCAL_CHECKS = [
    {"id": "local-d1-d0-wall-specs-present", "path": ROOT / "src/dm1/dm1_v1_viewport_3d_pc34_compat.c", "lines": "1168-1172", "claim": "Firestaff exposes D1/D0 wall metadata with ReDMCSB return/alcove source anchors.", "ordered": [
    ...
    {"id": "local-side-occlusion-d1-d0-cell-orders-present", "path": ROOT / "src/dm1/dm1_v1_viewport_3d_pc34_compat.c", "lines": "189-193", "claim": "Open side branches keep their source cell-order contracts separate from wall-return blockers.", "ordered": [
