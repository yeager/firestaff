...
LOCAL_CHECKS = [
    {"id": "local-d1-d0-wall-specs-present", "path": ROOT / "dm1_v1_viewport_3d_pc34_compat.c", "lines": "216-220", "claim": "Firestaff exposes D1/D0 wall metadata with ReDMCSB return/alcove source anchors.", "ordered": [
    ...
    {"id": "local-side-occlusion-d1-d0-cell-orders-present", "path": ROOT / "dm1_v1_viewport_3d_pc34_compat.c", "lines": "147-150", "claim": "Open side branches keep their source cell-order contracts separate from wall-return blockers.", "ordered": [
        "DM1_VIEW_SQUARE_D1L, 0x0032",
        "DM1_VIEW_SQUARE_D1R, 0x0041",
        "DM1_VIEW_SQUARE_D0L, 0x0002",
        "DM1_VIEW_SQUARE_D0R, 0x0001",
    ]},
    {"id": "local-runtime-test-covers-d1-d0-wall-occlusion", "path": ROOT / "test_dm1_v1_viewport_3d_pc34_compat.c", "lines": "190-284", "claim": "The narrow runtime test checks D1/D0 zone/pairing and wall item occlusion outcomes.", "ordered": [
        "DM1_VIEW_SQUARE_D1L,  DM1_WALL_D1L,  DM1_WALL_D1R",
        "DM1_VIEW_SQUARE_D1R,  DM1_WALL_D1R,  DM1_WALL_D1L",
        "DM1_VIEW_SQUARE_D1C,  DM1_WALL_D1C,  DM1_WALL_D1C",
        "DM1_VIEW_SQUARE_D0L,  DM1_WALL_D0L,  DM1_WALL_D0R",
