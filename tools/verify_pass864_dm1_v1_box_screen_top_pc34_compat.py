...
PASS = "pass864_dm1_v1_box_screen_top_pc34_compat"
STATUS = "PASS864_DM1_V1_BOX_SCREEN_TOP_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_screen_top_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_screen_top_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_screen_top_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_screen_top_table_pc34",
    "DATA.C:109",
    "DATA.C:531",
    "G0061_ai_Graphic562_Box_ScreenTop",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_screen_top_pc34_compat",
    "src/dm1/dm1_v1_box_screen_top_pc34_compat.c",
    "NAME dm1_v1_box_screen_top_pc34_compat",
    "verify_pass864_dm1_v1_box_screen_top_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (109, "G0061_ai_Graphic562_Box_ScreenTop"),
        (531, "G0061_ai_Graphic562_Box_ScreenTop"),
        (1350, "G0061_ai_Graphic562_Box_ScreenTop"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_box_screen_top_table_pc34"]),
