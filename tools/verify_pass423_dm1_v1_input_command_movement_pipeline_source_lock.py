...
SOURCE_RANGES = [
    ...
    {"id": "move_handler", "file": "CLIKMENU.C", "lines": "180-347", "claim": "F0366 computes relative destination, blocks walls/doors/fakewalls/groups before side effects, discards input on block, and calls F0267 on success.", "needles": ["F0366_COMMAND_ProcessTypes3To6_MoveParty", "G0465_ai_Graphic561_MovementArrowToStepForwardCount", "F0150_DUNGEON_UpdateMapCoordinatesAfterRelativeMovement", "L1117_B_MovementBlocked", "F0357_COMMAND_DiscardAllInput();", "F0267_MOVE_GetMoveResult_CPSCE(C0xFFFF_THING_PARTY, G0306_i_PartyMapX, G0307_i_PartyMapY, L1121_i_MapX, L1122_i_MapY);", "G0310_i_DisabledMovementTicks = AL1115_ui_Ticks;", "G0311_i_ProjectileDisabledMovementTicks = 0;"]},
