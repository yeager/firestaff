...
RED_RANGES = (
    ...
    SourceRange("CLIKMENU.C", "180-347", "F0366 steps charge stamina before resolution, blocks walls/doors/fakewalls/groups before F0267 for non-empty parties, preserves BUG0_85 by skipping group collision when the party is empty, and applies cooldown only after accepted movement", ("void F0366_COMMAND_ProcessTypes3To6_MoveParty", "G0465_ai_Graphic561_MovementArrowToStepForwardCount", "F0325_CHAMPION_DecrementStamina", "F0150_DUNGEON_UpdateMapCoordinatesAfterRelativeMovement", "C00_ELEMENT_WALL", "C04_ELEMENT_DOOR", "C06_ELEMENT_FAKEWALL", "G0305_ui_PartyChampionCount == 0", "BUG0_85", "F0175_GROUP_GetThing", "F0209_GROUP_ProcessEvents29to41", "F0357_COMMAND_DiscardAllInput();", "F0267_MOVE_GetMoveResult_CPSCE", "G0310_i_DisabledMovementTicks = AL1115_ui_Ticks;", "G0311_i_ProjectileDisabledMovementTicks = 0;")),
...
FIRESTAFF_EVIDENCE = (
    FirestaffEvidence("src/dm1/dm1_v1_input_command_queue_pc34_compat.c", "PC-34 input rows, queue lock, gated movement retention, pending-click replay, and blocked-input discard", ("DM1_V1_InputCommandQueue_ProcessOnePc34Compat", "disabledMovementTicks", "projectileDisabledMovementTicks", "movementDisabledGate", "process_pending_click(queue)", "DM1_V1_InputCommandQueue_DiscardAllInputPc34Compat")),
    FirestaffEvidence("src/dm1/dm1_v1_movement_command_core_pc34_compat.c", "F0380-to-F0365/F0366 seam: turns bypass movement gates, steps apply stamina/collision/group blocking/timing", ("DM1_V1_MovementCommandCore_ProcessOnePc34Compat", "dm1_v1_is_turn_command", "dm1_v1_apply_pre_step_stamina_plan", "F0702_MOVEMENT_TryMove_Compat", "F0708_MOVEMENT_IsPartyStepBlockedByGroup_Compat", "movementBlocked", "DM1_V1_MovementTiming_ApplySuccessfulStepPc34Compat")),
    FirestaffEvidence("src/memory/memory_movement_pc34_compat.c", "pure movement legality and target-square result semantics behind F0366, including the empty-party group-collision bug", ("F0700_MOVEMENT_TurnDirection_Compat", "F0701_MOVEMENT_GetStepDelta_Compat", "F0702_MOVEMENT_TryMove_Compat", "party->championCount <= 0", "THING_GET_TYPE(thing) == THING_TYPE_GROUP", "MOVE_BLOCKED_WALL", "MOVE_BLOCKED_DOOR")),
    FirestaffEvidence("src/dm1/dm1_v1_movement_timing_pc34_compat.c", "post-step cadence mirrors F0310/F0366 timing side effects", ("DM1_V1_MovementTiming_ComputeChampionTicksPc34Compat", "DM1_V1_MovementTiming_ApplySuccessfulStepPc34Compat", "disabledMovementTicks", "projectileDisabledMovementTicks", "lastPartyMovementTime")),
    FirestaffEvidence("tests/test_dm1_v1_movement_command_core_pc34_compat.c", "behavior coverage for queued input through turn/step dispatch, collision, stamina, timing, and sensor order", ("turn does not set movement cooldown", "blocked movement reported", "stamina cost", "step records scent/last movement time", "step updates last movement time")),
    FirestaffEvidence("tests/test_dm1_v1_command_movement_sensor_timing_pc34_compat.c", "integration coverage for PC-34 movement queue, collision, turn, sensor, timing edges, and BUG0_85 empty-party group passage", ("projectile same-direction movement gate reported", "turn current-square sensor", "mouse forward command dequeued", "core forward1 destination sensors", "core turn bypasses movement gates", "empty-party group collision bug not blocked", "empty-party group collision bug minimum cooldown")),
)
