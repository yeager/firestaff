#!/usr/bin/env python3
"""pass816 DM1 V1 champion-panel-box-object-description-circle contract."""
...
PASS = "pass816_dm1_v1_champion_panel_box_object_description_circle_pc34_compat"
STATUS = "PASS816_DM1_V1_CHAMPION_PANEL_BOX_OBJECT_DESCRIPTION_CIRCLE_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_champion_panel_box_object_description_circle_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/champion_panel_box_object_description_circle_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_panel_box_object_description_circle_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_champion_panel_box_object_description_circle_table_pc34",
    "dm1_v1_champion_panel_box_object_description_circle_get_pc34",
    "dm1_v1_champion_panel_box_object_description_circle_x_pc34",
    "kCircleX",
    "kCircleY",
    "kCircleW",
    "kCircleH",
    "G0034_ai_Graphic562_Box_ObjectDescriptionCircle",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_champion_panel_box_object_description_circle_pc34_compat",
    "src/dm1/dm1_v1_champion_panel_box_object_description_circle_pc34_compat.c",
    "NAME dm1_v1_champion_panel_box_object_description_circle_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (40, "G0034_ai_Graphic562_Box_ObjectDescriptionCircle"),
        (316, "G0034_ai_Graphic562_Box_ObjectDescriptionCircle"),
        (1033, "G0034_ai_Graphic562_Box_ObjectDescriptionCircle"),
    ],
    "PANEL.C": [
        (1141, "G0034_ai_Graphic562_Box_ObjectDescriptionCircle"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "{105, 136, 53, 79}. The {X, Y, W, H} pixel-coordinate "
            "rectangle for the object-description circle blit onto "
            "the champion panel. Read site: PANEL.C:1141 "
            "F0344_INVENTORY_DrawPanel blits C029_GRAPHIC_OBJECT_"
            "DESCRIPTION_CIRCLE into G0034's box with byte width "
            "C016_BYTE_WIDTH and color C12_COLOR_DARKEST_GRAY."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:316/1033 + PANEL.C:1141 line numbers "
        ...
        "nonOverlap": [
            ...
            "Not pass798-815 (Graphics.dat init-table gates batches "
            "1+2+3+4).",
        ],
    }
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0034_ai_Graphic562_"
        "Box_ObjectDescriptionCircle[4] = {105, 136, 53, 79}. The "
        "{X, Y, W, H} pixel-coordinate rectangle for the object-"
        "description circle blit. PANEL.C F0344_INVENTORY_DrawPanel "
        "calls M519_F0020_MAIN_BlitToViewport(C029_GRAPHIC_OBJECT_"
        "DESCRIPTION_CIRCLE, G0034, C016_BYTE_WIDTH, "
        "C12_COLOR_DARKEST_GRAY, 9).",
        "- Runtime assertion floor: 52 assertions in `tests/test_dm1_v1_"
        "champion_panel_box_object_description_circle_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:316/1033, PANEL.C:1141 "
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_champion_panel_box_object_description_circle_pc34_compat")])
    ]
