...
# are drift-proof: the line locations of the D0C thieves-eye metadata table, the
# test_d0c_thieves_eye_door_frame_occlusion_order CTest, and the source-evidence
# string have moved as more SIDE/D0C/D1-side metadata rows and source citations
...
LOCAL=[("firestaff-d0c-thieves-eye-metadata",ROOT/"src/dm1/dm1_v1_viewport_3d_pc34_compat.c","1-9999",["DM1_VIEW_SQUARE_D0C, 0x0021, 728, 736","DUNVIEW.C:8185-8188","DUNVIEW.C:8199-8201","DUNVIEW.C:8206-8210","DUNVIEW.C:8215-8216","DUNVIEW.C:8240,8294"]),("firestaff-d0c-thieves-eye-test",ROOT/"tests/test_dm1_v1_viewport_3d_pc34_compat.c","1-9999",["test_d0c_thieves_eye_door_frame_occlusion_order","dm1_viewport_3d_get_thieves_eye_door_frame_occlusion_spec_for_square(DM1_VIEW_SQUARE_D0C)","spec->door_frame_zone, 728","spec->hole_zone, 736","8215-8216","8294"]),("firestaff-source-evidence-string",ROOT/"src/dm1/dm1_v1_viewport_3d_pc34_compat.c","1-9999",["DUNVIEW.C:8185-8216 D0C Thieves Eye door-side frame occlusion","copy front frame, composite hole, blit temporary frame before common F0115"])]
def span(path,lines):
