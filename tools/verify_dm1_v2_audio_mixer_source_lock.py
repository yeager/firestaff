...
import json
r=Path(__file__).resolve().parents[1]; s=Path.home()/'.firestaff/data/firestaff-redmcsb-source/ReDMCSB_WIP20210206/Toolchains/Common/Source/SOUND.C'; t=s.read_text(encoding='utf-8',errors='replace'); e=[]
