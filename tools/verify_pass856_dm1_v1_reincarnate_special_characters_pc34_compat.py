...
PASS = "pass856_dm1_v1_reincarnate_special_characters_pc34_compat"
STATUS = "PASS856_DM1_V1_REINCARNATE_SPECIAL_CHARACTERS_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_reincarnate_special_characters_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/reincarnate_special_characters_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_reincarnate_special_characters_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "DATA.C:91",
    "DATA.C:430",
    "G0053_ac_Graphic562_ReincarnateSpecialCharacters",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_reincarnate_special_characters_pc34_compat",
    "src/dm1/dm1_v1_reincarnate_special_characters_pc34_compat.c",
    "NAME dm1_v1_reincarnate_special_characters_pc34_compat",
    "verify_pass856_dm1_v1_reincarnate_special_characters_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (91, "G0053_ac_Graphic562_ReincarnateSpecialCharacters"),
        (430, "G0053_ac_Graphic562_ReincarnateSpecialCharacters"),
        (1111, "G0053_ac_Graphic562_ReincarnateSpecialCharacters"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_reincarnate_special_characters_table_pc34"]),
