#!/usr/bin/env python3
"""Verify pass799 — DM1 V1 chest open-stack-split press-eye path."""
import os, subprocess, sys, json
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent
PASS = "pass799_dm1_v1_chest_open_stack_split_press_eye_pc34_compat"
HDR = ROOT / "include/dm1_v1_chest_open_stack_split_press_eye_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_chest_open_stack_split_press_eye_pc34_compat.c"
...
RED = (
    ...
    "CHAMPION.C F0302:688-710 (leader hand + destination slot click dispatcher, pickup path); "
...
NEEDLES_T = [
    ...
    "stack-split", "stack", "pickup"
]
NEEDLES_H = [
    "F0333", "F0334", "press-eye",
    "DM1_PC34_SLOT_ACTION_HAND", "C09_SLOT_BOX_INVENTORY_ACTION_HAND",
    "stack-split"
]
NEEDLES_C = [
    "test_dm1_v1_chest_open_stack_split_press_eye_pc34_compat",
    "src/dm1/dm1_v1_chest_open_stack_split_press_eye_pc34_compat.c",
    "NAME dm1_v1_chest_open_stack_split_press_eye_pc34_compat",
    f"verify_{PASS}",
]
...
def main():
    ...
    binary_name = "test_dm1_v1_chest_open_stack_split_press_eye_pc34_compat"
