...
PASS = "pass877_dm1_v1_animtown_color_inventory_pc34_compat"
STATUS = "PASS877_DM1_V1_ANIMTOWN_COLOR_INVENTORY_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_animtown_color_inventory_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/animtown_color_inventory_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_animtown_color_inventory_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_animtown_color_inventory_table_pc34",
    "DRAWVIEW.C:79",
    "ANIMTOWN.C:63",
    "G8150_INVENTORY",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_animtown_color_inventory_pc34_compat",
    "src/dm1/dm1_v1_animtown_color_inventory_pc34_compat.c",
    "NAME dm1_v1_animtown_color_inventory_pc34_compat",
    "verify_pass877_dm1_v1_animtown_color_inventory_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_animtown_color_inventory_table_pc34"]),
