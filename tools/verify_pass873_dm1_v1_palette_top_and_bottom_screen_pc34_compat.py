...
PASS = "pass873_dm1_v1_palette_top_and_bottom_screen_pc34_compat"
STATUS = "PASS873_DM1_V1_PALETTE_TOP_AND_BOTTOM_SCREEN_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_top_and_bottom_screen_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_top_and_bottom_screen_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_top_and_bottom_screen_pc34_compat.c"
...
ANCHORS = [
    "DATA.C:216/170/759/866/790",
    "BASE.C palette register load",
    "DIALOG.C F0436_STARTEND_FadeToPalette",
]

LOCAL_NEEDLES = [
    "dm1_v1_palette_top_and_bottom_screen_table_pc34",
    "DATA.C:216",
    "BASE.C:170",
    "G0347_aui_Palette_TopAndBottomScreen",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_top_and_bottom_screen_pc34_compat",
    "src/dm1/dm1_v1_palette_top_and_bottom_screen_pc34_compat.c",
    "NAME dm1_v1_palette_top_and_bottom_screen_pc34_compat",
    "verify_pass873_dm1_v1_palette_top_and_bottom_screen_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_palette_top_and_bottom_screen_table_pc34"]),
