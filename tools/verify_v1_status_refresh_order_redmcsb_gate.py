...
SOURCE_RANGES = [
    ...
    {"file": "src/engine/m11_game_view.c", "function": "m11_draw_party_panel", "start": 19127, "end": 19420},
]
...
def verify_firestaff() -> list[dict[str, int | str]]:
    ...
    require_excerpt(FIRESTAFF_SRC, "src/engine/m11_game_view.c", 23251, 23672, [
