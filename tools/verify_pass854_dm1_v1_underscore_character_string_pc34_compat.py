...
PASS = "pass854_dm1_v1_underscore_character_string_pc34_compat"
STATUS = "PASS854_DM1_V1_UNDERSCORE_CHARACTER_STRING_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_underscore_character_string_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/underscore_character_string_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_underscore_character_string_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "DATA.C:428",
    "REVIVE.C:429",
    "G0051_ac_Graphic562_UnderscoreCharacterString",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_underscore_character_string_pc34_compat",
    "src/dm1/dm1_v1_underscore_character_string_pc34_compat.c",
    "NAME dm1_v1_underscore_character_string_pc34_compat",
    "verify_pass854_dm1_v1_underscore_character_string_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (89, "G0051_ac_Graphic562_UnderscoreCharacterString"),
        (428, "G0051_ac_Graphic562_UnderscoreCharacterString"),
        (1104, "G0051_ac_Graphic562_UnderscoreCharacterString"),
    ],
    "REVIVE.C": [
        (429, "G0051_ac_Graphic562_UnderscoreCharacterString"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_underscore_character_string_table_pc34"]),
