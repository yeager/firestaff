...
PASS = "pass788_dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat"
STATUS = "PASS788_DM1_V1_MIRROR_CANDIDATE_C040_STATUS_BOX_CLICK_WHILE_PANEL_LIVE_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/mirror_candidate/c040_status_box_click_while_panel_live_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "dispatch_f0367_status_box_click",
    "F0380 gate",
    "f0367CallsWhileLive == 0",
    "rejectedWhileLive == 2",
    "rejectedOutOfRange == 2",
    "f0367CallsAfterClear == 1",
    "Disjoint from pass787",
    "status-box-click-while-c040-live",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat",
    "src/dm1/dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat.c",
    "NAME dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "COMMAND.C": [
        (2159, "!G0299_ui_CandidateChampionOrdinal"),
        (2160, "F0367_COMMAND_ProcessTypes12To27_ClickInChampionStatusBox"),
    ],
    "REVIVE.C": [
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "live (G0299 set), COMMAND.C F0380:2159-2161 drops the "
            "C012..C015 champion-status-box click. After F0282(C162) "
            "clears G0299 the click fires F0367. Disjoint from pass787 "
            "(C111), pass786 (C100 with G0514), pass785 (C007..C011), and "
            "pass784 (cancel-then-reopen same-tick)."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin COMMAND.C F0380:2159 and F0367 line numbers when the "
        ...
        "nonOverlap": [
            ...
            "Not the C140 save gate (not yet covered by any pass).",
    ...
    lines = [
        ...
        "- Gate: COMMAND.C F0380:2159-2161 drops C012..C015 status-box "
        "clicks while G0299 is set; after F0282(C162) clears G0299 the "
        "click fires F0367.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin COMMAND.C F0380:2159 and F0367 "
            "line numbers in next source refresh."
        )
...
def main() -> int:
    local_checks = [
        ...
        check_needles(
            ...
            [
                ...
                "test_run_accepted",
                "test_run_gates_status_box_while_panel_live",
    ...
    build_dir = resolve_build_dir("test_dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat")
    runs = [
        run([str(build_dir / "test_dm1_v1_mirror_candidate_c040_status_box_click_while_panel_live_pc34_compat")])
    ]
