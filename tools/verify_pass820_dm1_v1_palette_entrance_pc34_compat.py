#!/usr/bin/env python3
"""pass820 DM1 V1 palette-entrance contract."""
...
PASS = "pass820_dm1_v1_palette_entrance_pc34_compat"
STATUS = "PASS820_DM1_V1_PALETTE_ENTRANCE_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_entrance_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_entrance_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_entrance_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_palette_entrance_table_pc34",
    "dm1_v1_palette_entrance_pc34",
    "kTableSize",
    "kMax12Bit",
    "G0020_aui_Graphic562_Palette_Entrance",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_entrance_pc34_compat",
    "src/dm1/dm1_v1_palette_entrance_pc34_compat.c",
    "NAME dm1_v1_palette_entrance_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (25, "G0020_aui_Graphic562_Palette_Entrance"),
        (213, "G0020_aui_Graphic562_Palette_Entrance"),
        (792, "G0020_aui_Graphic562_Palette_Entrance"),
    ],
    "ENDGAME.C": [
        (595, "G0020_aui_Graphic562_Palette_Entrance"),
    ],
    "ENTRANCE.C": [
        (595, "G0020_aui_Graphic562_Palette_Entrance"),
    ],
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0020_aui_Graphic562_Palette_Entrance[16] = { 0x000, 0x666, "
            "0x888, 0x840, 0xCA8, 0x0C0, 0x080, 0x0A0, 0xC84, 0xFFA, "
            "0xF84, 0xFC0, 0xFA0, 0x000, 0x620, 0xFFC }. The 16-color "
            "palette used for the Entrance screen fade. Each entry is "
            "a 12-bit RGB color (4 bits per channel). Read sites: "
            "ENTRANCE.C:595 + ENTRANCE.C:1061 F0436_STARTEND_FadeToPalette("
            "G0019)."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:213/789 + ENTRANCE.C:595 + ENTRANCE.C:1061 "
    ...
    lines = [
        ...
        "Palette_Entrance[16] = { 0x000, 0x666, 0xFF6, 0x840, 0xFF8, "
        ...
        "palette_entrance_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:213/792, ENDGAME.C:"
            "595, ENTRANCE.C:1061 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_palette_entrance_pc34_compat")])
    ]
