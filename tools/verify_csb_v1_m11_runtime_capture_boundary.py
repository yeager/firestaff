...
ANCHORS = [
    ...
    {"id": "firestaff_m11_csb_handoff_bypasses_dm1_loader", "role": "firestaff_positive", "path": ROOT / "src/engine/m11_game_view.c", "lines": "22065-22140", "needles": ["CSB V1: bypass DM1 dungeon loader", "m11_csb_apply_boot_runtime_receipt", "CSB READY: gameId=csb dataDir=%s"]},
