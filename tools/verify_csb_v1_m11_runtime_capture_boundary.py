...
ANCHORS = [
    ...
    {"id": "firestaff_m12_production_launch_guard", "role": "firestaff_guard", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "1408-1414", "needles": ["Only DM1 is launch-supported", "return gameId && strcmp(gameId, \"dm1\") == 0;"]},
    {"id": "firestaff_m12_launch_intent_guard", "role": "firestaff_guard", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "5313-5350", "needles": ["M12_StartupMenu_GetLaunchIntent", "intent.valid = m12_game_supported(intent.gameId)", "version && version->matched ? 1 : 0"]},
    {"id": "firestaff_m11_title_intro_is_dm1_only", "role": "firestaff_blocker", "path": ROOT / "src/engine/main_loop_m11.c", "lines": "196-260", "needles": ["m11_find_title_dat_for_intro", "M12_AssetStatus_GetVersionCount(\"dm1\")", ".openclaw/data/firestaff-original-games/DM/_canonical/dm1/TITLE"]},
    {"id": "firestaff_m11_launch_handoff_runs_title_before_open", "role": "firestaff_blocker", "path": ROOT / "src/engine/main_loop_m11.c", "lines": "698-728", "needles": ["m11_open_requested_launch", "m11_play_redmcsb_title_intro_if_available", "M11_GameView_OpenSelectedMenuEntry", "m11_play_redmcsb_entrance_transition"]},
    {"id": "firestaff_m11_csb_builtin_path_mismatch", "role": "firestaff_blocker", "path": ROOT / "src/engine/m11_game_view.c", "lines": "1003-1015", "needles": ["m11_resolve_builtin_dungeon_path", "strcmp(gameId, \"csb\") == 0", "\"CSB.DAT\""]},
