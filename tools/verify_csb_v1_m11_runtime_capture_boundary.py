...
ANCHORS = [
    ...
    {"id": "firestaff_m12_supports_csb_launch_intent", "role": "firestaff_positive", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "4890-4928", "needles": ["All five catalogued games now have runtime launch boundaries", "strcmp(gameId, \"csb\") == 0"]},
    {"id": "firestaff_m12_launch_intent_uses_supported_game_and_assets", "role": "firestaff_positive", "path": ROOT / "src/ui/menu_startup_m12.c", "lines": "12569-12670", "needles": ["M12_StartupMenu_GetLaunchIntent", "m12_game_supported(intent.gameId)", "gate.canLaunch && version && version->matched ? 1 : 0"]},
    {"id": "firestaff_m11_csb_handoff_bypasses_dm1_loader", "role": "firestaff_positive", "path": ROOT / "src/engine/m11_game_view.c", "lines": "19595-19670", "needles": ["CSB V1: bypass DM1 dungeon loader", "m11_csb_apply_boot_runtime_receipt", "CSB READY: gameId=csb dataDir=%s"]},
