...
def audit_firestaff() -> list[dict[str, Any]]:
    ...
    return [
        ...
        require_needles(
            "local tests cover the drawn statistic text-run and framebuffer contract",
            panel_test + "\n" + runtime_test,
            [
...
def build_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "claim": "The champion statistics eye-panel draw contract and Firestaff indexed-framebuffer draw path are source-locked; original runtime pixel parity remains blocked.",
        "redmcsbChecks": red,
