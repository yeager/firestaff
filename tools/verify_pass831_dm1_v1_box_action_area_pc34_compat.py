#!/usr/bin/env python3
"""pass831 DM1 V1 box-action-area contract."""
...
PASS = "pass831_dm1_v1_box_action_area_pc34_compat"
STATUS = "PASS831_DM1_V1_BOX_ACTION_AREA_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_action_area_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_action_area_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_action_area_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_action_area_table_pc34",
    "dm1_v1_box_action_area_get_pc34",
    "dm1_v1_box_action_area_x_pc34",
    "kActionX",
    "kActionY",
    "kActionW",
    "kActionH",
    "G0001_ai_Graphic562_Box_ActionArea",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_action_area_pc34_compat",
    "src/dm1/dm1_v1_box_action_area_pc34_compat.c",
    "NAME dm1_v1_box_action_area_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (6, "G0001_ai_Graphic562_Box_ActionArea"),
        (119, "G0001_ai_Graphic562_Box_ActionArea"),
        (539, "G0001_ai_Graphic562_Box_ActionArea"),
    ],
    "CASTER.C": [
        (24, "G0001_ai_Graphic562_Box_ActionArea"),
        (31, "G0001_ai_Graphic562_Box_ActionArea"),
    ],
    "STARTUP2.C": [
        (376, "G0001_ai_Graphic562_Box_ActionArea"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0001_ai_Graphic562_Box_ActionArea[4] = {224, 319, 77, 121}. "
            "The {X, Y, W, H} byte-coordinate sub-rectangle for the "
            "action-area background blit on the champion panel. Read "
            "sites: ACTIDRAW.C:73 M520_F0021_MAIN_BlitToScreen (spell-"
            "area background blit), ACTIDRAW.C:320 M524_FillScreenBox "
            "(clear), STARTUP2.C:377 F0136_VIDEO_HatchScreenBox (hatch)."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:121/539 + ACTIDRAW.C:73/31 + STARTUP2.C:377 "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0001_ai_Graphic562_"
        "Box_ActionArea[4] = {224, 319, 77, 121}. The {X, Y, W, H} "
        "byte-coordinate sub-rectangle for the action-area background "
        "blit on the champion panel. Read sites: ACTIDRAW.C:73/31 + "
        "STARTUP2.C:377 (action-area blit + clear + hatch).",
        "- Runtime assertion floor: 54 assertions in `tests/test_dm1_v1_"
        "box_action_area_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:121/539, ACTIDRAW.C:73/"
            "31, STARTUP2.C:377 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_action_area_pc34_compat")])
    ]
