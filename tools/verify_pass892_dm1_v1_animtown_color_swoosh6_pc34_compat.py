...
PASS = "pass892_dm1_v1_animtown_color_swoosh6_pc34_compat"
STATUS = "PASS892_DM1_V1_ANIMTOWN_COLOR_SWOOSH6_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_animtown_color_swoosh6_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/animtown_color_swoosh6_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_animtown_color_swoosh6_pc34_compat.c"
...
ANCHORS = [
    "DRAWVIEW.C:319/302/418/624-629",
]

LOCAL_NEEDLES = [
    "dm1_v1_animtown_color_swoosh6_table_pc34",
    "DRAWVIEW.C:319",
    "ANIMTOWN.C:302",
    "G8167_SWOOSH6",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_animtown_color_swoosh6_pc34_compat",
    "src/dm1/dm1_v1_animtown_color_swoosh6_pc34_compat.c",
    "NAME dm1_v1_animtown_color_swoosh6_pc34_compat",
    "verify_pass892_dm1_v1_animtown_color_swoosh6_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_animtown_color_swoosh6_table_pc34"]),
