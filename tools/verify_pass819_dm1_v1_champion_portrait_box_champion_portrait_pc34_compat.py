#!/usr/bin/env python3
"""pass819 DM1 V1 champion-portrait-box-champion-portrait contract."""
...
PASS = "pass819_dm1_v1_champion_portrait_box_champion_portrait_pc34_compat"
STATUS = "PASS819_DM1_V1_BOX_CHAMPION_PORTRAIT_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_champion_portrait_box_champion_portrait_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/champion_portrait_box_champion_portrait_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_portrait_box_champion_portrait_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_champion_portrait_table_pc34",
    "dm1_v1_box_champion_portrait_get_pc34",
    "dm1_v1_box_champion_portrait_x_pc34",
    "kPortraitX",
    "kPortraitY",
    "kPortraitW",
    "kPortraitH",
    "G0047_auc_Graphic562_Box_ChampionPortrait",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_champion_portrait_box_champion_portrait_pc34_compat",
    "src/dm1/dm1_v1_champion_portrait_box_champion_portrait_pc34_compat.c",
    "NAME dm1_v1_champion_portrait_box_champion_portrait_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (85, "G0047_auc_Graphic562_Box_ChampionPortrait"),
        (424, "G0047_auc_Graphic562_Box_ChampionPortrait"),
        (1098, "G0047_auc_Graphic562_Box_ChampionPortrait"),
    ],
    "REVIVE.C": [
        (142, "G0047_auc_Graphic562_Box_ChampionPortrait"),
        (146, "G0047_auc_Graphic562_Box_ChampionPortrait"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "{0, 31, 0, 28}. The {X, Y, W, H} byte-coordinate sub-"
            "rectangle used by REVIVE.C F0132_VIDEO_Blit to extract "
            "a single champion portrait (31 bytes wide x 28 bytes "
            "tall) from the C026_GRAPHIC_CHAMPION_PORTRAITS source "
            "bitmap. Read sites: REVIVE.C:142/146 F0132_VIDEO_Blit."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:424/1098 + REVIVE.C:142/146 line numbers "
        ...
        "nonOverlap": [
            ...
            "Not pass798-818 (Graphics.dat init-table gates batches "
            "1+2+3+4+5+6).",
        ],
    }
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0047_auc_Graphic562_"
        "Box_ChampionPortrait[4] = {0, 31, 0, 28}. The {X, Y, W, H} "
        "byte-coordinate sub-rectangle used by REVIVE.C F0132_VIDEO_"
        "Blit to extract a single champion portrait (31 bytes wide "
        "x 28 bytes tall) from the C026_GRAPHIC_CHAMPION_PORTRAITS "
        "source bitmap.",
        "- Runtime assertion floor: 59 assertions in `tests/test_dm1_v1_"
        "champion_portrait_box_champion_portrait_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:424/1098, REVIVE.C:142/"
            "146 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_champion_portrait_box_champion_portrait_pc34_compat")])
    ]
