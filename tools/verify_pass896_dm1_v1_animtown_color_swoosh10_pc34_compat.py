...
PASS = "pass896_dm1_v1_animtown_color_swoosh10_pc34_compat"
STATUS = "PASS896_DM1_V1_ANIMTOWN_COLOR_SWOOSH10_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_animtown_color_swoosh10_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/animtown_color_swoosh10_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_animtown_color_swoosh10_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_animtown_color_swoosh10_table_pc34",
    "DRAWVIEW.C:337",
    "ANIMTOWN.C:320",
    "G8171_SWOOSH10",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_animtown_color_swoosh10_pc34_compat",
    "src/dm1/dm1_v1_animtown_color_swoosh10_pc34_compat.c",
    "NAME dm1_v1_animtown_color_swoosh10_pc34_compat",
    "verify_pass896_dm1_v1_animtown_color_swoosh10_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_animtown_color_swoosh10_table_pc34"]),
