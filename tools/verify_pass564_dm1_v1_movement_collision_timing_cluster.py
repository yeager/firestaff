...
FIRESTAFF = [
    ...
    ("src/dm1/dm1_v1_movement_command_core_pc34_compat.c", "turn/step dispatch, blockers, coordinate update, cooldown", ["dm1_v1_apply_pre_step_stamina_plan", "F0702_MOVEMENT_TryMove_Compat", "DM1_V1_MovementCommandCore_BlockedResolutionPlanPc34Compat", "F0708_MOVEMENT_IsPartyStepBlockedByGroup_Compat", "DM1_V1_InputCommandQueue_DiscardAllInputPc34Compat(queue);", "party->mapX = plan->newMapX;", "DM1_V1_MovementTiming_ApplySuccessfulStepPc34Compat"]),
