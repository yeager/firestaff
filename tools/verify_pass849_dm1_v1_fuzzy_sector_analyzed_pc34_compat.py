#!/usr/bin/env python3
"""pass849 DM1 V1 fuzzy-sector-analyzed contract."""
...
PASS = "pass849_dm1_v1_fuzzy_sector_analyzed_pc34_compat"
STATUS = "PASS849_DM1_V1_FUZZY_SECTOR_ANALYZED_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_fuzzy_sector_analyzed_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/fuzzy_sector_analyzed_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_fuzzy_sector_analyzed_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_fuzzy_sector_analyzed_get_pc34",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_fuzzy_sector_analyzed_pc34_compat",
    "src/dm1/dm1_v1_fuzzy_sector_analyzed_pc34_compat.c",
    "NAME dm1_v1_fuzzy_sector_analyzed_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (39, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
        (179, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
        (579, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
    ],
    "CLIKMENU.C": [
        (366, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
        (491, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
        (559, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
    ],
    "COPYPRO6.C": [
        (69, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
        (99, "G0031_i_Graphic562_FuzzySectorAnalyzed_CPSE"),
    ],
}
...
def write_outputs(local_checks, redmcsb_checks, runs):
    ...
    manifest = {
        ...
        "scope": "DM1 V1 Graphics.dat item 562 init var G0031 (single int16_t) — copy-protection fuzzy-sector-analyzed flag.",
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
...
def main():
    local_checks = [
        ...
        check_needles("test_entry_and_assertions", TEST,
                      ["test_initial_value", "test_value_in_int16_range",
