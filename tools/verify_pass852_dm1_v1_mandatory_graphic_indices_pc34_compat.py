...
PASS = "pass852_dm1_v1_mandatory_graphic_indices_pc34_compat"
STATUS = "PASS852_DM1_V1_MANDATORY_GRAPHIC_INDICES_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_mandatory_graphic_indices_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/mandatory_graphic_indices_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_mandatory_graphic_indices_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_mandatory_graphic_indices_table_pc34",
    "dm1_v1_mandatory_graphic_indices_get_pc34",
    "kTableSize",
    "kIndexOutOfRange",
    "G0018_ai_Graphic562_MandatoryGraphicIndices",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_mandatory_graphic_indices_pc34_compat",
    "src/dm1/dm1_v1_mandatory_graphic_indices_pc34_compat.c",
    "NAME dm1_v1_mandatory_graphic_indices_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (24, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (137, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (209, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (615, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (690, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
    ],
    "DUNVIEW.C": [
        (2350, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (2353, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (2356, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (2359, "M531_MANDATORY_GRAPHIC_COUNT"),
        (2454, "G0018_ai_Graphic562_MandatoryGraphicIndices"),
        (2455, "M531_MANDATORY_GRAPHIC_COUNT"),
    ],
}
    ...
    local_checks = [
        ...
        check_needles("test_entry_and_assertions", TEST,
                      ["test_table_values", "test_lookup_function",
                       "test_first_last_specific", "test_run_accepted",
                       "assertions passed"]),
