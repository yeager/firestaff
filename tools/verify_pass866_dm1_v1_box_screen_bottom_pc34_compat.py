...
PASS = "pass866_dm1_v1_box_screen_bottom_pc34_compat"
STATUS = "PASS866_DM1_V1_BOX_SCREEN_BOTTOM_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_screen_bottom_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_screen_bottom_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_screen_bottom_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_screen_bottom_table_pc34",
    "DATA.C:111",
    "DATA.C:533",
    "G0063_ai_Graphic562_Box_ScreenBottom",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_screen_bottom_pc34_compat",
    "src/dm1/dm1_v1_box_screen_bottom_pc34_compat.c",
    "NAME dm1_v1_box_screen_bottom_pc34_compat",
    "verify_pass866_dm1_v1_box_screen_bottom_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (111, "G0063_ai_Graphic562_Box_ScreenBottom"),
        (533, "G0063_ai_Graphic562_Box_ScreenBottom"),
        (1352, "G0063_ai_Graphic562_Box_ScreenBottom"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_box_screen_bottom_table_pc34"]),
