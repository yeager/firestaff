...
def main() -> int:
    ...
    # contents pass is now named m11_draw_dm1_side_contents_at_depth(), and
    # the deferred explosion layer materializes C15 records through
    ...
    if "cell->renderableProjectileCount > 0" not in effect_body:
