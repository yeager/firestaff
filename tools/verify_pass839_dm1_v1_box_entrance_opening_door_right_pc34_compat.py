#!/usr/bin/env python3
"""pass839 DM1 V1 box-entrance-opening-door-right contract."""
...
PASS = "pass839_dm1_v1_box_entrance_opening_door_right_pc34_compat"
STATUS = "PASS839_DM1_V1_BOX_ENTRANCE_OPENING_DOOR_RIGHT_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_entrance_opening_door_right_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_entrance_opening_door_right_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_entrance_opening_door_right_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_entrance_opening_door_right_table_pc34",
    "dm1_v1_box_entrance_opening_door_right_get_pc34",
    "dm1_v1_box_entrance_opening_door_right_x_pc34",
    "kEDRX",
    "kEDRY",
    "kEDRW",
    "kEDRH",
    "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_entrance_opening_door_right_pc34_compat",
    "src/dm1/dm1_v1_box_entrance_opening_door_right_pc34_compat.c",
    "NAME dm1_v1_box_entrance_opening_door_right_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (13, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
        (135, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
        (555, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
    ],
    "ENTRANCE.C": [
        (150, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
        (190, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
        (192, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
        (195, "G0008_ai_Graphic562_Box_Entrance_OpeningDoorRight"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "{109, 231, 0, 160}. The {X, Y, W, H} byte-coordinate sub-"
            "rectangle for the entrance door-opening animation (right "
            "half). Read sites: ENTRANCE.C:150 (M768_BOX_LEFT shrink "
            "each tick) + ENTRANCE.C:190/192/195 F0132_VIDEO_Blit "
            "(entrance door animation step into G0008's box)."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:143/553 + ENTRANCE.C:150/189/191/194 line "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0008_ai_Graphic562_"
        "Box_Entrance_OpeningDoorRight[4] = {109, 231, 0, 160}. The "
        "{X, Y, W, H} byte-coordinate sub-rectangle for the entrance "
        "door-opening animation (right half). Read sites: ENTRANCE.C:150 "
        "(M768_BOX_LEFT shrink) + ENTRANCE.C:190/192/195 (F0132_VIDEO_"
        "Blit).",
        "- Runtime assertion floor: 53 assertions in `tests/test_dm1_v1_"
        "box_entrance_opening_door_right_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:143/553, ENTRANCE.C:"
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_entrance_opening_door_right_pc34_compat")])
    ]
