...
PASS = "pass886_dm1_v1_animtown_color_master_pc34_compat"
STATUS = "PASS886_DM1_V1_ANIMTOWN_COLOR_MASTER_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_animtown_color_master_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/animtown_color_master_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_animtown_color_master_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_animtown_color_master_table_pc34",
    "DRAWVIEW.C:301",
    "ANIMTOWN.C:284",
    "G8161_MASTER",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_animtown_color_master_pc34_compat",
    "src/dm1/dm1_v1_animtown_color_master_pc34_compat.c",
    "NAME dm1_v1_animtown_color_master_pc34_compat",
    "verify_pass886_dm1_v1_animtown_color_master_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_animtown_color_master_table_pc34"]),
