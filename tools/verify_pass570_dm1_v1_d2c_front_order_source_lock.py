...
LOCAL = [
    ...
    ("firestaff-d2c-runtime-test", ROOT / "test_dm1_v1_viewport_3d_pc34_compat.c", "513-552", [
    ...
    ("firestaff-d2c-source-evidence", ROOT / "dm1_v1_viewport_3d_pc34_compat.c", "1097-1115", [
