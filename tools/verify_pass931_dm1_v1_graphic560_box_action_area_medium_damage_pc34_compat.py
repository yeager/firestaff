#!/usr/bin/env python3
"""pass931 DM1 V1 medium damage action-area box contract."""
...
PASS = "pass931_dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat"
STATUS = "PASS931_DM1_V1_G0502_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/G0502_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "G0502_ai_Graphic560_Box_ActionAreaMediumDamage",
    "MENU.C:38",
    "MENU.C:498",
    "ACTIDRAW.C:136",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat",
    "src/dm1/dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat.c",
    "NAME dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat",
    "verify_pass931_dm1_v1_graphic560_box_action_area_medium_damage_pc34_compat",
]

REDMCSB_WINDOWS = {
    "MENU.C": [
        (38, "G0502_ai_Graphic560_Box_ActionAreaMediumDamage"),
        (498, "{ 242, 305, 81, 117 }"),
    ],
    "ACTIDRAW.C": [
        (136, "G0502_ai_Graphic560_Box_ActionAreaMediumDamage"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_graphic560_box_action_area_medium_damage_table_pc34"]),
