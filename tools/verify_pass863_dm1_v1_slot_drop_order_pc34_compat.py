...
PASS = "pass863_dm1_v1_slot_drop_order_pc34_compat"
STATUS = "PASS863_DM1_V1_SLOT_DROP_ORDER_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_slot_drop_order_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/slot_drop_order_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_slot_drop_order_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_slot_drop_order_table_pc34",
    "DATA.C:105",
    "DATA.C:436",
    "CHAMPION.C:1546",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_slot_drop_order_pc34_compat",
    "src/dm1/dm1_v1_slot_drop_order_pc34_compat.c",
    "NAME dm1_v1_slot_drop_order_pc34_compat",
    "verify_pass863_dm1_v1_slot_drop_order_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (105, "G0057_ai_Graphic562_SlotDropOrder"),
        (436, "G0057_ai_Graphic562_SlotDropOrder"),
        (466, "G0057_ai_Graphic562_SlotDropOrder"),
        (1119, "G0057_ai_Graphic562_SlotDropOrder"),
    ],
    "CHAMPION.C": [
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_slot_drop_order_table_pc34"]),
