...
PASS = "pass872_dm1_v1_palette_changes_cursor_mask_v2_pc34_compat"
STATUS = "PASS872_DM1_V1_PALETTE_CHANGES_CURSOR_MASK_V2_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_palette_changes_cursor_mask_v2_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/palette_changes_cursor_mask_v2_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_palette_changes_cursor_mask_v2_pc34_compat.c"
...
ANCHORS = [
    "DATA.C:422/2151/2453",
    "IO.C cursor-style-2 + champion-icon mask path",
]

LOCAL_NEEDLES = [
    "dm1_v1_palette_changes_cursor_mask_v2_table_pc34",
    "DATA.C:422",
    "IO.C:2151",
    "G4013_auc_PaletteChanges_CursorMask",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_palette_changes_cursor_mask_v2_pc34_compat",
    "src/dm1/dm1_v1_palette_changes_cursor_mask_v2_pc34_compat.c",
    "NAME dm1_v1_palette_changes_cursor_mask_v2_pc34_compat",
    "verify_pass872_dm1_v1_palette_changes_cursor_mask_v2_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_palette_changes_cursor_mask_v2_table_pc34"]),
