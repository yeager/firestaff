...
PASS = "pass787_dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat"
STATUS = "PASS787_DM1_V1_MIRROR_CANDIDATE_C040_ACTION_AREA_CLICK_WHILE_PANEL_LIVE_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/mirror_candidate/c040_action_area_click_while_panel_live_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat.c"
...
LOCAL_NEEDLES = [
    ...
    "dispatch_f0371_action_area_click",
    "F0380 gate",
    "f0371CallsWhileLive == 0",
    "rejectedWhileLive == 3",
    "f0371CallsAfterClear == 1",
    "Disjoint from pass786",
    "action-area-click-while-c040-live",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat",
    "src/dm1/dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat.c",
    "NAME dm1_v1_mirror_candidate_c040_action_area_click_while_panel_live_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "COMMAND.C": [
        (2309, "!G0299_ui_CandidateChampionOrdinal"),
        (2310, "F0371_COMMAND_ProcessType111To115_ClickInActionArea_CPSE"),
    ],
    "REVIVE.C": [
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "live (G0299 set), COMMAND.C F0380:2309-2311 drops the C111 "
            "action-area click. After F0282(C162) clears G0299 the click "
            "fires F0371. Disjoint from pass786 (C100 with G0514 magic-"
            "caster gate), pass785 (C007..C011 inventory-toggle), and "
        ...
        "anchorDriftTodo": [
            "Re-pin COMMAND.C F0380:2309 and F0371 line numbers when the "
        ...
        "nonOverlap": [
            ...
            "Not the C012..C016 status-box gate (not yet covered by any "
            "pass).",
    ...
    lines = [
        ...
        "- Gate: COMMAND.C F0380:2309-2311 drops C111 action-area clicks "
        "while G0299 is set; after F0282(C162) clears G0299 the click "
        "fires F0371.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin COMMAND.C F0380:2309 and F0371 "
    ...
    local_checks = [
        ...
        check_needles(
            ...
            [
                ...
                "test_run_accepted",
                "test_run_gates_action_area_while_panel_live",
