...
PASS = "pass891_dm1_v1_animtown_color_swoosh5_pc34_compat"
STATUS = "PASS891_DM1_V1_ANIMTOWN_COLOR_SWOOSH5_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_animtown_color_swoosh5_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/animtown_color_swoosh5_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_animtown_color_swoosh5_pc34_compat.c"
...
ANCHORS = [
    "DRAWVIEW.C:316/299/417/624-629",
]

LOCAL_NEEDLES = [
    "dm1_v1_animtown_color_swoosh5_table_pc34",
    "DRAWVIEW.C:316",
    "ANIMTOWN.C:299",
    "G8166_SWOOSH5",
...
CMAKE_NEEDLES = [
    "test_dm1_v1_animtown_color_swoosh5_pc34_compat",
    "src/dm1/dm1_v1_animtown_color_swoosh5_pc34_compat.c",
    "NAME dm1_v1_animtown_color_swoosh5_pc34_compat",
    "verify_pass891_dm1_v1_animtown_color_swoosh5_pc34_compat",
]
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_animtown_color_swoosh5_table_pc34"]),
