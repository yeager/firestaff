...
PASS = "pass861_dm1_v1_bar_graph_masks_pc34_compat"
STATUS = "PASS861_DM1_V1_BAR_GRAPH_MASKS_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_bar_graph_masks_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/bar_graph_masks_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_bar_graph_masks_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_bar_graph_masks_table_pc34",
    "DATA.C:93",
    "CHAMDRAW.C:204",
    "G0055_aaaui_Graphic562_BarGraphMasks",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_bar_graph_masks_pc34_compat",
    "src/dm1/dm1_v1_bar_graph_masks_pc34_compat.c",
    "NAME dm1_v1_bar_graph_masks_pc34_compat",
    "verify_pass861_dm1_v1_bar_graph_masks_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (93, "G0055_aaaui_Graphic562_BarGraphMasks"),
        (98, "G0055_aaaui_Graphic562_BarGraphMasks"),
    ],
    "CHAMDRAW.C": [
        (204, "G0056_aaui_Graphic562_BarGraphByteOffsets"),
        (207, "G0055_aaaui_Graphic562_BarGraphMasks"),
        (208, "G0055_aaaui_Graphic562_BarGraphMasks"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_bar_graph_masks_table_pc34"]),
