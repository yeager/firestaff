#!/usr/bin/env python3
"""Verify pass795 — DM1 V1 champion leader state contract test."""
import os, subprocess, sys, json
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
PASS = "pass795_dm1_v1_champion_leader_pc34_compat"
HDR = ROOT / "include/dm1_v1_champion_leader_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_leader_pc34_compat.c"
CMAKE = ROOT / "CMakeLists.txt"
OUT_DIR = ROOT / "parity-evidence/verification" / PASS
MANIFEST = OUT_DIR / "manifest.json"
REPORT = ROOT / "parity-evidence" / f"{PASS}.md"
RED = ("CLIKCHAM.C F0367:24-35 (status-box nested G0455 dispatch) + "
       "CLIKCHAM.C F0368:51-72 (set-leader state transition with old-leader "
       "dirty marking, leader-hand weight remove/add, G0411 set/clear, "
       "candidate leader redraw); DEFS.H:8090-8100 (C00..C03 champion "
       "indices, G0411, G0455); DEFS.H:1874-1878 (CM1_CHAMPION_NONE)")
NEEDLES_T = ["F0367", "F0368", "CLIKCHAM", "leader", "G0411", "G0455", "champion"]
NEEDLES_H = ["F0367", "F0368", "G0411", "leader"]
NEEDLES_C = [
    "test_dm1_v1_champion_leader_pc34_compat",
    "src/dm1/dm1_v1_champion_leader_pc34_compat.c",
    "NAME dm1_v1_champion_leader_pc34_compat",
    f"verify_{PASS}",
]
...
def main():
    ...
    binary_name = "test_dm1_v1_champion_leader_pc34_compat"
