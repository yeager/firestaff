...
PASS = "pass867_dm1_v1_print_text_masks2_pc34_compat"
STATUS = "PASS867_DM1_V1_PRINT_TEXT_MASKS2_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_print_text_masks2_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/print_text_masks2_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_print_text_masks2_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_print_text_masks2_table_pc34",
    "DATA.C:112",
    "DATA.C:534",
    "G0064_al_Graphic562_PrintTextMasks2",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_print_text_masks2_pc34_compat",
    "src/dm1/dm1_v1_print_text_masks2_pc34_compat.c",
    "NAME dm1_v1_print_text_masks2_pc34_compat",
    "verify_pass867_dm1_v1_print_text_masks2_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (112, "G0064_al_Graphic562_PrintTextMasks2"),
        (534, "G0064_al_Graphic562_PrintTextMasks2"),
        (1355, "G0064_al_Graphic562_PrintTextMasks2"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_print_text_masks2_table_pc34"]),
