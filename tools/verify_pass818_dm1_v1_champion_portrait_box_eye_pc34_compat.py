#!/usr/bin/env python3
"""pass818 DM1 V1 champion-portrait-box-eye contract."""
...
PASS = "pass818_dm1_v1_champion_portrait_box_eye_pc34_compat"
STATUS = "PASS818_DM1_V1_CHAMPION_PORTRAIT_BOX_EYE_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_champion_portrait_box_eye_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/champion_portrait_box_eye_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_champion_portrait_box_eye_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_champion_portrait_box_eye_table_pc34",
    "dm1_v1_champion_portrait_box_eye_get_pc34",
    "dm1_v1_champion_portrait_box_eye_x_pc34",
    "kEyeX",
    "kEyeY",
    "kEyeW",
    "kEyeH",
    "G0049_ai_Graphic562_Box_Eye",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_champion_portrait_box_eye_pc34_compat",
    "src/dm1/dm1_v1_champion_portrait_box_eye_pc34_compat.c",
    "NAME dm1_v1_champion_portrait_box_eye_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (79, "G0049_ai_Graphic562_Box_Eye"),
        (423, "G0049_ai_Graphic562_Box_Eye"),
        (1095, "G0049_ai_Graphic562_Box_Eye"),
    ],
    "CHAMDRAW.C": [
        (914, "G0049_ai_Graphic562_Box_Eye"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "G0049_ai_Graphic562_Box_Eye[4] = {11, 28, 12, 29}. "
            "The {X, Y, W, H} pixel-coordinate rectangle for the "
            "champion-portrait eye-overlay blit. Read site: "
            "CHAMDRAW.C:928 F0294_CHAMPION_DrawChampionPortraitEye "
            "blits the eye graphic into G0048's box with byte "
            "width C016_BYTE_WIDTH and color C12_COLOR_DARKEST_GRAY."
        ),
        "anchors": ANCHORS,
        "redmcsbRoot": str(RED),
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:426/1095 + CHAMDRAW.C:928 line numbers "
        ...
        "nonOverlap": [
            ...
            "Not pass798-816 (Graphics.dat init-table gates batches "
            "1+2+3+4+5).",
        ],
    }
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0048_ai_Graphic562_"
        "Box_Eye[4] = {11, 28, 12, 29}. The {X, Y, W, H} pixel-"
        "coordinate rectangle for the champion-portrait eye-overlay "
        "blit. CHAMDRAW.C F0294_CHAMPION_DrawChampionPortraitEye "
        "calls M519_F0020_MAIN_BlitToViewport(nativeBitmap, "
        "G0048, C016_BYTE_WIDTH, C12_COLOR_DARKEST_GRAY, 18) to "
        "blit the eye graphic on top of the portrait when the "
        "champion is mid-action.",
        "- Runtime assertion floor: 52 assertions in `tests/test_dm1_v1_"
        "champion_portrait_box_eye_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:426/1095, "
            "CHAMDRAW.C:928 in next source refresh."
        )
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_champion_portrait_box_eye_pc34_compat")])
    ]
