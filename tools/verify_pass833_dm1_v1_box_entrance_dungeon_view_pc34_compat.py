#!/usr/bin/env python3
"""pass833 DM1 V1 box-entrance-dungeon-view contract."""
...
PASS = "pass833_dm1_v1_box_entrance_dungeon_view_pc34_compat"
STATUS = "PASS833_DM1_V1_BOX_ENTRANCE_DUNGEON_VIEW_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_box_entrance_dungeon_view_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/box_entrance_dungeon_view_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_box_entrance_dungeon_view_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_box_entrance_dungeon_view_table_pc34",
    "dm1_v1_box_entrance_dungeon_view_get_pc34",
    "dm1_v1_box_entrance_dungeon_view_x_pc34",
    "kEntrX",
    "kEntrY",
    "kEntrW",
    "kEntrH",
    "G0006_ai_Graphic562_Box_Entrance_DungeonView",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_box_entrance_dungeon_view_pc34_compat",
    "src/dm1/dm1_v1_box_entrance_dungeon_view_pc34_compat.c",
    "NAME dm1_v1_box_entrance_dungeon_view_pc34_compat",
    f"verify_{PASS}",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (12, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
        (131, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
        (551, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
    ],
    "ENTRANCE.C": [
        (178, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
        (181, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
        (184, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
        (187, "G0006_ai_Graphic562_Box_Entrance_DungeonView"),
    ],
}
...
def write_outputs(
    ...
    manifest = {
        ...
        "scope": (
            ...
            "{0, 223, 3, 138}. The {X, Y, W, H} byte-coordinate sub-"
            "rectangle for the entrance dungeon-view backdrop blit "
            "during the door-opening animation. Read sites: "
            "ENTRANCE.C:178/181/184/187 F0132_VIDEO_Blit(entrance "
            "dungeon-view backdrop, G0006, 0, 0, byteWidth, byteWidth, "
        ...
        "anchorDriftTodo": [
            "Re-pin DATA.C:131/551 + ENTRANCE.C:178/181/184/187 line "
    ...
    lines = [
        ...
        "- Gate: Graphics.dat item 562 init var G0006_ai_Graphic562_"
        "Box_Entrance_DungeonView[4] = {0, 223, 3, 138}. The "
        "{X, Y, W, H} byte-coordinate sub-rectangle for the "
        "entrance dungeon-view backdrop blit during the door-"
        "opening animation. Read sites: ENTRANCE.C:178/181/184/187 "
        "F0132_VIDEO_Blit.",
        "- Runtime assertion floor: 53 assertions in `tests/test_dm1_v1_"
        "box_entrance_dungeon_view_pc34_compat.c`.",
    ...
    if drift:
        lines.extend(["", "## TODO", ""])
        lines.append(
            "- Anchor drift note: re-pin DATA.C:131/551, ENTRANCE.C:"
...
def main() -> int:
    ...
    runs = [
        run([str(build_dir / "test_dm1_v1_box_entrance_dungeon_view_pc34_compat")])
    ]
