...
MATRIX = [
    ...
    },
    {
        ...
        "status": "VERIFIED_SOURCE_AND_RUNTIME",
        "evidence": ["tools/verify_dm1_v1_hall_of_champions_full_source_lock.py", "tests/test_dm1_v1_resurrection_pc34_compat.c", "probes/m11/firestaff_m11_hall_walkaround_runtime_probe.c"],
    ...
    },
    {
        ...
        "evidence": ["tests/test_dm1_v1_resurrection_pc34_compat.c", "probes/m11/firestaff_m11_hall_walkaround_runtime_probe.c"],
    ...
    },
    {
        ...
        "evidence": ["tools/verify_dm1_v1_hall_mirror_sensor_disable_source_lock.py", "tests/test_dm1_v1_resurrection_pc34_compat.c"],
