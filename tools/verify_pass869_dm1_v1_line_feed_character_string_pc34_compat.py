...
PASS = "pass869_dm1_v1_line_feed_character_string_pc34_compat"
STATUS = "PASS869_DM1_V1_LINE_FEED_CHARACTER_STRING_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_line_feed_character_string_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/line_feed_character_string_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_line_feed_character_string_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_line_feed_character_string_table_pc34",
    "DATA.C:114",
    "DATA.C:536",
    "G0066_ac_Graphic562_LineFeedCharacterString",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_line_feed_character_string_pc34_compat",
    "src/dm1/dm1_v1_line_feed_character_string_pc34_compat.c",
    "NAME dm1_v1_line_feed_character_string_pc34_compat",
    "verify_pass869_dm1_v1_line_feed_character_string_pc34_compat",
]

REDMCSB_WINDOWS = {
    "DATA.C": [
        (114, "G0066_ac_Graphic562_LineFeedCharacterString"),
        (536, "G0066_ac_Graphic562_LineFeedCharacterString"),
    ],
}
...
def main():
    local_checks = [
        ...
        check_needles("header_api_surface", HDR, ["dm1_v1_line_feed_character_string_table_pc34"]),
