#!/usr/bin/env python3
"""DM1 V1 endgame_restart_inner contract (PASS845)."""
...
PASS = "pass845_dm1_v1_endgame_restart_inner_pc34_compat"
STATUS = "PASS845_DM1_V1_ENDGAME_RESTART_INNER_LOCKED"
SRC = ROOT / "src/dm1/dm1_v1_endgame_restart_inner_pc34_compat.c"
HDR = ROOT / "include/firestaff/dm1/v1/endgame_restart_inner_pc34_compat.h"
TEST = ROOT / "tests/test_dm1_v1_endgame_restart_inner_pc34_compat.c"
...
LOCAL_NEEDLES = [
    "dm1_v1_endgame_restart_inner_table_pc34",
    "dm1_v1_endgame_restart_inner_get_pc34",
    "dm1_v1_endgame_restart_inner_x_pc34",
    "dm1_v1_endgame_restart_inner_y_pc34",
    "dm1_v1_endgame_restart_inner_w_pc34",
    "dm1_v1_endgame_restart_inner_h_pc34",
    "Disjoint from pass784-790",
]

CMAKE_NEEDLES = [
    "test_dm1_v1_endgame_restart_inner_pc34_compat",
    "src/dm1/dm1_v1_endgame_restart_inner_pc34_compat.c",
    "NAME dm1_v1_endgame_restart_inner_pc34_compat",
    "verify_" + PASS,
]
...
def main():
    checks = [
        ...
        check_needles('header', HDR, ['dm1_v1_endgame_restart_inner_table_pc34']),
        check_needles('test', TEST, ['test_table_values', 'test_components_non_negative']),
        check_needles('cmake', CMAKE, CMAKE_NEEDLES),
    ]
    runs = [run([str(ROOT / "build" / "test_dm1_v1_endgame_restart_inner_pc34_compat")])]
    ...
    manifest = {
        ...
        'scope': 'DM1 V1 endgame_restart_inner contract.',
        'anchors': ANCHORS,
        'redmcsbRoot': str(RED),
        'sourceChecks': checks,
