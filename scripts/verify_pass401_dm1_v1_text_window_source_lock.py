#!/usr/bin/env python3
"""Pass401 verifier: DM1 V1 message-area/text-window source lock.
...
def main() -> int:
    ...
    ap.add_argument("--build-dir", type=Path, default=Path.home() / ".firestaff/data/firestaff-builds/pass401-text-window-gpt")
    ...
    if args.run_ctest:
        ...
        results["runtime"] = [cfg, bld, tst]
        ok = ok and cfg["passed"] and bld["passed"] and tst["passed"]
