...
launch=(
    ...
    FIRESTAFF_THERON_RAM_PROVENANCE_DIRECT="${THERON_CAPTURE_RAM_PROVENANCE_DIRECT:-0}" \
    FIRESTAFF_THERON_RECORD_WATCH_TRACE="$record_watch_trace" \
...
transition_ram_provenance_direct_count=$(trace_count '^theron_ram_provenance_direct ' "$ram_provenance_trace")
...
transition_vdc_io_write_count=$(trace_count '^vdc_io_write ' "$vdc_io_trace")
{
    ...
    printf 'ram_provenance_direct=%s\n' "$transition_ram_provenance_direct_count"
    printf 'ram_provenance_direct_enabled=%s\n' "${THERON_CAPTURE_RAM_PROVENANCE_DIRECT:-0}"
