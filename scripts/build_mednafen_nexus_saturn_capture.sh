...
source_trace_patch_id='FIRESTAFF_NEXUS_SH2_SOURCE_TRACE_V2_ALL_ACCESS_WIDTHS'
...
vdp1_trace_patch_id='FIRESTAFF_NEXUS_VDP1_WRITE_TRACE_V5_CODE_TARGETED_SNAPSHOT_FRAME_BOUND'
