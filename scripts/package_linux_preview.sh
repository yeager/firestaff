...
cp "$ROOT/assets/branding/firestaff-startup-dungeon-v2.ppm" "$DEB_ROOT/usr/share/firestaff/firestaff-startup-dungeon-v2.ppm"
...
cp "$ROOT/assets/branding/firestaff-startup-dungeon-v2.ppm" "$RPM_ROOT/usr/share/firestaff/firestaff-startup-dungeon-v2.ppm"
