...
OUT_DIR=${1:-$HERE/verification-m11/pass43-bar-graphs}
mkdir -p "$OUT_DIR"

PROBE_BIN="$HERE/firestaff_m11_pass43_bar_graph_probe_bin"
LOG="$OUT_DIR/pass43_bar_graph_probe.log"

# SDL3 flags for audio_sdl_m11.c parity with the main game-view probe.
SDL3_CFLAGS=""
SDL3_LIBS=""
