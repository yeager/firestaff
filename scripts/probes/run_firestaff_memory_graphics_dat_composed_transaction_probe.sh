...
cc -std=c99 -Wall -Wextra -pedantic -DCOMPILE_H '-DSTATICFUNCTION=static' '-DSEPARATOR=,' '-DFINAL_SEPARATOR=)'   -I$HERE   $HERE/test_memory_graphics_dat_composed_transaction_pc34_compat_integration.c   $HERE/memory_graphics_dat_composed_transaction_pc34_compat.c   $HERE/memory_graphics_dat_select_pc34_compat.c   $HERE/memory_graphics_dat_header_pc34_compat.c   $HERE/memory_graphics_dat_metadata_pc34_compat.c   $HERE/memory_graphics_dat_transaction_pc34_compat.c   $HERE/memory_graphics_dat_pc34_compat.c   -o $HERE/test_memory_graphics_dat_composed_transaction_pc34_compat_integration
$HERE/test_memory_graphics_dat_composed_transaction_pc34_compat_integration
