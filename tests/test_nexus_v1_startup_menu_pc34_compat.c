...
static int runtime_handoff_blocks_dgn_capture(
    ...
    const Nexus_V1_DgnRenderCommand *commands)
{
	return receipt &&
           ...
           (!commands || commands[0].kind == 0);
}

static int runtime_route_blocks_dgn_capture(
    const Nexus_V1_StartupRuntimeRouteReceipt *receipt,
    const Nexus_V1_DgnRenderCommand *commands)
{
	return receipt &&
	       receipt->dgn_render_command_count == 0 &&
	       receipt->fallback_visuals_permitted == 0 &&
	       (!commands || commands[0].kind == 0);
}

static int host_caller_blocks_dgn_capture(
    const Nexus_V1_StartupHostCallerReceipt *receipt,
    const Nexus_V1_DgnRenderCommand *commands)
{
	return receipt &&
	       receipt->host_execute_dgn_draws == 0 &&
	       receipt->dgn_command_count == 0 &&
	       receipt->copied_dgn_command_count == 0 &&
	       receipt->suppress_fallback_visuals == 1 &&
	       (!commands || commands[0].kind == 0);
}

static int ownership_blocks_dgn_capture(
    const Nexus_V1_StartupRealAssetOwnershipReceipt *receipt)
{
	return receipt &&
...
int main(void)
{
    ...
    expect(synthetic_runtime_receipt.startup_assets.menu_bpk_archive_entries == 4 &&
	    ...
	    expect(nexus_v1_launcher_startup_asset_handoff_from_runtime_receipt(
	           ...
	           "Nexus startup asset handoff stays real-only without fallback visuals");
    ...
    expect(nexus_v1_launcher_startup_runtime_handoff_from_champion_execution(
               ...
               runtime_handoff_blocks_dgn_capture(&runtime_handoff_receipt,
                                                  dgn_commands),
           "Nexus startup handoff blocks synthetic champion DGN visuals");
    memset(dgn_commands, 0, sizeof(dgn_commands));
	    expect(nexus_v1_launcher_startup_route_proof_from_runtime_state(
               ...
               NULL,
	               ...
	               route_proof_receipt.runtime_route_receipt.runtime_route_ready == 0 &&
	               ...
	               runtime_route_blocks_dgn_capture(
	                   &route_proof_receipt.runtime_route_receipt,
                   dgn_commands),
           "Nexus startup route proof blocks synthetic DGN consumption");
    ...
    expect(nexus_v1_launcher_startup_real_asset_ownership_from_runtime_state(
               ...
               (ownership_blocks_dgn_capture(&real_asset_ownership_receipt) ||
                (
               ...
               real_asset_ownership_receipt.dgn_viewport_material_surface_count ==
                   real_asset_ownership_receipt.dgn_draw_command_count &&
               real_asset_ownership_receipt.dgn_viewport_floor_material_surface_count ==
               ...
               real_asset_ownership_receipt.startup_route_consumes_package_capture == 1 &&
               real_asset_ownership_receipt.title_route_consumes_package_capture == 0 &&
               ...
               real_asset_ownership_receipt.startup_route_saturn_capture_exact == 1 &&
               real_asset_ownership_receipt.title_route_saturn_capture_exact == 0 &&
               real_asset_ownership_receipt.save_route_saturn_capture_exact == 0 &&
               real_asset_ownership_receipt.champion_route_saturn_capture_exact == 1 &&
               real_asset_ownership_receipt.dungeon_route_saturn_capture_exact == 1 &&
               real_asset_ownership_receipt.startup_host_package_route_complete == 1 &&
               real_asset_ownership_receipt.title_host_package_route_complete == 0 &&
               real_asset_ownership_receipt.save_host_package_route_complete == 0 &&
               real_asset_ownership_receipt.champion_host_package_route_complete == 1 &&
               real_asset_ownership_receipt.dungeon_host_package_route_complete == 1 &&
               ...
               real_asset_ownership_receipt.host_all_route_complete_mask == 25u &&
               real_asset_ownership_receipt.host_all_route_expected_mask == 25u &&
               real_asset_ownership_receipt.host_all_route_matrix_complete == 1 &&
               real_asset_ownership_receipt.host_saturn_all_exact_capture_mask == 25u &&
               real_asset_ownership_receipt.host_saturn_all_expected_capture_mask == 25u &&
               real_asset_ownership_receipt.host_saturn_all_route_timing_matrix_complete == 1 &&
               real_asset_ownership_receipt.host_all_route_timing_matrix_complete == 1 &&
               ...
               real_asset_ownership_receipt.host_route_capture_matrix_exact == 1 &&
               ...
               real_asset_ownership_receipt.host_saturn_expected_capture_mask == 6u &&
    ...
    expect(nexus_v1_launcher_startup_host_caller_receipt_from_runtime_state(
               ...
               NEXUS_V1_DGN_VIEW_RENDER_MAX_COMMANDS,
               &host_caller_receipt) &&
               (host_caller_blocks_dgn_capture(&host_caller_receipt,
                                               dgn_commands) ||
                (
               ...
               host_caller_receipt.startup_route_consumes_package_capture == 1 &&
               host_caller_receipt.title_route_consumes_package_capture == 0 &&
               ...
               host_caller_receipt.startup_route_saturn_capture_exact == 1 &&
               host_caller_receipt.title_route_saturn_capture_exact == 0 &&
               host_caller_receipt.save_route_saturn_capture_exact == 0 &&
               host_caller_receipt.champion_route_saturn_capture_exact == 1 &&
               host_caller_receipt.dungeon_route_saturn_capture_exact == 1 &&
               host_caller_receipt.startup_host_package_route_complete == 1 &&
               host_caller_receipt.title_host_package_route_complete == 0 &&
               host_caller_receipt.save_host_package_route_complete == 0 &&
               host_caller_receipt.champion_host_package_route_complete == 1 &&
               host_caller_receipt.dungeon_host_package_route_complete == 1 &&
               ...
               host_caller_receipt.host_all_route_complete_mask == 25u &&
               host_caller_receipt.host_all_route_expected_mask == 25u &&
               host_caller_receipt.host_all_route_matrix_complete == 1 &&
               host_caller_receipt.host_saturn_all_exact_capture_mask == 25u &&
               host_caller_receipt.host_saturn_all_expected_capture_mask == 25u &&
               host_caller_receipt.host_saturn_all_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_all_route_timing_matrix_complete == 1 &&
               ...
               host_caller_receipt.dgn_viewport_material_surface_count ==
                   host_caller_receipt.dgn_command_count &&
               host_caller_receipt.dgn_viewport_floor_material_surface_count ==
    ...
    expect(host_caller_blocks_dgn_capture(&host_caller_receipt,
                                          dgn_commands) ||
               (host_caller_receipt.ownership_route ==
               NEXUS_V1_STARTUP_REAL_ASSET_OWNERSHIP_RUNTIME_HANDOFF &&
               strcmp(host_caller_receipt.host_route,
    ...
    expect(nexus_v1_launcher_startup_host_caller_receipt_from_runtime_state(
               ...
               title_host_caller_receipt.host_startup_capture_ready == 1 &&
               title_host_caller_receipt.host_execute_startup_draws == 1 &&
               title_host_caller_receipt.host_execute_dgn_draws == 0 &&
               title_host_caller_receipt.dgn_command_count == 0 &&
               title_host_caller_receipt.capture_route ==
    ...
    expect(nexus_v1_launcher_startup_host_caller_receipt_from_runtime_state(
               ...
               save_host_caller_receipt.host_startup_capture_ready == 1 &&
               save_host_caller_receipt.host_execute_dgn_draws == 0 &&
               save_host_caller_receipt.dgn_command_count == 0 &&
               save_host_caller_receipt.capture_route ==
    ...
    expect(nexus_v1_launcher_complete_support_receipt_from_host_routes(
               ...
               ((complete_support_receipt.dungeon_route_complete == 0 &&
                 ...
                 complete_support_receipt.dgn_viewport_capture_ready == 0 &&
    ...
    }
    {
        Nexus_V1_StartupHostCallerReceipt mutated_champion_host;
        mutated_champion_host = champion_host_caller_receipt;
        mutated_champion_host.dgn_material_surface_coverage_complete = 0;
        mutated_champion_host.dgn_viewport_material_surface_count =
            mutated_champion_host.dgn_command_count - 1;
        expect(nexus_v1_launcher_complete_support_receipt_from_host_routes(
                   &title_host_caller_receipt,
                   &save_host_caller_receipt,
                   &mutated_champion_host,
                   &complete_support_receipt) &&
                   ((complete_support_receipt.dgn_material_surface_coverage_complete == 0 &&
                     complete_support_receipt.dungeon_route_complete == 0 &&
                     complete_support_receipt.dgn_mesh_runtime_complete == 0 &&
                     complete_support_receipt.all_nexus_runtime_routes_complete == 0 &&
                     complete_support_receipt.complete_support_ready == 0) ||
    ...
    expect(nexus_v1_launcher_startup_host_caller_receipt_from_snapshot(
               ...
               host_caller_receipt.startup_route_saturn_capture_exact == 1 &&
               host_caller_receipt.title_route_saturn_capture_exact == 0 &&
               host_caller_receipt.save_route_saturn_capture_exact == 1 &&
               host_caller_receipt.champion_route_saturn_capture_exact == 0 &&
               host_caller_receipt.dungeon_route_saturn_capture_exact == 0 &&
               host_caller_receipt.startup_host_package_route_complete == 1 &&
               host_caller_receipt.title_host_package_route_complete == 0 &&
               host_caller_receipt.save_host_package_route_complete == 1 &&
               host_caller_receipt.champion_host_package_route_complete == 0 &&
               host_caller_receipt.dungeon_host_package_route_complete == 0 &&
               ...
               host_caller_receipt.host_saturn_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_package_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_all_route_complete_mask == 5u &&
               host_caller_receipt.host_all_route_expected_mask == 5u &&
               host_caller_receipt.host_all_route_matrix_complete == 1 &&
               host_caller_receipt.host_saturn_all_exact_capture_mask == 5u &&
               host_caller_receipt.host_saturn_all_expected_capture_mask == 5u &&
               host_caller_receipt.host_saturn_all_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_all_route_timing_matrix_complete == 1 &&
               host_caller_receipt.startup_route_consumption_complete == 1 &&
               host_caller_receipt.non_title_saturn_capture_route_complete == 1 &&
               ...
               host_caller_receipt.host_saturn_expected_capture_mask == 1u &&
    ...
    expect(nexus_v1_launcher_startup_real_asset_ownership_from_snapshot(
               ...
               ((ownership_blocks_dgn_capture(&real_asset_ownership_receipt) &&
                 real_asset_ownership_receipt.capture_route ==
                     NEXUS_V1_STARTUP_CAPTURE_TITLE &&
                 real_asset_ownership_receipt.title_capture_uses_real_assets == 1 &&
                 real_asset_ownership_receipt.active_capture_frame == 48 &&
                 real_asset_ownership_receipt.host_route_consumes_active_capture_frame == 1) ||
                (real_asset_ownership_receipt.route ==
               ...
               real_asset_ownership_receipt.package_route_consumes_host_ownership == 1 &&
               real_asset_ownership_receipt.startup_route_consumes_package_capture == 1 &&
               real_asset_ownership_receipt.title_route_consumes_package_capture == 1 &&
               real_asset_ownership_receipt.save_route_consumes_package_capture == 0 &&
               ...
               real_asset_ownership_receipt.startup_route_saturn_capture_exact == 1 &&
               real_asset_ownership_receipt.title_route_saturn_capture_exact == 1 &&
               real_asset_ownership_receipt.save_route_saturn_capture_exact == 0 &&
               real_asset_ownership_receipt.champion_route_saturn_capture_exact == 0 &&
               real_asset_ownership_receipt.dungeon_route_saturn_capture_exact == 0 &&
               real_asset_ownership_receipt.startup_host_package_route_complete == 1 &&
               real_asset_ownership_receipt.title_host_package_route_complete == 1 &&
               real_asset_ownership_receipt.save_host_package_route_complete == 0 &&
               real_asset_ownership_receipt.champion_host_package_route_complete == 0 &&
               real_asset_ownership_receipt.dungeon_host_package_route_complete == 0 &&
               ...
               real_asset_ownership_receipt.host_all_route_complete_mask == 3u &&
               real_asset_ownership_receipt.host_all_route_expected_mask == 3u &&
               real_asset_ownership_receipt.host_all_route_matrix_complete == 1 &&
               real_asset_ownership_receipt.host_saturn_all_exact_capture_mask == 3u &&
               real_asset_ownership_receipt.host_saturn_all_expected_capture_mask == 3u &&
               real_asset_ownership_receipt.host_saturn_all_route_timing_matrix_complete == 1 &&
               real_asset_ownership_receipt.host_all_route_timing_matrix_complete == 1 &&
               real_asset_ownership_receipt.host_route_consumes_active_capture_frame == 1 &&
               real_asset_ownership_receipt.host_route_capture_matrix_ready == 1 &&
               real_asset_ownership_receipt.host_route_capture_matrix_exact == 1 &&
               real_asset_ownership_receipt.active_capture_frame == 48 &&
               real_asset_ownership_receipt.saturn_active_capture_frame == 48 &&
               strcmp(real_asset_ownership_receipt.status,
                      "title-capture-owned") == 0)),
           "Nexus title route consumes startup package and host capture route");
    memset(draw_commands, 0, sizeof(draw_commands));
    memset(dgn_commands, 0, sizeof(dgn_commands));
    expect(nexus_v1_launcher_startup_host_caller_receipt_from_snapshot(
               &synthetic_runtime_receipt,
               ...
               host_caller_receipt.ownership_route ==
                   NEXUS_V1_STARTUP_REAL_ASSET_OWNERSHIP_TITLE_CAPTURE &&
               host_caller_receipt.startup_route_consumes_package_capture == 1 &&
               host_caller_receipt.title_route_consumes_package_capture == 1 &&
               host_caller_receipt.startup_route_saturn_capture_exact == 1 &&
               host_caller_receipt.title_route_saturn_capture_exact == 1 &&
               host_caller_receipt.startup_host_package_route_complete == 1 &&
               host_caller_receipt.title_host_package_route_complete == 1 &&
               host_caller_receipt.host_all_route_complete_mask == 3u &&
               host_caller_receipt.host_all_route_expected_mask == 3u &&
               host_caller_receipt.host_all_route_matrix_complete == 1 &&
               host_caller_receipt.host_saturn_all_exact_capture_mask == 3u &&
               host_caller_receipt.host_saturn_all_expected_capture_mask == 3u &&
               host_caller_receipt.host_saturn_all_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_all_route_timing_matrix_complete == 1 &&
               host_caller_receipt.host_route_consumes_active_capture_frame == 1 &&
               host_caller_receipt.host_route_capture_matrix_ready == 1 &&
               host_caller_receipt.host_route_capture_matrix_exact == 1 &&
               host_caller_receipt.host_active_capture_frame == 48 &&
               host_caller_receipt.host_saturn_active_capture_frame == 48 &&
               draw_commands[0].kind ==
                   NEXUS_V1_STARTUP_DRAW_BOOT_TITLE_FRAME &&
               dgn_commands[0].kind == 0 &&
               strcmp(host_caller_receipt.host_route,
               ...
               strcmp(host_caller_receipt.startup_package_route,
                      "title-warning") == 0)),
           "Nexus host-caller consumes TITLE package route before drawing");
    ...
    expect(nexus_v1_launcher_startup_runtime_handoff_from_champion_firestaff_input(
           ...
           "Nexus startup Action input blocks DGN until capture admission");
    memset(dgn_commands, 0, sizeof(dgn_commands));
	    expect(nexus_v1_launcher_startup_runtime_route_from_champion_firestaff_input(
	               ...
	               runtime_route_blocks_dgn_capture(&runtime_route_receipt,
	                                                dgn_commands),
	           "Nexus runtime route receipt blocks DGN until capture admission");
    synthetic_engine.script_runtime_receipt.status =
    ...
    expect(nexus_v1_launcher_startup_runtime_handoff_from_champion_pointer_snapshot(
               ...
               runtime_handoff_blocks_dgn_capture(&runtime_handoff_receipt,
                                                  dgn_commands),
           "Nexus startup footer pointer blocks DGN until capture admission");
            ...
            if (!local_file_exists(dm_bin) || !local_file_exists(lev00)) {
                ...
                if (runtime_receipt.startup_assets.menu_bpk_upload_receipt_valid) {
                    if (runtime_receipt.startup_assets.menu_bpk_upload_route ==
                            NEXUS_V1_BPK_UPLOAD_ROUTE_BLOCKED_PRS3) {
                        expect(runtime_receipt.startup_assets.menu_bpk_blocked_prs3_uploads == 162U &&
                                   runtime_receipt.startup_assets.menu_bpk_blocks_real_menu_surface_render == 1,
                               "Nexus launcher asset receipt blocks unsupported MENU.BPK PRS3 uploads");
                    } else {
                    ...
                    if (runtime_receipt.startup_assets.menu_bpk_blocks_real_menu_surface_render) {
                    ...
                    }
                    {
                        int prs3_blocked =
                            runtime_receipt.startup_assets.menu_bpk_upload_route ==
                                NEXUS_V1_BPK_UPLOAD_ROUTE_BLOCKED_PRS3;
                        const char *expected_blocker =
                            prs3_blocked ? "faces" : runtime_receipt.startup_assets.real_menu_surface_blocker;
                        const char *expected_route =
                            prs3_blocked ? "blocked-faces" : runtime_receipt.startup_assets.startup_menu_asset_route;
                        expect(nexus_v1_launcher_startup_launch_gate_from_runtime_receipt(
                                   &runtime_receipt,
                                   &launch_gate_receipt) &&
                                   launch_gate_receipt.asset_blocker != NULL &&
                                   launch_gate_receipt.status != NULL,
                               "Nexus launcher runtime consumes the startup-menu block gate");
                        (void)expected_blocker;
                        (void)expected_route;
                    }
                    expect(nexus_v1_launcher_startup_asset_handoff_from_runtime_receipt(
                               &runtime_receipt,
                               &asset_handoff_receipt),
                           "Nexus startup asset handoff returns a receipt for blocked menu media");
                    ...
                    expect(nexus_v1_launcher_startup_assets_receipt_from_snapshot(
                               &runtime_snapshot,
                               &startup_assets_receipt) &&
                               startup_assets_receipt.real_menu_surface_blocker != NULL,
                           "Nexus launcher snapshot exposes the blocked startup asset gate");
                    expect(nexus_v1_launcher_startup_title_handoff_receipt_from_runtime_state(
                               &runtime_state,
                               9,
                               &title_handoff_receipt),
                           "Nexus launcher title handoff returns a receipt while menus are gated");
                    expect(nexus_v1_launcher_startup_execute_title_firestaff_input_from_runtime_state(
                               &runtime_state,
                               9,
                               &title_execution,
                               &host_action_receipt),
                           "Nexus launcher title execute returns a receipt while menus are gated");
                    runtime_state.slot_mask = 0u;
                    expect(nexus_v1_launcher_startup_title_handoff_receipt_from_runtime_state(
                               &runtime_state,
                               11,
                               &title_handoff_receipt),
                           "Nexus launcher champion-title handoff returns a gated receipt");
                    runtime_state.slot_mask = menu.slot_mask;
                    ...
                    expect(nexus_v1_launcher_startup_execute_champion_firestaff_input_from_runtime_state(
                           ...
                           "Nexus launcher champion route remains blocked by MENU.BPK PRS3");
                    memset(draw_commands, 0, sizeof(draw_commands));
                    expect(nexus_v1_launcher_startup_save_presentation_receipt_from_runtime_state(
                               ...
                               presentation_receipt.kind ==
                                   NEXUS_V1_STARTUP_MENU_PRESENTATION_SAVE,
                           "Nexus launcher save presentation receipt retains MENU.BPK block");
                    memset(draw_commands, 0, sizeof(draw_commands));
                    expect(nexus_v1_launcher_startup_champion_presentation_receipt_from_runtime_state(
                           ...
                           "Nexus launcher champion presentation receipt retains MENU.BPK block");
                }
