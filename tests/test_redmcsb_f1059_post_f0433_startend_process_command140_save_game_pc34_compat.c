...
int main(void)
{
    ...
    assert(strstr(evidence, "LOADSAVE.C:1783-1801") != NULL);
    ...
    assert(strstr(evidence, "AMIGA.H:403") != NULL);
    assert(strstr(evidence, "No PC 3.4 branch") != NULL);

    puts("ok: ReDMCSB F1059 post-save-game fake-code boundary");
    return 0;
}
