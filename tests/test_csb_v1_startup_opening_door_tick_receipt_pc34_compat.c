    ...
    CSB_V1_StartupRuntimeHostSurfaceReceipt_PC34 *host_surface)
{
    ...
    left_door->source_x = 0;
    left_door->source_y = 0;
    left_door->source_kind = CSB_V1_STARTUP_RUNTIME_SURFACE_SOURCE_GRAPHICS_DAT_PC34;
    left_door->width = 105;
    ...
    right_door->source_x = 0;
    right_door->source_y = 0;
    right_door->source_kind = CSB_V1_STARTUP_RUNTIME_SURFACE_SOURCE_GRAPHICS_DAT_PC34;
