...
int main(void)
{
    ...
    free(data);
    if (rc != NEXUS_V1_DGN_TEXTURE_DECODE_OK || r.source_verified || !r.direct_color_555 || r.width != 0x20 || r.height != 0x20) { fprintf(stderr, "FAIL: real direct-color texture decode\n"); return 1; }
