...
static const char *A_F0095 =
    "ReDMCSB DUNVIEW.C F0095:2124-2223; D2C floor route requested "
    "F0124:7874,7926; local F0121:7314,7357";
...
int main(void)
{
    ...
    printf("probe=csb_v1_viewport_d2c_f0095_floor_ornament_pc34_compat\n");
    rc = csb_v1_viewport_d2c_f0095_floor_ornament_run(&passed, &failed);
    ...
    expect_ge("run.assertions_cover_dungeon_map_anchor", passed, 70, A_DUNGEON);

    rc = csb_v1_viewport_d2c_f0095_floor_ornament_run(&rerun_passed,
                                                      &rerun_failed);
    ...
    rc = csb_v1_viewport_d2c_f0095_floor_ornament_run(NULL, NULL);
    expect_int("null_counters.return", rc, 0, A_F0095);
    rc = csb_v1_viewport_d2c_f0095_floor_ornament_run(&rerun_passed, NULL);
    expect_int("null_failed.return", rc, 0, A_F0095);
    expect_int("null_failed.passed_still_populated", rerun_passed, passed, A_F0095);
    rc = csb_v1_viewport_d2c_f0095_floor_ornament_run(NULL, &rerun_failed);
    ...
    if (g_failures == 0 && failed == 0) {
        printf("PASS csb_v1_viewport_d2c_f0095_floor_ornament_pc34_compat "
