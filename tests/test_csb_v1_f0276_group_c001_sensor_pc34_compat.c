...
int main(void)
{
    ...
    put_le16(raw, 74, DM1_SENSOR_FLOOR_THERON_PARTY_CREATURE_OBJECT);
    ...
    CHECK(profile.timeline_queue.eventCount == 1 &&
          ...
          "C001 group addition publishes the ReDMCSB F0268 fakewall event");
