...
int main(void) {
    ...
    version = M12_AssetStatus_GetVersion(&directRootStatus, "theron", 2U);
    ...
    version = M12_AssetStatus_GetVersion(&specificTheronStatus, "theron", 2U);
    check_int(version && version->matched &&
    ...
    version = M12_AssetStatus_GetVersion(&looseDirStatus, "theron", 2U);
    check_int(version && version->matched &&
