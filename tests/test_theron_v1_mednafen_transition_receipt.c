...
int main(void) {
    ...
    assert(theron_v1_mednafen_transition_region_for_track02_md5(
    ...
    assert(theron_v1_mednafen_transition_region_for_track02_md5(
           ...
           THERON_V1_MEDNAFEN_REGION_JP);
    assert(theron_v1_mednafen_transition_region_for_track02_md5(
               "not-a-real-track02-hash") ==
           THERON_V1_MEDNAFEN_REGION_UNKNOWN);
    assert(theron_v1_mednafen_transition_region_for_track02_md5(NULL) ==
           THERON_V1_MEDNAFEN_REGION_UNKNOWN);
