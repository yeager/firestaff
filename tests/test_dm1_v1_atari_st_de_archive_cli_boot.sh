...
app=$1
archive=${FIRESTAFF_DM1_ATARI_ST_DE_ARCHIVE:-
"$HOME/.firestaff/data/dm1/Dungeon-Master_Atari-ST_DE_Version-12.zip"}
...
printf '%s\n' 'PASS: authentic German DM1 Atari ST 1.2 ZIP -> STX reaches CLI and menu runtime'
