...
{
    int ok = 1;
    const DM1_V1_ViewportD1CF0115DoorFramePc34Contract *c =
...
static int test_f0115_order_pairing(void)
{
    ...
    ok &= expect_int("rear.order.role",
                     dm1_v1_viewport_d1c_f0115_door_frame_order_role_pc34(c, 0x0218),
                     1, A_F0124);
    ok &= expect_int("front.order.role",
                     dm1_v1_viewport_d1c_f0115_door_frame_order_role_pc34(c, 0x0349),
                     2, A_F0124);
    ok &= expect_int("invalid.order.zero",
                     dm1_v1_viewport_d1c_f0115_door_frame_order_role_pc34(c, 0),
                     0, A_F0115);
    ok &= expect_int("invalid.order.random",
                     dm1_v1_viewport_d1c_f0115_door_frame_order_role_pc34(c, 0x1234),
                     0, A_F0115);
    ok &= expect_int("null.order.role",
                     dm1_v1_viewport_d1c_f0115_door_frame_order_role_pc34(NULL, 0x0218),
                     0, A_F0115);
...
static int test_frame_zones_and_bitmaps(void)
{
    ...
    ok &= expect_int("zone.top.func",
                     dm1_v1_viewport_d1c_f0115_door_frame_zone_for_part_pc34(
                         c, DM1_V1_D1C_DOOR_FRAME_PART_TOP),
                     733, A_F0124);
    ok &= expect_int("zone.left.func",
                     dm1_v1_viewport_d1c_f0115_door_frame_zone_for_part_pc34(
                         c, DM1_V1_D1C_DOOR_FRAME_PART_LEFT),
                     726, A_F0124);
    ok &= expect_int("zone.right.func",
                     dm1_v1_viewport_d1c_f0115_door_frame_zone_for_part_pc34(
                         c, DM1_V1_D1C_DOOR_FRAME_PART_RIGHT),
                     727, A_F0124);
    ok &= expect_int("zone.invalid.func",
                     dm1_v1_viewport_d1c_f0115_door_frame_zone_for_part_pc34(c, 99),
                     -1, A_F0124);
    ok &= expect_int("zone.null.func",
                     dm1_v1_viewport_d1c_f0115_door_frame_zone_for_part_pc34(NULL, 0),
                     -1, A_F0124);
    ...
    ok &= expect_int("bitmap.invalid.null",
                     dm1_v1_viewport_d1c_f0115_door_frame_bitmap_for_part_pc34(c, 99) == NULL,
                     1, A_F0124);
    ok &= expect_int("bitmap.null.contract",
                     dm1_v1_viewport_d1c_f0115_door_frame_bitmap_for_part_pc34(NULL, 0) == NULL,
                     1, A_F0124);
    ok &= expect_int("top.flip",
                     dm1_v1_viewport_d1c_f0115_door_frame_flip_for_part_pc34(
                         c, DM1_V1_D1C_DOOR_FRAME_PART_TOP),
                     0, A_F0104);
    ...
    ok &= expect_int("invalid.flip",
                     dm1_v1_viewport_d1c_f0115_door_frame_flip_for_part_pc34(c, 99),
                     -1, A_F0105);
    ok &= expect_int("null.flip",
                     dm1_v1_viewport_d1c_f0115_door_frame_flip_for_part_pc34(NULL, 0),
                     -1, A_F0105);
...
static int test_frame_blit_contract(void)
{
    ...
    ok &= expect_int("top.blit.copied",
                     dm1_v1_viewport_d1c_f0115_door_frame_apply_blit_pc34(
                         c, DM1_V1_D1C_DOOR_FRAME_PART_TOP,
    ...
    ok &= expect_int("blit.null.contract",
                     dm1_v1_viewport_d1c_f0115_door_frame_apply_blit_pc34(
                         NULL, DM1_V1_D1C_DOOR_FRAME_PART_TOP,
                         source, 3, top_dest, 3, 3, 2),
                     -1, A_F0104);
...
static int test_evidence_strings(void)
{
    ...
    const DM1_V1_ViewportD1CF0115DoorFramePc34Contract *c =
        dm1_v1_viewport_d1c_f0115_door_frame_pc34_contract();
    const char *e =
        dm1_v1_viewport_d1c_f0115_door_frame_pc34_source_evidence();
    ...
    ok &= expect_contains("anchor.f0128", c ? c->redmcsb_f0128_anchor : NULL,
                          "8524-8533", A_F0128);
    ok &= expect_contains("evidence.dm1", e, "DM1 V1 source-locked", A_F0124);
    ...
    ok &= expect_contains("evidence.right", e,
                          "F0105 horizontal flip of G2117_DoorFrameLeftD1C",
                          A_F0124);
    ...
    ok &= expect_contains("evidence.c10", e, "C10 transparent frame blits",
                          A_F0104);
    ok &= expect_contains("evidence.mask", e, "MASK0x0001", A_F0105);
...
int main(void)
{
    ...
    printf("probe=dm1_v1_viewport_d1c_f0115_door_frame_pc34_compat\n");
    ...
    if (ok && g_failures == 0) {
        printf("PASS dm1_v1_viewport_d1c_f0115_door_frame_pc34_compat assertions=%d failures=0\n",
               g_assertions);
    }
