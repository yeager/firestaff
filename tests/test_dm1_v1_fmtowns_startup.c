...
int main(void) {
    ...
    if(!dm1_v1_fmtowns_startup_receipt(a,as,g,gs,m,ms,i,is,n,ns,&r)||!dm1_v1_fmtowns_startup_receipt_is_native(&r)||r.language!=DM1_FMTOWNS_LANG_EN||strcmp(r.game_program_name,"EDM.EXP")||r.title_track!=2||r.hall_track!=3||r.entrance_track!=5) { fprintf(stderr,"FAIL: original FM Towns startup receipt\n"); return 1; }
