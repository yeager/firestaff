...
int main(void) {
    ...
    uint8_t *a=NULL,*g=NULL,*m=NULL,*i=NULL,*n=NULL; size_t as=0,gs=0,ms=0,is=0,ns=0; DM1_V1_FmtownsStartupReceipt r, directoryReceipt;
