...
int main(void)
{
    const DM1_V1_D2L2D2R2F0108SelfTestResultPc34 *result;
    const int ok = run_dm1_v1_viewport_d2l2_d2r2_f0108_floor_ceiling_ornament_self_test();

    result = dm1_v1_viewport_d2l2_d2r2_f0108_last_self_test_result_pc34();
    if (!ok || !result || result->failures != 0) {
        printf("FAIL test_dm1_v1_viewport_d2l2_d2r2_f0108_floor_ceiling_ornament_pc34_compat "
    ...
    printf("PASS test_dm1_v1_viewport_d2l2_d2r2_f0108_floor_ceiling_ornament_pc34_compat "
           "assertions=%d failures=0 d2l2_floor=%d d2r2_floor=%d footprint_recursions=%d "
