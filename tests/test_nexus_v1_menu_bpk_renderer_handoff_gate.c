                               ...
                               int can_render)
{
    ...
    expect(receipt.blocks_real_menu_surface_render == !can_render,
           "non-renderable MENU.BPK routes block real menu render");
    expect(!receipt.fallback_visuals_permitted,
...
int main(void)
{
    ...
    check_decode_route(NEXUS_V1_BPK_DECODE_ROUTE_INVALID,
                       NEXUS_V1_MENU_BPK_RENDERER_HANDOFF_INVALID, 0);
    check_decode_route(NEXUS_V1_BPK_DECODE_ROUTE_NO_SURFACES,
                       NEXUS_V1_MENU_BPK_RENDERER_HANDOFF_NO_SURFACES, 0);
    check_decode_route(NEXUS_V1_BPK_DECODE_ROUTE_BLOCKED_PRS3,
                       NEXUS_V1_MENU_BPK_RENDERER_HANDOFF_BLOCKED_PRS3, 0);
