...
{
    const DM1_V1_MirrorCandidateC045FoodWaterCloseEvidencePc34 *e =
...
static void test_initial_state(void)
{
    ...
    DM1_V1_MirrorCandidateC045FoodWaterCloseNoCandidate_InitPc34(&state);
...
static uint32_t test_run(void)
{
    ...
    DM1_V1_MirrorCandidateC045FoodWaterCloseNoCandidate_InitPc34(&state);
    ok = DM1_V1_MirrorCandidateC045FoodWaterCloseNoCandidate_RunPc34(
        &state, &result);
