...
int main(void) {
    ...
    expect_true(M12_AssetStatus_GameKnownHashCount("theron") == 5U,
                "Theron exposes US BIN/CloneCD, JP BIN and JP/US ISO Track 02 hashes");
    ...
    expect_true(M12_AssetStatus_FindVersionIndex("theron", "pce-jp-rev1-iso") == 4,
