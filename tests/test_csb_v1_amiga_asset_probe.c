...
int main(void)
{
    ...
    /* CSB Amiga v3.3 French Dungeon.DAT */
    ...
    /* CSB Amiga v3.3 French TITL.DAT */
    ...
    /* CSB Amiga v3.3 French ENDA.DAT */
    ...
    /* CSB Amiga v3.3 French SWSH.FTL */
    ...
    puts("ok: CSB Amiga asset probe (8 fingerprints verified)");
    return 0;
}
