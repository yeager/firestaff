...
int main(void)
{
    ...
    input.secondaryGraphicId = 0; input.runeValue = 0x69; input.sourceTick = 60;
    ...
    commands.commands[1] = (DM1_V1_ActionSpellRenderCommandPc34){ 2, 695, 221, 1, 0, 0, 0, 0, 1 };
    commands.commands[2] = (DM1_V1_ActionSpellRenderCommandPc34){ 2, 695, 255, 6, 0, 0, 0, 0, 1 };
    commands.commands[3] = (DM1_V1_ActionSpellRenderCommandPc34){ 2, 695, 261, 4, 0, 0, 0, 0, 1 };
