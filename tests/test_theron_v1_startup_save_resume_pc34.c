...
static void test_startup_session_facts_wrappers(void) {
    ...
    media_receipt.startup_bitmap_sample_count = 8;
    ...
    media_receipt.startup_bitmap_atlas.route_mask =
        media_receipt.startup_bitmap_atlas_route_mask;
    media_receipt.startup_bitmap_atlas.total_tile_count = 8u;
    media_receipt.startup_bitmap_atlas.total_nonzero_pixel_count = 96u;
    ...
    for (i = 0; i < 4; ++i) {
        size_t p;
        media_receipt.startup_bitmap_atlas.routes[i].tile_count = 2u;
        media_receipt.startup_bitmap_atlas.routes[i].width = 16u;
        media_receipt.startup_bitmap_atlas.routes[i].height = 8u;
        media_receipt.startup_bitmap_atlas.routes[i].nonzero_pixel_count = 24u;
...
static void test_track02_startup_bitmap_decode_receipt(void) {
    ...
    expect_true(theron_v1_track02_build_startup_bitmap_atlas(
                    ...
                    atlas.routes[2].raw_offsets[3] == span_offsets[1] + 12u &&
                    atlas.routes[3].width == 32u &&
                    atlas.routes[3].raw_offsets[0] == span_offsets[2] &&
                    atlas.routes[3].raw_offsets[3] == span_offsets[2] + 12u &&
    ...
    expect_true(receipt.startup_media_ready &&
                    ...
                    receipt.startup_bitmap_sample_count == 12 &&
                    ...
                    receipt.startup_bitmap_atlas.total_tile_count == 12u &&
                    receipt.startup_bitmap_atlas.routes[0].width == 16u &&
                    receipt.startup_bitmap_atlas.routes[2].width == 32u &&
                    ...
                    receipt.startup_bitmap_forcefield_sample_count == 2 &&
...
static void test_track02_startup_bitmap_decode_iso_receipt(void) {
    ...
    const size_t extended_iso_bitmap_bytes = 128u;
    ...
    expect_true(theron_v1_track02_catalog_startup_bitmap_samples(
                ...
                "Track02 startup bitmap catalog decodes extended ISO startup bitmap samples");
    expect_true(theron_v1_track02_build_startup_bitmap_atlas(
                    &catalog,
                    &atlas) == THERON_TRACK02_SIGNAL_OK &&
                    atlas.route_count == 4u &&
                    atlas.total_tile_count == 20u &&
                    atlas.route_mask ==
                        (THERON_TRACK02_STARTUP_BITMAP_ROUTE_TITLE |
                         THERON_TRACK02_STARTUP_BITMAP_ROUTE_STAGE |
                         THERON_TRACK02_STARTUP_BITMAP_ROUTE_SOUL_ROOM |
    ...
    expect_true(receipt.startup_media_ready &&
                    receipt.startup_bitmap_decode_status ==
                        THERON_TRACK02_SIGNAL_OK &&
                    receipt.startup_bitmap_sample_count == 20 &&
                    receipt.startup_bitmap_atlas_ready &&
                    receipt.startup_bitmap_atlas_route_count == 4 &&
                    receipt.startup_bitmap_atlas_tile_count == 20u &&
                    receipt.startup_bitmap_atlas_nonzero_pixel_count > 0u &&
                    receipt.startup_bitmap_atlas.route_count == 4u &&
                    receipt.startup_bitmap_atlas.total_tile_count == 20u &&
                    (receipt.startup_bitmap_route_mask &
                     THERON_TRACK02_STARTUP_BITMAP_ROUTE_TITLE) &&
                    (receipt.startup_bitmap_route_mask &
                     THERON_TRACK02_STARTUP_BITMAP_ROUTE_STAGE) &&
                    ...
                    theron_v1_startup_media_state_receipt_has_complete_bitmap_routes(
                        &receipt),
                "startup media receipt accepts extended ISO bitmaps as complete startup coverage");
