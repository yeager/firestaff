...
int main(void)
{
    ...
    check(csb_v1_startup_presentation_receipt_from_host_facts_pc34(
              ...
              receipt.render_plan.source_asset_id == 1 &&
              receipt.render_plan.title_source_x == 0 &&
              receipt.render_plan.title_source_y == 0 &&
              receipt.render_plan.title_source_w == 320 &&
              receipt.render_plan.title_source_h == 80 &&
    ...
    check(csb_v1_startup_presentation_receipt_from_host_facts_pc34(
              ...
              receipt.render_plan.source_asset_id == 1 &&
              receipt.render_plan.title_source_x == 0 &&
              receipt.render_plan.title_source_y == 80 &&
              receipt.render_plan.title_source_w == 320 &&
              receipt.render_plan.title_source_h == 57 &&
    ...
    check(csb_v1_startup_presentation_receipt_from_host_facts_pc34(
              ...
              receipt.render_plan.source_asset_id == 4 &&
              receipt.render_plan.opening_composite_screen_asset_id == 4 &&
              receipt.render_plan.opening_composite_left_asset_id == 2 &&
              receipt.render_plan.opening_composite_right_asset_id == 3,
