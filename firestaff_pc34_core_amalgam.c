...
#include "COMPILE.H"
#endif
char G0353_ac_StringBuildBuffer[150];
BOOLEAN G0355_B_ScrollMessageArea;
unsigned char* G0356_puc_Bitmap_MessageAreaNewRow; /* Width = 320 pixels = 160 bytes, Height = 7 pixels */
unsigned char* G0357_puc_InterfaceAndScrollsFont;
int16_t G2104_i_InterfaceAndScrollsFontCurrentTextColor = -1;
int16_t G2105_i_InterfaceAndScrollsFontCurrentBackgroundColor = -1;
unsigned char* G2148_puc_InterfaceAndScrollsFontCustomColors;
static int16_t G0358_i_MessageAreaCursorRow;
static int16_t G0359_i_MessageAreaCursorColumn;
long G0360_al_MessageAreaRowExpirationTime[M532_MESSAGE_AREA_ROW_COUNT];
...
BOOLEAN F0645_GetStringPixelDimensions(
REGISTER char* P2190_pc_String SEPARATOR
int16_t*       P2191_pi_Width  SEPARATOR
int16_t*       P2192_pi_Height FINAL_SEPARATOR
{
        REGISTER int16_t L3448_i_Width;
        REGISTER int16_t L3449__Height;


        if (P2190_pc_String == NULL) {
                return C0_FALSE;
        }
                L3448_i_Width = -G2084_C1_;
                L3449__Height = G2083_C6_ - G2086_C1_;
                while (*P2190_pc_String++) {
                        L3448_i_Width += G2087_C6_TextCharacterWidth;
                }
        if (L3448_i_Width <= 0) {
                return C0_FALSE;
        }
        *P2191_pi_Width = L3448_i_Width;
        *P2192_pi_Height = L3449__Height;
        return C1_TRUE;
}

/* Returns the width of the largest sub string of P2193_pc_String that starts at character P2195_pi_CharacterIndex and fits in P2196_i_Width. The substring is copied to P2194_pc_String */
int16_t F0646_GetLargestPrintableSubString(
REGISTER char*    P2193_pc_String         SEPARATOR
REGISTER char*    P2194_pc_String         SEPARATOR
REGISTER int16_t* P2195_pi_CharacterIndex SEPARATOR
int16_t           P2196_i_Width           FINAL_SEPARATOR
{
        REGISTER int16_t L3450_i_;
        REGISTER int16_t L3451_i_;
        REGISTER int16_t L3452_i_;
        REGISTER unsigned int16_t L3453_i_SpaceCharacterIndex;
        REGISTER int16_t L3455_i_;
        int16_t L3456_i_;


        L3450_i_ = *P2195_pi_CharacterIndex;
        L3452_i_ = 0;
        L3451_i_ = 0;
        L3453_i_SpaceCharacterIndex = 0xFFFF;
                for (;;) { /*_Infinite loop_*/
                        P2194_pc_String[L3452_i_] = 0;
                        if ((P2193_pc_String[L3450_i_] == '\n') || (P2193_pc_String[L3450_i_] == '\0')) {
                                *P2195_pi_CharacterIndex = L3450_i_;
                                return L3451_i_;
                        }
                        if (P2193_pc_String[L3450_i_] == ' ') {
                                L3453_i_SpaceCharacterIndex = L3450_i_;
                                L3455_i_ = L3452_i_;
                                L3456_i_ = L3451_i_;
                        }
                        if (L3451_i_ + G2087_C6_TextCharacterWidth >= P2196_i_Width) {
                                break;
                        }
                        L3451_i_ += G2087_C6_TextCharacterWidth;
                        P2194_pc_String[L3452_i_++] = P2193_pc_String[L3450_i_++];
                        continue;
                };
                if (L3453_i_SpaceCharacterIndex != 0xFFFF) {
                        *P2195_pi_CharacterIndex = L3453_i_SpaceCharacterIndex + 1;
                        P2194_pc_String[L3455_i_] = 0;
                        return L3456_i_;
                }
        *P2195_pi_CharacterIndex = L3450_i_;
        return L3451_i_;
...
unsigned char*   P0050_puc_Bitmap_Destination SEPARATOR
unsigned int16_t P0051_ui_Width               SEPARATOR
int16_t          P2197_i_ZoneIndex            SEPARATOR
int16_t          P0054_i_TextColor            SEPARATOR
int16_t          P0055_i_BackgroundColor      SEPARATOR
char*            P0056_pc_String              FINAL_SEPARATOR
{
        int16_t L3461_i_Width;
        int16_t L3462_i_Height;
        int16_t L3463_ai_XYZ[4];


        if (F0645_GetStringPixelDimensions(P0056_pc_String, &L3461_i_Width, &L3462_i_Height)) {
                if (F0635_(NULL, L3463_ai_XYZ, P2197_i_ZoneIndex, &L3461_i_Width, &L3462_i_Height)) {
                        M720_F0644_PrintTextAlt(P0050_puc_Bitmap_Destination, P0051_ui_Width, M704_ZONE_LEFT(L3463_ai_XYZ), M707_ZONE_BOTTOM(L3463_ai_XYZ), P0054_i_TextColor, P0055_i_BackgroundColor, P0056_pc_String, P0919_i_Height);
                }
        }
}

void F0041_TEXT_PrintWithTrailingSpaces(
unsigned char* P0057_puc_Bitmap_Destination SEPARATOR
int16_t        P0058_i_ByteWidth            SEPARATOR
int16_t        P0059_i_X                    SEPARATOR
int16_t        P0060_i_Y                    SEPARATOR
int16_t        P0061_i_TextColor            SEPARATOR
int16_t        P0062_i_BackgroundColor      SEPARATOR
REGISTER char* P0063_pc_String              SEPARATOR
int16_t        P0064_i_StringLength         FINAL_SEPARATOR
{
        char L0022_ac_String[80];
        REGISTER int16_t L0021_i_CharacterIndex;


        L0021_i_CharacterIndex = 0;
        while (L0022_ac_String[L0021_i_CharacterIndex] = *P0063_pc_String++) {
                L0021_i_CharacterIndex++;
        }
        for (; L0021_i_CharacterIndex < P0064_i_StringLength; L0021_i_CharacterIndex++) {
                L0022_ac_String[L0021_i_CharacterIndex] = ' ';
        }
        L0022_ac_String[L0021_i_CharacterIndex] = '\0';
        M720_F0644_PrintTextAlt(P0057_puc_Bitmap_Destination, P0058_i_ByteWidth, P0059_i_X, P0060_i_Y, P0061_i_TextColor, P0062_i_BackgroundColor, L0022_ac_String, P0920_i_Height);
}

void F0768_TEXT_PrintToZoneWithTrailingSpaces(
unsigned char* P0057_puc_Bitmap_Destination SEPARATOR
int16_t        P0058_i_ByteWidth            SEPARATOR
int16_t        P2198_i_ZoneIndex            SEPARATOR
int16_t        P0061_i_TextColor            SEPARATOR
int16_t        P0062_i_BackgroundColor      SEPARATOR
REGISTER char* P0063_pc_String              SEPARATOR
int16_t        P0064_i_StringLength         FINAL_SEPARATOR
{
        ...
        while (L0021_i_CharacterIndex < P0064_i_StringLength) {
                L0022_ac_String[L0021_i_CharacterIndex] = ' ';
                L0021_i_CharacterIndex++;
        }
        L0022_ac_String[L0021_i_CharacterIndex] = '\0';
        F0040_TEXT_Print(P0057_puc_Bitmap_Destination, P0058_i_ByteWidth, P2198_i_ZoneIndex, P0061_i_TextColor, P0062_i_BackgroundColor, L0022_ac_String);
}

void F0042_TEXT_MESSAGEAREA_MoveCursor(
REGISTER int16_t P0065_i_Column SEPARATOR
REGISTER int16_t P0066_i_Row    FINAL_SEPARATOR
{
        if (P0065_i_Column < 0) {
                P0065_i_Column = 0;
        }
        ...
        if (P0066_i_Row < 0) {
                ...
                if (P0066_i_Row >= M532_MESSAGE_AREA_ROW_COUNT) {
                        P0066_i_Row = M532_MESSAGE_AREA_ROW_COUNT - 1;
                }
        }
        G0358_i_MessageAreaCursorRow = P0066_i_Row;
        G0355_B_ScrollMessageArea = C0_FALSE;
}

void F0043_TEXT_MESSAGEAREA_ClearAllRows(
void
)
{
        REGISTER unsigned int16_t L0023_RowIndex;
        F0077_MOUSE_EnableScreenUpdate_CPSE();
        ...
        for (L0023_RowIndex = 0; L0023_RowIndex < M532_MESSAGE_AREA_ROW_COUNT; L0023_RowIndex++) {
                G0360_al_MessageAreaRowExpirationTime[L0023_RowIndex] = -1;
        }
}


void F0044_TEXT_MESSAGEAREA_ClearExpiredRows(
void
)
{
        REGISTER unsigned int16_t L0026_ui_RowIndex;
        REGISTER long L0027_l_ExpirationTime;
        int16_t L0028_ai_XYZ[4];
        REGISTER int16_t L3464_i_ZoneYBackup;


        F0638_GetZone(C015_ZONE_MESSAGE_AREA, L0028_ai_XYZ);
        L3464_i_ZoneYBackup = M706_ZONE_TOP(L0028_ai_XYZ);
        for (L0026_ui_RowIndex = 0; L0026_ui_RowIndex < M532_MESSAGE_AREA_ROW_COUNT; L0026_ui_RowIndex++) { /* ANOMALY_ASSEMBLY_COMPILATION_DIFFERENCE jmp */
                L0027_l_ExpirationTime = G0360_al_MessageAreaRowExpirationTime[L0026_ui_RowIndex];
                if ((L0027_l_ExpirationTime == -1) || (L0027_l_ExpirationTime > G0313_ul_GameTime))
                        continue;
                M706_ZONE_TOP(L0028_ai_XYZ) = L3464_i_ZoneYBackup + (L0026_ui_RowIndex * G2088_C7_TextLineHeight);
                M709_ZONE_HEIGHT(L0028_ai_XYZ) = G2083_C6_;
                F0077_MOUSE_EnableScreenUpdate_CPSE();
...
STATICFUNCTION void F0045_TEXT_MESSAGEAREA_CreateNewRow(
void
)
{
        REGISTER unsigned int16_t L0029_ui_RowIndex;
        ...
        if (G0358_i_MessageAreaCursorRow == M532_MESSAGE_AREA_ROW_COUNT - 1) {
                ...
                for (L0029_ui_RowIndex = 0; L0029_ui_RowIndex < M532_MESSAGE_AREA_ROW_COUNT - 1; L0029_ui_RowIndex++) {
...
STATICFUNCTION void F0046_TEXT_MESSAGEAREA_PrintString(
int16_t        P0067_i_TextColor SEPARATOR
REGISTER char* P0068_pc_String   FINAL_SEPARATOR
{
        REGISTER int16_t L0030_i_StringLength;
        int16_t L3465_ai_XYZ[4];


        F0638_GetZone(C015_ZONE_MESSAGE_AREA, L3465_ai_XYZ);
        L0030_i_StringLength = M544_STRLEN(P0068_pc_String);
        if (G0355_B_ScrollMessageArea) {
                F0644_PrintTextAlt(G0356_puc_Bitmap_MessageAreaNewRow, G2092_MessageAreaWidth, G0359_i_MessageAreaCursorColumn, G2088_C7_TextLineHeight - G2086_C1_ - 2, P0067_i_TextColor, C00_COLOR_BLACK, P0068_pc_String);
        } else {
                F0077_MOUSE_EnableScreenUpdate_CPSE();

                F0053_TEXT_PrintToLogicalScreen(M704_ZONE_LEFT(L3465_ai_XYZ) + G0359_i_MessageAreaCursorColumn, M706_ZONE_TOP(L3465_ai_XYZ) + (G0358_i_MessageAreaCursorRow * G2088_C7_TextLineHeight) + G2083_C6_ - G2086_C1_ - 1, P0067_i_TextColor, C00_COLOR_BLACK, P0068_pc_String);
                F0078_MOUSE_DisableScreenUpdate();
        }
        G0360_al_MessageAreaRowExpirationTime[G0358_i_MessageAreaCursorRow] = G0313_ul_GameTime + 70;
}

void F0047_TEXT_MESSAGEAREA_PrintMessage(
REGISTER int16_t P0069_i_TextColor SEPARATOR
REGISTER char*   P0070_pc_String   FINAL_SEPARATOR
{
        int16_t L0031_CharacterIndex;
        char L0033_ac_String[100];
        REGISTER int16_t L3466_i_Width;
        ...
        L0031_CharacterIndex = 0;
        while (P0070_pc_String[L0031_CharacterIndex]) {
                ...
                if (P0070_pc_String[L0031_CharacterIndex] == '\n') { /* New line */
                        ...
                        F0046_TEXT_MESSAGEAREA_PrintString(P0069_i_TextColor, L0033_ac_String);
                        G0359_i_MessageAreaCursorColumn = 0;
                        L0031_CharacterIndex++;
                        continue;
                }
                if (P0070_pc_String[L0031_CharacterIndex] != '\0') {
                        F0046_TEXT_MESSAGEAREA_PrintString(P0069_i_TextColor, L0033_ac_String);
                        F0045_TEXT_MESSAGEAREA_CreateNewRow();
...
void F0048_TEXT_MESSAGEAREA_PrintCharacter( /* BUG0_00 Useless code (Atari ST / Amiga) */
int16_t P0071_i_TextColor SEPARATOR
char    P0072_c_Character FINAL_SEPARATOR
{
        char L0034_ac_String[2];


        L0034_ac_String[0] = P0072_c_Character;
        L0034_ac_String[1] = '\0';
        F0047_TEXT_MESSAGEAREA_PrintMessage(P0071_i_TextColor, L0034_ac_String);
}


void F0647_PrintLongForDebugMemory( /* Can be merged with F0049_TEXT_MESSAGEAREA_PrintInteger_Unreferenced */
int16_t                P2201_i_TextColor SEPARATOR
REGISTER unsigned long P2202_ul_Value    FINAL_SEPARATOR
{
        char L3468_ac_String[14];
        F0671_ConvertLongToString(P2202_ul_Value, L3468_ac_String);
        F0047_TEXT_MESSAGEAREA_PrintMessage(P2201_i_TextColor, L3468_ac_String);
        F0047_TEXT_MESSAGEAREA_PrintMessage(P2201_i_TextColor, " ");
}

void F0050_TEXT_MESSAGEAREA_PrintSpace_Unreferenced( /* BUG0_00 Useless code */
void
)
{
        F0047_TEXT_MESSAGEAREA_PrintMessage(C15_COLOR_WHITE, " ");
}

void F0051_TEXT_MESSAGEAREA_PrintLineFeed(
void
)
{
        F0047_TEXT_MESSAGEAREA_PrintMessage(C00_COLOR_BLACK, G0066_ac_Graphic562_LineFeedCharacterString);
}

void F0052_TEXT_PrintToViewport(
int16_t P0075_i_X         SEPARATOR
int16_t P0076_i_Y         SEPARATOR
int16_t P0077_i_TextColor SEPARATOR
char*   P0078_pc_String   FINAL_SEPARATOR
{
        M720_F0644_PrintTextAlt(G0296_puc_Bitmap_Viewport, G2073_C224_ViewportPixelWidth, P0075_i_X, P0076_i_Y, P0077_i_TextColor, C12_COLOR_DARKEST_GRAY, P0078_pc_String, G2074_C136_ViewportHeight);
}

void F0053_TEXT_PrintToLogicalScreen(
int16_t P0079_i_X               SEPARATOR
int16_t P0080_i_Y               SEPARATOR
int16_t P0081_i_TextColor       SEPARATOR
int16_t P0082_i_BackgroundColor SEPARATOR
char*   P0083_pc_String         FINAL_SEPARATOR
{
        M720_F0644_PrintTextAlt(G0348_Bitmap_Screen, G2071_C320_ScreenPixelWidth, P0079_i_X, P0080_i_Y, P0081_i_TextColor, P0082_i_BackgroundColor, P0083_pc_String, G2072_C200_ScreenPixelHeight);
}


void F0648_PrintTextInViewportZone(
int16_t P2203_i_ZoneIndex SEPARATOR
int16_t P2204_i_Color     SEPARATOR
char*   P2205_pc_String   FINAL_SEPARATOR
{
        int16_t L3470_i_Width;
        int16_t L3471_i_Height;
        int16_t L3472_ai_XYZ[4];


        if (F0645_GetStringPixelDimensions(P2205_pc_String, &L3470_i_Width, &L3471_i_Height)) {
                if (F0635_(NULL, L3472_ai_XYZ, P2203_i_ZoneIndex, &L3470_i_Width, &L3471_i_Height)) {
                        M720_F0644_PrintTextAlt(G0296_puc_Bitmap_Viewport, G2073_C224_ViewportPixelWidth, M704_ZONE_LEFT(L3472_ai_XYZ), M707_ZONE_BOTTOM(L3472_ai_XYZ), P2204_i_Color, C12_COLOR_DARKEST_GRAY, P2205_pc_String, G2074_C136_ViewportHeight);
                }
        }
}

void F0649_PrintCenteredTextToViewportZone(
int16_t P2206_i_ZoneIndex       SEPARATOR
int16_t P2207_i_TextColor       SEPARATOR
int16_t P2208_i_BackgroundColor SEPARATOR
char*   P2209_pc_String         FINAL_SEPARATOR
{
        int16_t L3473_i_Width;
        int16_t L3474_i_Height;
        int16_t L3475_ai_XYZ[4];


        if (F0645_GetStringPixelDimensions(P2209_pc_String, &L3473_i_Width, &L3474_i_Height)) {
                if (F0635_(NULL, L3475_ai_XYZ, P2206_i_ZoneIndex, &L3473_i_Width, &L3474_i_Height)) {
                        M720_F0644_PrintTextAlt(G0296_puc_Bitmap_Viewport, G2073_C224_ViewportPixelWidth, M704_ZONE_LEFT(L3475_ai_XYZ), M707_ZONE_BOTTOM(L3475_ai_XYZ), P2207_i_TextColor, P2208_i_BackgroundColor, P2209_pc_String, G2074_C136_ViewportHeight);
                }
        }
}

void F0650_PrintCenteredTextToScreenZone(
int16_t P2210_i_ZoneIndex       SEPARATOR
int16_t P2211_i_TextColor       SEPARATOR
int16_t P2212_i_BackgroundColor SEPARATOR
char*   P2213_pc_String         FINAL_SEPARATOR
{
        int16_t L3476_i_Width;
        int16_t L3477_i_Height;
        int16_t L3478_ai_XYZ[4];


        if (F0645_GetStringPixelDimensions(P2213_pc_String, &L3476_i_Width, &L3477_i_Height)) {
                if (F0635_(NULL, L3478_ai_XYZ, P2210_i_ZoneIndex, &L3476_i_Width, &L3477_i_Height)) {
                        M720_F0644_PrintTextAlt(G0348_Bitmap_Screen, G2071_C320_ScreenPixelWidth, M704_ZONE_LEFT(L3478_ai_XYZ), M707_ZONE_BOTTOM(L3478_ai_XYZ), P2211_i_TextColor, P2212_i_BackgroundColor, P2213_pc_String, G2072_C200_ScreenPixelHeight);
                }
        }
}

void F0054_TEXT_Initialize(
void
)
{
        REGISTER unsigned int16_t L0037_ui_LineIndex;


        F0042_TEXT_MESSAGEAREA_MoveCursor(0, M532_MESSAGE_AREA_ROW_COUNT - 1);
        G0356_puc_Bitmap_MessageAreaNewRow = M533_F0468_MEMORY_Allocate((long)G2091_MessageAreaLineByteCount, C1_ALLOCATION_PERMANENT, MASK0x0008_MEMREQ);
        G0357_puc_InterfaceAndScrollsFont = M533_F0468_MEMORY_Allocate((long)(M075_BITMAP_BYTE_COUNT(1024, 6) / 4), C1_ALLOCATION_PERMANENT, MASK0x0400_MEMREQ); /* The color depth of the font bitmap is 1 bit per pixel instead of 4 for all other bitmaps */
        F0490_MEMORY_LoadDecompressAndExpandGraphic(MASK0x8000_NOT_EXPANDED | MASK0x4000_DO_NOT_COPY_DIMENSIONS | M653_GRAPHIC_FONT, G0357_puc_InterfaceAndScrollsFont);
        for (L0037_ui_LineIndex = 0; L0037_ui_LineIndex < M532_MESSAGE_AREA_ROW_COUNT; L0037_ui_LineIndex++) {
...
unsigned char* F0643_BuildCustomColorsFont( /* ANOMALY_FMT Parameters declared as int required for call in F0644_ but actually parameters are int16_t */
int P2180_i_TextColor       SEPARATOR
int P2181_i_BackgroundColor
);

#include "FONT.C"

void F0644_PrintTextAlt(
unsigned char* P2182_puc_Bitmap         SEPARATOR
int16_t        P2183_i_DestinationWidth SEPARATOR
int16_t        P2184_i_X                SEPARATOR
int16_t        P2185_i_Y                SEPARATOR
int16_t        P2186_i_TextColor        SEPARATOR
int16_t        P2187_i_BackgroundColor  SEPARATOR
REGISTER char* P2188_pc_String          FINAL_SEPARATOR
{
        int16_t L3487_i_FontX;
        unsigned char* L3488_puc_Bitmap;
        int16_t L3489_i_TransparentColor;
        int16_t L3490_ai_XYZ[4];


        if (!*P2188_pc_String) {
                return;
        }
        if (M007_GET(P2187_i_BackgroundColor, MASK0x4000_TRANSPARENT)) {
                L3489_i_TransparentColor = M009_CLEAR(P2187_i_BackgroundColor, MASK0x4000_TRANSPARENT);
        } else {
                L3489_i_TransparentColor = CM1_COLOR_NO_TRANSPARENCY;
        }
        M704_ZONE_LEFT(L3490_ai_XYZ) = P2184_i_X;
                M709_ZONE_HEIGHT(L3490_ai_XYZ) = G2083_C6_;
                M706_ZONE_TOP(L3490_ai_XYZ) = P2185_i_Y + G2086_C1_ - (M709_ZONE_HEIGHT(L3490_ai_XYZ) - 1);
                M708_ZONE_WIDTH(L3490_ai_XYZ) = G2087_C6_TextCharacterWidth;
                L3488_puc_Bitmap = F0643_BuildCustomColorsFont(P2186_i_TextColor, P2187_i_BackgroundColor);
                do {
                        L3487_i_FontX = (*((unsigned char*)P2188_pc_String) * 8) + (8 - G2082_);
                        F0132_VIDEO_Blit(L3488_puc_Bitmap, P2182_puc_Bitmap, L3490_ai_XYZ, L3487_i_FontX, 0, C1024_WIDTH, P2183_i_DestinationWidth, CM1_COLOR_NO_TRANSPARENCY, MASK0x0000_NO_FLIP);
                        M704_ZONE_LEFT(L3490_ai_XYZ) += G2087_C6_TextCharacterWidth;
                        P2188_pc_String++;
                } while (*P2188_pc_String);
}
/* END TEXT2.C */
...
#include "COMPILE.H"
#endif
void F0642_AllocateFontMemory(
void
)
{
        G2148_puc_InterfaceAndScrollsFontCustomColors = M533_F0468_MEMORY_Allocate((long)M075_BITMAP_BYTE_COUNT(1024, 6), C1_ALLOCATION_PERMANENT, MASK0x0400_MEMREQ);
}

unsigned char* F0643_BuildCustomColorsFont(
register int16_t P2180_i_TextColor       SEPARATOR /* register required for PC98 */ 
register int16_t P2181_i_BackgroundColor FINAL_SEPARATOR /* register required for PC98 */
{
        register unsigned char* L3479_puc_;                    /* ANOMALY_FMT register required */
        REGISTER unsigned char* L3480_puc_;
        register int16_t L3481_i_; /* register required for I34x */
        REGISTER int16_t L3482_i_;
        register int16_t L3483_i_; /* register required for I34x */
        int16_t L3484_i_;
        unsigned int16_t L3485_ui_;
        unsigned int16_t L3486_ui_;


        if ((G2104_i_InterfaceAndScrollsFontCurrentTextColor != P2180_i_TextColor) || (G2105_i_InterfaceAndScrollsFontCurrentBackgroundColor != P2181_i_BackgroundColor)) {
                L3479_puc_ = G0357_puc_InterfaceAndScrollsFont;
                L3480_puc_ = G2148_puc_InterfaceAndScrollsFontCustomColors;
                L3482_i_ = P2180_i_TextColor << 4;
                L3483_i_ = P2181_i_BackgroundColor << 4;
                for (L3481_i_ = 768; L3481_i_; L3481_i_--) {
                        L3485_ui_ = *L3479_puc_++;
                        for (L3486_ui_ = 0; L3486_ui_ < 4; L3486_ui_++) {
                                if (L3485_ui_ & 0x80)
                                        L3484_i_ = L3482_i_;
                                else
                                        L3484_i_ = L3483_i_;
                                if (L3485_ui_ & 0x40)
                                        *L3480_puc_++ = (L3484_i_ | P2180_i_TextColor);
                                else
                                        *L3480_puc_++ = (L3484_i_ | P2181_i_BackgroundColor);
                                L3485_ui_ = L3485_ui_ << 2;
                        }
                }
                G2104_i_InterfaceAndScrollsFontCurrentTextColor = P2180_i_TextColor;
                G2105_i_InterfaceAndScrollsFontCurrentBackgroundColor = P2181_i_BackgroundColor;
        }
        return G2148_puc_InterfaceAndScrollsFontCustomColors;
}
/* END FONT.C */
...
/* BEGIN IMAGE2.C */
#define ANOMALY_TOWNSIMAGE2
#ifndef COMPILE_H
#include "COMPILE.H"
#endif
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(X463_I34E_I34M) && (EXETYPE == C03_GAME)) || (defined(MEDIA551_F20E_F20J_F31E_F31J)) || (defined(X707_I34E_I34M) && (EXETYPE == C11_SELECTOR)))


#include "IMAGE4.C"

STATICFUNCTION void F0686_IMG_CopyFromPreviousLine(
unsigned int16_t P2350_ui_,
unsigned int16_t P2351_ui_,
int16_t P2352_i_)
{
        asm     cld
        asm     les     di, G2160_puc_Bitmap_Destination
        asm     mov     si, di
        asm     mov     bx, P2350_ui_
        asm     mov     dx, P2351_ui_
        asm     mov     cx, P2352_i_
        asm     shr     dx, 1
        asm     shr     bx, 1
        asm     pushf
        ...
        asm     shr     cx, 1
        asm     jnb     loc_2289A
        asm     movs    byte ptr es:[di], byte ptr es:[si]
        loc_2289A:
#if ((defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(X480_I34E_I34M) && (EXETYPE == C03_GAME)) || (defined(X707_I34E_I34M) && (EXETYPE == C11_SELECTOR)))
        asm     push    ds
        asm     mov     ax, es
        asm     mov     ds, ax
#endif
        loc_2289F:
#if (defined(MEDIA457_P20JA) && ((EXETYPE == C19_NECIO) || (EXETYPE == C03_GAME)))
        asm     SEGES rep movsw         /* Equivalent to (but with prefix bytes swapped): rep movs word ptr es:[di], word ptr es:[si] */
#endif
#if ((defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(X480_I34E_I34M) && (EXETYPE == C03_GAME)) || (defined(X707_I34E_I34M) && (EXETYPE == C11_SELECTOR)))
        asm     rep movsw
#endif
...
#if (defined(X707_I34E_I34M) && ((EXETYPE == C03_GAME) || (EXETYPE == C11_SELECTOR)))
...
int16_t F0688_IMG3_GetPixelCount(
)
{
        int16_t L2714_i_;
...
void F0689_IMG_ExpandGraphicToBitmap(
unsigned char* P2353_puc_Bitmap_AtariST,
unsigned char* P2354_puc_Bitmap)
{
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J)) /* IMG2 */
        unsigned int16_t L2715_ui_;
        unsigned int16_t L2716_ui_;
        unsigned int16_t L2717_ui_;
        unsigned int16_t L2718_ui_;
        unsigned int16_t L2726_ui_;
        unsigned int16_t L2719_ui_;
        unsigned int16_t L2720_ui_;
        unsigned int16_t L2723_ui_;
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
        unsigned int16_t L2724_ui_;
#endif
        unsigned char L2721_uc_;
        unsigned char L2722_uc_;
        unsigned int16_t L2725_ui_;


        G2159_puc_Bitmap_Source = P2353_puc_Bitmap_AtariST;
        G2160_puc_Bitmap_Destination = P2354_puc_Bitmap;
        L2715_ui_ = *((int16_t*)G2159_puc_Bitmap_Source);
        L2716_ui_ = *((int16_t*)G2159_puc_Bitmap_Source + 1);
        L2718_ui_ = (L2717_ui_ = M104_EVEN_INTEGER(L2715_ui_)) * L2716_ui_;
        G2159_puc_Bitmap_Source += 4;
        if (L2715_ui_ != L2717_ui_) {
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                L2724_ui_ = L2717_ui_ - L2715_ui_;
#endif
                L2720_ui_ = 0;
                L2726_ui_ = L2715_ui_;
                do {
                        L2721_uc_ = *G2159_puc_Bitmap_Source++;
                        L2722_uc_ = L2721_uc_ & 0x0F;
                        if ((L2721_uc_ & 0x80) == 0) {
                                L2725_ui_ = (L2721_uc_ >> 4) + 1;
                                while (L2725_ui_ >= L2726_ui_) {
                                        F0685_IMG3_LineColorFilling(L2720_ui_, L2722_uc_, L2726_ui_);
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                        L2720_ui_ += L2726_ui_ + 1;
#endif
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                        L2720_ui_ += L2726_ui_ + L2724_ui_;
#endif
                                        L2725_ui_ -= L2726_ui_;
                                        L2726_ui_ = L2715_ui_;
                                }
                                if (L2725_ui_ > 0) {
                                        F0685_IMG3_LineColorFilling(L2720_ui_, L2722_uc_, L2725_ui_);
                                        L2720_ui_ += L2725_ui_;
                                        L2726_ui_ -= L2725_ui_;
                                }
                        } else {
                                if ((L2721_uc_ & 0x40) == 0) {
                                        L2725_ui_ = *G2159_puc_Bitmap_Source++ + 1;
                                } else {
                                        L2725_ui_ = (*(G2159_puc_Bitmap_Source + 1) | (*G2159_puc_Bitmap_Source << 8)) + 1;
                                        G2159_puc_Bitmap_Source += 2;
                                }
                                switch (L2721_uc_ & 0x30) {
                                        case 0x00:
                                                while (L2725_ui_ >= L2726_ui_) {
                                                        F0685_IMG3_LineColorFilling(L2720_ui_, L2722_uc_, L2726_ui_);
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                        ...
                                        case 0x10:
                                                if (L2725_ui_ & 1) {
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                                        F0790_(L2720_ui_, L2722_uc_);
#endif
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                        F0790_(L2720_ui_++, (int16_t)L2722_uc_);
#endif
                                                        if (--L2726_ui_ == 0) {
                                                                L2726_ui_ = L2715_ui_;
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                                ...
                                                L2723_ui_ = L2725_ui_;
                                                while (L2725_ui_ >= L2726_ui_) {
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA458_P20JA_P20JB) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                        F1003_(L2719_ui_, L2720_ui_, L2726_ui_);
#endif
#if (defined(MEDIA667_P31J) && (EXETYPE == C03_GAME))
                                                        F0680_CopyPixelsToScreenWithoutTransparency(L2719_ui_, L2720_ui_, L2726_ui_);
#endif
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                                        L2720_ui_ += L2726_ui_ + 1;
#endif
                                                ...
                                                if (L2725_ui_ > 0) {
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA458_P20JA_P20JB) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                        F1003_(L2719_ui_, L2720_ui_, L2725_ui_);
#endif
#if (defined(MEDIA667_P31J) && (EXETYPE == C03_GAME))
                                                        F0680_CopyPixelsToScreenWithoutTransparency(L2719_ui_, L2720_ui_, L2725_ui_);
#endif
                                                        L2720_ui_ += L2725_ui_;
                                                        L2719_ui_ += L2725_ui_;
                                                        L2726_ui_ -= L2725_ui_;
                                                }
                                                G2159_puc_Bitmap_Source += (L2723_ui_ >> 1);
                                                break;
                                        case 0x30:
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                                L2723_ui_ = L2725_ui_ + (L2725_ui_ / L2717_ui_);
                                                if (L2725_ui_ > L2726_ui_) {
                                                        L2723_ui_++;
                                                }
                                                F0686_IMG_CopyFromPreviousLine(L2720_ui_, L2720_ui_ - L2717_ui_, L2723_ui_);
                                                L2720_ui_ += L2723_ui_;
#endif
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                while (L2725_ui_ >= L2726_ui_) {
                                                        F0686_IMG_CopyFromPreviousLine(L2720_ui_, L2720_ui_ - L2717_ui_, L2726_ui_);
                                                        L2720_ui_ += L2726_ui_ + L2724_ui_;
                                                        L2725_ui_ -= L2726_ui_;
                                                        L2726_ui_ = L2715_ui_;
                                                }
                                                ...
                                                F0790_(L2720_ui_++, L2722_uc_);
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)))
                                                L2726_ui_ = L2717_ui_ - (L2720_ui_ % L2717_ui_) - 1;
#endif
#if ((defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA459_P20JA_P20JB_P31J) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                if (--L2726_ui_ == 0) {
                                                        L2720_ui_ += L2724_ui_;
...
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA458_P20JA_P20JB) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J))
                                                F1003_(0, L2720_ui_, L2725_ui_);
#endif
#if (defined(MEDIA667_P31J) && (EXETYPE == C03_GAME))
                                                F0680_CopyPixelsToScreenWithoutTransparency(0, L2720_ui_, L2725_ui_);
#endif
                                                G2159_puc_Bitmap_Source += (L2725_ui_ >> 1);
                                                L2720_ui_ += L2725_ui_;
                                                break;
                                        case 0x30:
                                                F0686_IMG_CopyFromPreviousLine(L2720_ui_, L2720_ui_ - L2717_ui_, L2725_ui_);
                                                L2720_ui_ += L2725_ui_;
                                                F0790_(L2720_ui_++, L2722_uc_);
                                }
                        }
...
#endif
#if (defined(X707_I34E_I34M) && ((EXETYPE == C03_GAME) || (EXETYPE == C11_SELECTOR))) /* IMG3 */
        int16_t L2727_i_;
        int16_t L2728_i_;
        unsigned int16_t L2729_ui_;
        int16_t L2730_i_;
        unsigned int16_t L2731_ui_;
        int16_t L2732_i_;
#if (EXETYPE == C03_GAME)
        int16_t L2733_i_;
#endif
        unsigned char L2734_uc_;
        unsigned char L2735_uc_;
#if (EXETYPE == C03_GAME)
        unsigned char L2736_auc_LocalPalette[6];
#endif
        char L2737_c_;
#if (EXETYPE == C11_SELECTOR)
        int16_t L2733_i_;
#endif
        unsigned int16_t L2738_ui_;
        unsigned int16_t L2739_ui_;


        G2159_puc_Bitmap_Source = P2353_puc_Bitmap_AtariST;
        G2160_puc_Bitmap_Destination = P2354_puc_Bitmap;
        L2727_i_ = *((int16_t*)G2159_puc_Bitmap_Source);
        L2728_i_ = *((int16_t*)G2159_puc_Bitmap_Source + 1);
        L2730_i_ = (L2729_ui_ = M104_EVEN_INTEGER(L2727_i_)) * L2728_i_;
        G2157_ = 8;
        for (L2733_i_ = 0; L2733_i_ < 6; L2733_i_++) {
#if (EXETYPE == C03_GAME)
                L2736_auc_LocalPalette[L2733_i_] = F0687_IMG3_GetNibble();
#endif
#if (EXETYPE == C11_SELECTOR)
                G8245_auc_LocalPalette[L2733_i_] = F0687_IMG3_GetNibble();
#endif
        }
        if (L2727_i_ != L2729_ui_) {
                L2732_i_ = L2729_ui_ - L2727_i_;
                L2738_ui_ = 0;
                L2731_ui_ = L2727_i_;
                do {
                        L2735_uc_ = (L2734_uc_ = F0687_IMG3_GetNibble()) & 0x07;
                        if (L2735_uc_ == 6) {
                                if (L2734_uc_ & 8) {
                                        L2739_ui_ = F0688_IMG3_GetPixelCount();
                                } else {
                                        L2739_ui_ = 1;
                                }
                                while (L2739_ui_ >= L2731_ui_) {
                                        F0686_IMG_CopyFromPreviousLine(L2738_ui_, L2738_ui_ - L2729_ui_, L2731_ui_);
                                        L2738_ui_ += L2731_ui_ + L2732_i_;
                                        L2739_ui_ -= L2731_ui_;
                                        L2731_ui_ = L2727_i_;
                                }
                                if (L2739_ui_ > 0) {
                                ...
                                if (L2735_uc_ < 6) {
#if (EXETYPE == C03_GAME)
                                        L2737_c_ = L2736_auc_LocalPalette[L2735_uc_];
#endif
#if (EXETYPE == C11_SELECTOR)
                                        L2737_c_ = G8245_auc_LocalPalette[L2735_uc_];
#endif
                                } else {
                                        L2737_c_ = F0687_IMG3_GetNibble();
                                }
                                if (L2734_uc_ & 8) {
                                        L2739_ui_ = F0688_IMG3_GetPixelCount();
                                } else {
                                ...
                                while (L2739_ui_ >= L2731_ui_) {
                                        F0685_IMG3_LineColorFilling(L2738_ui_, L2737_c_, L2731_ui_);
                                        L2738_ui_ += L2731_ui_ + L2732_i_;
                                        L2739_ui_ -= L2731_ui_;
                                        L2731_ui_ = L2727_i_;
                                }
                                if (L2739_ui_ > 0) {
                                        F0685_IMG3_LineColorFilling(L2738_ui_, L2737_c_, L2739_ui_);
                                        L2738_ui_ += L2739_ui_;
                                        L2731_ui_ -= L2739_ui_;
                                }
                        }
                } while (L2738_ui_ < L2730_i_);
        } else {
                L2738_ui_ = 0;
                do {
                        L2735_uc_ = (L2734_uc_ = F0687_IMG3_GetNibble()) & 0x07;
                        if (L2735_uc_ == 6) {
                                ...
                                F0686_IMG_CopyFromPreviousLine(L2738_ui_, L2738_ui_ - L2729_ui_, L2739_ui_);
                        } else {
                                if (L2735_uc_ < 6) {
#if (EXETYPE == C03_GAME)
                                        L2737_c_ = L2736_auc_LocalPalette[L2735_uc_];
...
#include "COMPILE.H"
#endif
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(X463_I34E_I34M) && (EXETYPE == C03_GAME)) || (defined(MEDIA551_F20E_F20J_F31E_F31J)) || (defined(X707_I34E_I34M) && (EXETYPE == C11_SELECTOR)) || (defined(MEDIA667_P31J) && (EXETYPE == C04_SWITCH)))
STATICFUNCTION void F0790_(
unsigned int16_t P2342_ui_,
char P2343_c_)
{
#if ((defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(X480_I34E_I34M) && (EXETYPE == C03_GAME)) || (defined(X707_I34E_I34M) && (EXETYPE == C11_SELECTOR)) || (defined(MEDIA667_P31J) && (EXETYPE == C04_SWITCH)))
        asm     cld
#endif
        asm     les     di, G2160_puc_Bitmap_Destination
        asm     mov     bx, P2342_ui_
        asm     shr     bx, 1
        asm     jnb     loc_227FC
        asm     add     di, bx
        asm     mov     al, es:[di]
...
STATICFUNCTION void F0685_IMG3_LineColorFilling(
unsigned int16_t P2344_ui_,
char P2345_c_Color,
int16_t P2346_i_)
{
        asm     cld
        asm     les     di, G2160_puc_Bitmap_Destination
        asm     mov     bx, P2344_ui_
        asm     mov     cx, P2346_i_
        asm     mov     ah, P2345_c_Color
        asm     shr     bx, 1
        asm     pushf
        asm     add     di, bx
        asm     popf
...
#if ((defined(MEDIA457_P20JA) && (EXETYPE == C19_NECIO)) || (defined(X478_I34E_I34M) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)) || (defined(MEDIA458_P20JA_P20JB) && (EXETYPE == C03_GAME)) || defined(MEDIA551_F20E_F20J_F31E_F31J) || (defined(MEDIA667_P31J) && (EXETYPE == C04_SWITCH)))
STATICFUNCTION void F1003_(
unsigned int16_t P2347_ui_,
unsigned int16_t P2348_ui_,
int16_t P2349_i_)
{
        unsigned int16_t L2711_ui_;
        unsigned int16_t L2710_ui_;
        char L2712_c_;
        char L2713_c_;


        L2712_c_ = P2347_ui_ & 1;
        L2713_c_ = P2348_ui_ & 1;
        if (L2712_c_ == L2713_c_) {
                L2710_ui_ = P2347_ui_ >> 1;
                L2711_ui_ = P2348_ui_ >> 1;
                if (L2712_c_) {
                        G2160_puc_Bitmap_Destination[L2711_ui_] = (G2160_puc_Bitmap_Destination[L2711_ui_] & 0xF0) | (G2159_puc_Bitmap_Source[L2710_ui_] & 0x0F);
                        L2711_ui_++;
                        L2710_ui_++;
                        P2349_i_--;
                }
                while (P2349_i_ > 0) {
                        G2160_puc_Bitmap_Destination[L2711_ui_++] = G2159_puc_Bitmap_Source[L2710_ui_++];
                        P2349_i_ -= 2;
                }
        } else {
                while (P2349_i_-- > 0) {
                        if (P2347_ui_ & 1) {
                                F0790_(P2348_ui_++, G2159_puc_Bitmap_Source[P2347_ui_ >> 1] & 0x0F);
                        } else {
                                F0790_(P2348_ui_++, G2159_puc_Bitmap_Source[P2347_ui_ >> 1] >> 4);
                        }
                        P2347_ui_++;
                }
        }
...
/* Blit part of P0199_puc_Bitmap_Source at coordinates P0202_i_X, P0203_i_Y to P0200_puc_Bitmap_Destination at coordinates specified in P0201_pi_Box and with transparent color P0206_i_TransparentColor */
void F0132_VIDEO_Blit(
unsigned char*             P0199_puc_Bitmap_Source      SEPARATOR
unsigned char*             P0200_puc_Bitmap_Destination SEPARATOR
int16_t*                   P2364_pi_XYZ                 SEPARATOR
int16_t                    P0202_i_X                    SEPARATOR
int16_t                    P0203_i_Y                    SEPARATOR
int16_t                    P0204_i_SourceByteWidth      SEPARATOR
int16_t                    P0205_i_DestinationByteWidth SEPARATOR
#if (defined(MEDIA636_A31E_A31M_A35E) && (EXETYPE == C18_VDEO))
char                       P0206_i_TransparentColor     SEPARATOR
#else
int16_t                    P0206_i_TransparentColor     SEPARATOR
#endif
int16_t                    P2365_i_Flip                 FINAL_SEPARATOR
{
        int16_t L2192_ai_Box[4];


        if ((P0199_puc_Bitmap_Source == NULL) || (P0200_puc_Bitmap_Destination == NULL)) {
                M768_BOX_LEFT(L2192_ai_Box) = M704_ZONE_LEFT(P2364_pi_XYZ);
                M769_BOX_RIGHT(L2192_ai_Box) = M705_ZONE_RIGHT(P2364_pi_XYZ);
                M770_BOX_TOP(L2192_ai_Box) = M706_ZONE_TOP(P2364_pi_XYZ);
                M771_BOX_BOTTOM(L2192_ai_Box) = M707_ZONE_BOTTOM(P2364_pi_XYZ);
                (*(G2156_VideoDriver->VIDRV_02_Blit))(P0199_puc_Bitmap_Source, P0200_puc_Bitmap_Destination, L2192_ai_Box, P0202_i_X, P0203_i_Y, P0204_i_SourceByteWidth, P0205_i_DestinationByteWidth, P0206_i_TransparentColor, P2365_i_Flip);
        } else {
                F0684_Blit(P0199_puc_Bitmap_Source, P0200_puc_Bitmap_Destination, P2364_pi_XYZ, P0202_i_X, P0203_i_Y, P0204_i_SourceByteWidth, P0205_i_DestinationByteWidth, P0206_i_TransparentColor, P2365_i_Flip);
        }
}
/* END BLIT.C */
...
extern void F0697_HatchScreenBox(
int16_t* P2372_pi_XYZ  SEPARATOR
unsigned int16_t  P2373_ui_Color
);
...
void F0134_VIDEO_FillBitmap(
char*                     P0218_puc_Bitmap SEPARATOR
int16_t                   P0219_i_Color    SEPARATOR
int16_t                   P0216_i_Width    SEPARATOR
int16_t                   P0217_i_Height   FINAL_SEPARATOR
{
        unsigned int16_t L2207_ui_Counter;
        unsigned int16_t L2206_ui_ByteCount;


        L2206_ui_ByteCount = M103_BITMAP_BYTE_COUNT(P0216_i_Width, P0217_i_Height);
        P0219_i_Color |= P0219_i_Color << 4;
        for (L2207_ui_Counter = 0; L2207_ui_Counter < L2206_ui_ByteCount; L2207_ui_Counter++) {
                P0218_puc_Bitmap[L2207_ui_Counter] = P0219_i_Color;
        }
}



void F0732_FillScreenArea(
int16_t*         P2222_pi_Box   SEPARATOR
unsigned int16_t P2223_ui_Color FINAL_SEPARATOR
{
        F0135_VIDEO_FillBox(NULL, P2222_pi_Box, P2223_ui_Color, G2071_C320_ScreenPixelWidth);
}


void F0733_FillZoneByIndex(
int16_t P2224_i_ZoneIndex SEPARATOR
int16_t P2225_i_Color     FINAL_SEPARATOR
{
        int16_t L2210_ai_XYZ[4];


        M525_F0135_VIDEO_FillBox(G0348_Bitmap_Screen, F0638_GetZone(P2224_i_ZoneIndex, L2210_ai_XYZ), P2225_i_Color, G2071_C320_ScreenPixelWidth, G2072_C200_ScreenPixelHeight);
}


void F0136_VIDEO_HatchScreenBox(
int16_t          P2226_i_ZoneIndex SEPARATOR
unsigned int16_t P0226_Color       FINAL_SEPARATOR
{
        int16_t L2212_ai_XYZ[4];


        F0697_HatchScreenBox(F0638_GetZone(P2226_i_ZoneIndex, L2212_ai_XYZ), P0226_Color);
}




void F0734_ClearZoneInInventory(
int16_t P2228_i_ZoneIndex FINAL_SEPARATOR
{
        int16_t L2213_ai_XYZ[4];


        F0135_VIDEO_FillBox(G0296_puc_Bitmap_Viewport, F0638_GetZone(P2228_i_ZoneIndex, L2213_ai_XYZ), C12_COLOR_DARKEST_GRAY, G2073_C224_ViewportPixelWidth);
}

void F0735_FillViewportBox(
int16_t* P2229_pi_XYZ  SEPARATOR
int16_t  P2230_i_Color FINAL_SEPARATOR
{
        F0135_VIDEO_FillBox(G0296_puc_Bitmap_Viewport, P2229_pi_XYZ, P2230_i_Color, G2073_C224_ViewportPixelWidth);
}
/* END BLITFILL.C */
...
/* This function creates a bitmap in P0210_puc_Bitmap_Temporary with the dimensions of P0211_pi_Box and filled with units from P0207_puc_Bitmap_Source starting from P0213_ui_FirstUnitIndex to P0212_i_LastUnitIndex
The written units are masked with P0209_puc_Bitmap_Mask and the pixels removed by the mask are replaced by the color P0215_i_TransparentColor. The bitmap at coordinates P0216_i_X and P0217_i_Y in the resulting P0210_puc_Bitmap_Temporary is blitted to P0208_puc_Bitmap_Destination with transparent color P0215_i_TransparentColor
The dimensions of P0207_puc_Bitmap_Source are ignored as it is only used as a source for units. Consequently the source bitmap is never drawn as is and is always distorted */
void F0133_VIDEO_BlitBoxFilledWithMaskedBitmap(
unsigned char*          P0207_puc_Bitmap_Source       SEPARATOR
unsigned char*          P0208_puc_Bitmap_Destination  SEPARATOR
unsigned char*          P0209_puc_Bitmap_Mask         SEPARATOR
unsigned char*          P0210_puc_Bitmap_Temporary    SEPARATOR
int16_t*                P2416_pi_XYZ                  SEPARATOR
int16_t                 P0212_i_LastUnitIndex         SEPARATOR /* Index of the last source bitmap unit to write to the destination box. Must be greater than P0213_ui_FirstUnitIndex. After this unit is written to the destination box, the next unit to write will be set to the first unit in the source bitmap, and not reset to P0213_ui_FirstUnitIndex */
unsigned int16_t        P0213_ui_FirstUnitIndex       SEPARATOR /* Index of the first source bitmap unit to write to the destination box. Must be lower than P0212_i_LastUnitIndex */
unsigned int16_t        P0214_ui_DestinationByteWidth SEPARATOR
#if (EXETYPE == C13_GRF1)
char                    P0215_i_TransparentColor      SEPARATOR
#else
int16_t                 P0215_i_TransparentColor      SEPARATOR
#endif
int16_t                 P0216_i_X                     SEPARATOR
int16_t                 P0217_i_Y                     FINAL_SEPARATOR
{
        unsigned char* L2006_puc_Bitmap;
        unsigned char* L2007_puc_Buffer;
        int16_t L2008_i_;
        int16_t L2009_i_;
        int16_t L2010_i_;
        int16_t L2011_i_;
        char L2012_c_;
        int16_t L2013_i_;
        unsigned char L2014_uc_;
        int16_t L2015_ai_XYZ1[4];
        int16_t L2016_ai_XYZ2[4];
        int16_t L2017_i_;


#if (defined(MEDIA634_A31E_A31M_X31J) && (EXETYPE == C13_GRF1))
        ASM_STUB_PREFIX
#endif
#if (!(defined(MEDIA692_X31J) && (EXETYPE == C13_GRF1))) /* Function body is nearly empty in this version */
        P0213_ui_FirstUnitIndex <<= 3;
        L2008_i_ = P0212_i_LastUnitIndex << 3;
        F0007_MAIN_CopyBytes((char*)P2416_pi_XYZ, (char*)L2016_ai_XYZ2, (long)sizeof(L2016_ai_XYZ2));
        L2007_puc_Buffer = M533_F0468_MEMORY_Allocate(C800L_UNKNOWN, C0_ALLOCATION_TEMPORARY_ON_TOP_OF_HEAP, MASK0x0008_MEMREQ);
        L2014_uc_ = P0215_i_TransparentColor & 0x0F;
        L2017_i_ = 0;
        L2013_i_ = 0;
        if ((L2011_i_ = M100_PIXEL_WIDTH(P0207_puc_Bitmap_Source) & 1) != 0) {
                L2011_i_ = (2 - L2011_i_) >> 1;
        }
        for (L2009_i_ = 0; L2009_i_ < L2008_i_; L2009_i_++) {
                L2012_c_ = 0;
                if ((P0207_puc_Bitmap_Source[L2017_i_] & 0x0F) != L2014_uc_)
                        L2012_c_ |= P0207_puc_Bitmap_Source[L2017_i_] & 0x0F;
                if ((P0207_puc_Bitmap_Source[L2017_i_] >> 4) != L2014_uc_)
                        L2012_c_ |= P0207_puc_Bitmap_Source[L2017_i_] & 0xF0;
                L2007_puc_Buffer[L2009_i_] = L2012_c_;
                L2017_i_++;
                if (L2011_i_ && (++L2013_i_ >= (M100_PIXEL_WIDTH(P0207_puc_Bitmap_Source) >> 1))) {
                        L2017_i_ += L2011_i_;
                        L2013_i_ = 0;
                }
        }
        L2010_i_ = M103_BITMAP_BYTE_COUNT(M708_ZONE_WIDTH(L2016_ai_XYZ2), M709_ZONE_HEIGHT(L2016_ai_XYZ2));
        L2006_puc_Bitmap = P0210_puc_Bitmap_Temporary;
        if (P0213_ui_FirstUnitIndex > 0) {
                L2009_i_ = L2008_i_ - P0213_ui_FirstUnitIndex;
                F0007_MAIN_CopyBytes((char*)L2007_puc_Buffer + P0213_ui_FirstUnitIndex, (char*)L2006_puc_Bitmap, (long)L2009_i_);
                L2010_i_ -= L2009_i_;
                L2006_puc_Bitmap += L2009_i_;
        }
        while (L2010_i_ > L2008_i_) {
                F0007_MAIN_CopyBytes((char*)L2007_puc_Buffer, (char*)L2006_puc_Bitmap, (long)L2008_i_);
                L2010_i_ -= L2008_i_;
                L2006_puc_Bitmap += L2008_i_;
        }
        if (L2010_i_ > 0) {
                F0007_MAIN_CopyBytes((char*)L2007_puc_Buffer, (char*)L2006_puc_Bitmap, (long)L2010_i_);
        }
        F0469_MEMORY_FreeAtHeapTop(C800L_UNKNOWN);
        M704_ZONE_LEFT(L2015_ai_XYZ1) = M706_ZONE_TOP(L2015_ai_XYZ1) = 0;
        M708_ZONE_WIDTH(L2015_ai_XYZ1) = M708_ZONE_WIDTH(L2016_ai_XYZ2);
        M709_ZONE_HEIGHT(L2015_ai_XYZ1) = M709_ZONE_HEIGHT(L2016_ai_XYZ2);
        if (!M007_GET(P0215_i_TransparentColor, MASK0x0080_UNKNOWN)) {
                F0132_VIDEO_Blit(P0209_puc_Bitmap_Mask, P0210_puc_Bitmap_Temporary, L2015_ai_XYZ1, P0216_i_X, P0217_i_Y, M708_ZONE_WIDTH(L2016_ai_XYZ2), M708_ZONE_WIDTH(L2016_ai_XYZ2), C15_COLOR_WHITE, MASK0x0000_NO_FLIP);
        }
        F0132_VIDEO_Blit(P0210_puc_Bitmap_Temporary, P0208_puc_Bitmap_Destination, L2016_ai_XYZ2, 0, 0, M708_ZONE_WIDTH(L2016_ai_XYZ2), P0214_ui_DestinationByteWidth, C00_COLOR_BLACK, MASK0x0000_NO_FLIP);
#endif
#if (defined(MEDIA634_A31E_A31M_X31J) && (EXETYPE == C13_GRF1))
        ASM_STUB_SUFFIX
#endif
...
unsigned char* G2042_puc_BlitShrink_PaletteChanges;
unsigned char* G2043_puc_BlitShrink_BitmapSource;
unsigned char* G2044_puc_BlitShrink_BitmapDestination;



STATICFUNCTION void F0720_ShrinkBLT_Sub1(
int16_t          P2408_i_  SEPARATOR
unsigned int16_t P2409_ui_ SEPARATOR
unsigned int16_t P2410_ui_ SEPARATOR
unsigned int16_t P2411_ui_ FINAL_SEPARATOR
{
        unsigned int16_t L2223_i_;
        unsigned int16_t L2224_i_;
        unsigned int16_t L2225_ui_;
        unsigned char L2226_uc_;
        unsigned char L2227_uc_;


        L2223_i_ = P2410_ui_ >> 1;
        L2224_i_ = P2409_ui_;
        while (P2411_ui_ + P2409_ui_ > L2224_i_) {
                L2226_uc_ = G2043_puc_BlitShrink_BitmapSource[(L2225_ui_ = (L2223_i_ >> 6) + P2408_i_) >> 1];
                L2223_i_ += P2410_ui_;
                if (M007_GET(L2225_ui_, MASK0x0001_UNKNOWN)) {
                        L2227_uc_ = L2226_uc_ << 4;
                } else {
                        L2227_uc_ = L2226_uc_ & 0xF0;
                }
                L2226_uc_ = G2043_puc_BlitShrink_BitmapSource[(L2225_ui_ = (L2223_i_ >> 6) + P2408_i_) >> 1];
                L2223_i_ += P2410_ui_;
                if (M007_GET(L2225_ui_, MASK0x0001_UNKNOWN)) {
                        G2044_puc_BlitShrink_BitmapDestination[L2224_i_ >> 1] = L2227_uc_ | (L2226_uc_ & 0x0F);
                } else {
                        G2044_puc_BlitShrink_BitmapDestination[L2224_i_ >> 1] = L2227_uc_ | (L2226_uc_ >> 4);
                }
                L2224_i_ += 2;
        }
}

STATICFUNCTION void F0721_ShrinkBLT_Sub2(
int16_t          P2412_i_  SEPARATOR
unsigned int16_t P2413_ui_ SEPARATOR
unsigned int16_t P2414_ui_ SEPARATOR
unsigned int16_t P2415_ui_ FINAL_SEPARATOR
{
        unsigned int16_t L2228_ui_;
        unsigned int16_t L2229_ui_;
        unsigned int16_t L2230_ui_;
        unsigned char L2231_uc_;
        unsigned char L2232_uc_;


        L2228_ui_ = P2414_ui_ >> 1;
        L2229_ui_ = P2413_ui_;
        while (P2415_ui_ + P2413_ui_ > L2229_ui_) {
                L2231_uc_ = G2043_puc_BlitShrink_BitmapSource[(L2230_ui_ = (L2228_ui_ >> 6) + P2412_i_) >> 1];
                L2228_ui_ += P2414_ui_;
                if (M007_GET(L2230_ui_, MASK0x0001_UNKNOWN)) {
                        L2232_uc_ = G2042_puc_BlitShrink_PaletteChanges[L2231_uc_ & 0x0F] << 4;
                } else {
                        L2232_uc_ = G2042_puc_BlitShrink_PaletteChanges[L2231_uc_ >> 4] << 4;
                }
                L2231_uc_ = G2043_puc_BlitShrink_BitmapSource[(L2230_ui_ = (L2228_ui_ >> 6) + P2412_i_) >> 1];
                L2228_ui_ += P2414_ui_;
                if (M007_GET(L2230_ui_, MASK0x0001_UNKNOWN)) {
                        G2044_puc_BlitShrink_BitmapDestination[L2229_ui_ >> 1] = L2232_uc_ | G2042_puc_BlitShrink_PaletteChanges[L2231_uc_ & 0x0F];
                } else {
                        G2044_puc_BlitShrink_BitmapDestination[L2229_ui_ >> 1] = L2232_uc_ | G2042_puc_BlitShrink_PaletteChanges[L2231_uc_ >> 4];
                }
                L2229_ui_ += 2;
        }
}

void F0129_VIDEO_BlitShrinkWithPaletteChanges(
unsigned char*   P0186_puc_Bitmap_Source       SEPARATOR
unsigned char*   P0187_puc_Bitmap_Destination  SEPARATOR
int16_t          P0188_i_SourcePixelWidth      SEPARATOR
int16_t          P0189_i_SourceHeight          SEPARATOR
int16_t          P0190_i_DestinationPixelWidth SEPARATOR
int16_t          P0191_i_DestinationHeight     SEPARATOR
unsigned char*   P0192_puc_PaletteChanges      FINAL_SEPARATOR
{
        unsigned int16_t L2234_ui_;
        unsigned int16_t L2233_ui_;
        int16_t L2235_i_;
        unsigned int16_t L2236_ui_;
        int16_t L2237_i_;
        unsigned int16_t L2238_i_;


        G2043_puc_BlitShrink_BitmapSource = P0186_puc_Bitmap_Source;
        G2044_puc_BlitShrink_BitmapDestination = P0187_puc_Bitmap_Destination;
        G2042_puc_BlitShrink_PaletteChanges = P0192_puc_PaletteChanges;
        L2237_i_ = M104_EVEN_INTEGER(P0190_i_DestinationPixelWidth);
        L2238_i_ = M104_EVEN_INTEGER(P0188_i_SourcePixelWidth);
        L2235_i_ = (P0188_i_SourcePixelWidth << 6) / P0190_i_DestinationPixelWidth;
        L2236_ui_ = (P0189_i_SourceHeight << 6) / P0191_i_DestinationHeight;
        L2234_ui_ = L2236_ui_ >> 1;
        for (L2233_ui_ = 0; L2233_ui_ < P0191_i_DestinationHeight; L2233_ui_++) {
                if (P0192_puc_PaletteChanges == NULL) {
                        F0720_ShrinkBLT_Sub1((L2234_ui_ >> 6) * L2238_i_, L2233_ui_ * L2237_i_, L2235_i_, P0190_i_DestinationPixelWidth);
                } else {
                        F0721_ShrinkBLT_Sub2((L2234_ui_ >> 6) * L2238_i_, L2233_ui_ * L2237_i_, L2235_i_, P0190_i_DestinationPixelWidth);
                }
                L2234_ui_ += L2236_ui_;
        }
}
...
void F0466_EXPAND_GraphicToBitmap(
unsigned char* P0871_puc_Graphic SEPARATOR
#if (defined(MEDIA508_F20E_F20J_X30J_P20JA_P20JB) || defined(MEDIA763_AU1E_AU2E) || (defined(MEDIA618_A31E) && (EXETYPE == C01_SWOOSH)) || (defined(MEDIA671_F31E_F31J_P31J) && (EXETYPE == C06_CEDT)))
unsigned char* P0872_puc_Bitmap  SEPARATOR
int16_t        P0873_i_X         SEPARATOR
int16_t        P0874_i_Y         FINAL_SEPARATOR
#else
unsigned char* P0872_puc_Bitmap  FINAL_SEPARATOR
#endif
{
        if (P0872_puc_Bitmap != NULL) {
                F0689_IMG_ExpandGraphicToBitmap(P0871_puc_Graphic, P0872_puc_Bitmap);
        } else {
#if (defined(MEDIA458_P20JA_P20JB) || (defined(MEDIA667_P31J) && (EXETYPE == C06_CEDT)))
                F0691_IMG_ExpandGraphicToScreen(P0871_puc_Graphic, P0873_i_X, P0874_i_Y);
#else
                F0691_IMG_ExpandGraphicToScreen(P0871_puc_Graphic, 0, 0);
#endif
        }
}
...
int16_t P0100_i_PaletteSwitchingRequestedState FINAL_SEPARATOR
{
        int16_t L2410_i_;
        int16_t L2411_i_;
        int16_t L2412_i_;
        int16_t L2413_ai_Box[4];
        int16_t L2414_ai_XYZ[4];
        BOOLEAN L2415_B_;


        F0706_GetMouseState(&L2410_i_, &L2411_i_, &L2412_i_);
        if ((L2411_i_ > 168) || (L2410_i_ > 223) || (L2411_i_ < 15)) {
                F0704_();
                L2415_B_ = C1_TRUE;
        } else {
                F0077_MOUSE_EnableScreenUpdate_CPSE();
        ...
        switch (P0100_i_PaletteSwitchingRequestedState) {
                case 1:
                        if (G0304_i_DungeonViewPaletteIndex != G2123_) {
                                F0694_SetMultipleColorsInPalette(G2061_DungeonViewPaletteIndices[G0304_i_DungeonViewPaletteIndex]);
                                G2123_ = G0304_i_DungeonViewPaletteIndex;
                        }
                        break;
                case 0:
                        if (G0309_i_PartyMapIndex != C255_MAP_INDEX_ENTRANCE) {
                                F0694_SetMultipleColorsInPalette(C08_INVENTORY);
                        } else {
        ...
        M769_BOX_RIGHT(L2413_ai_Box) = M705_ZONE_RIGHT(L2414_ai_XYZ);
        M770_BOX_TOP(L2413_ai_Box) = M706_ZONE_TOP(L2414_ai_XYZ);
        M771_BOX_BOTTOM(L2413_ai_Box) = M707_ZONE_BOTTOM(L2414_ai_XYZ);
...
void F0696_UpdateMessageArea(
void
)
{
        int16_t L3502_ai_XYZ[4];
        int16_t L3503_ai_Box[4];


        F0077_MOUSE_EnableScreenUpdate_CPSE();
        F0638_GetZone(C015_ZONE_MESSAGE_AREA, L3502_ai_XYZ);
        M768_BOX_LEFT(L3503_ai_Box) = M704_ZONE_LEFT(L3502_ai_XYZ);
        M769_BOX_RIGHT(L3503_ai_Box) = M705_ZONE_RIGHT(L3502_ai_XYZ);
        M770_BOX_TOP(L3503_ai_Box) = M706_ZONE_TOP(L3502_ai_XYZ);
        M771_BOX_BOTTOM(L3503_ai_Box) = M707_ZONE_BOTTOM(L3502_ai_XYZ);
        (*(G2156_VideoDriver->VIDRV_10_ScrollMessageAreaUp))(L3503_ai_Box, G2088_C7_TextLineHeight);
        M706_ZONE_TOP(L3502_ai_XYZ) = M707_ZONE_BOTTOM(L3502_ai_XYZ) - G2083_C6_ + 1;
        M709_ZONE_HEIGHT(L3502_ai_XYZ) = G2083_C6_;
        F0132_VIDEO_Blit(G0356_puc_Bitmap_MessageAreaNewRow, NULL, L3502_ai_XYZ, 0, 0, G2092_MessageAreaWidth, G2071_C320_ScreenPixelWidth, CM1_COLOR_NO_TRANSPARENCY, MASK0x0000_NO_FLIP);
        F0078_MOUSE_DisableScreenUpdate();
}
...
void F0135_VIDEO_FillBox(
unsigned char*            P0221_puc_Bitmap  SEPARATOR
int16_t*                  P2219_pi_XYZ      SEPARATOR
unsigned int16_t          P0223_i_Color     SEPARATOR /* If bit 15 is set then only every other pixel is overwritten */
unsigned int16_t          P2221_i_Width     FINAL_SEPARATOR
{
        int16_t L3397_ai_Box[4];


        if (P0221_puc_Bitmap != NULL) {
                F0692_FillBox(P0221_puc_Bitmap, P2219_pi_XYZ, P0223_i_Color, P2221_i_Width);
        } else {
                M768_BOX_LEFT(L3397_ai_Box) = M704_ZONE_LEFT(P2219_pi_XYZ);
                M769_BOX_RIGHT(L3397_ai_Box) = M705_ZONE_RIGHT(P2219_pi_XYZ);
                M770_BOX_TOP(L3397_ai_Box) = M706_ZONE_TOP(P2219_pi_XYZ);
                M771_BOX_BOTTOM(L3397_ai_Box) = M707_ZONE_BOTTOM(P2219_pi_XYZ);
                (*(G2156_VideoDriver->VIDRV_01_FillBox))(P0221_puc_Bitmap, L3397_ai_Box, P0223_i_Color, P2221_i_Width);
        }
}
...
long    P0007_l_ByteCount    FINAL_SEPARATOR
{
        if ((unsigned char huge*)P0005_pc_Source > (unsigned char huge*)P0006_pc_Destination) {
                asm     cld
                asm     push    ds
                asm     lds     si, P0005_pc_Source
                asm     les     di, P0006_pc_Destination
                asm     mov     cx, P0007_l_ByteCount
                asm     shr     cx, 1
                asm     pushf
                asm     rep movsw
                asm     popf
                ...
                P0005_pc_Source += P0007_l_ByteCount - 1;
                P0006_pc_Destination += P0007_l_ByteCount - 1;
                asm     std
                asm     push    ds
                asm     lds     si, P0005_pc_Source
                asm     les     di, P0006_pc_Destination
...
unsigned long P0009_i_ByteCount FINAL_SEPARATOR
/*#ifdef X463_I34E_I34M
long P0009_i_ByteCount FINAL_SEPARATOR
*//*#endif
/*#ifdef MEDIA548_F20E_F20J_X30J_A36M_A31E_A31M_A33M_A35E_A35M_F31E_F31J_X31J
int16_t P0009_i_ByteCount FINAL_SEPARATOR
*//*#endif*/
{
        asm     cld
        asm     les     di, P0008_pc_Buffer
        asm     mov     cx, P0009_i_ByteCount
        asm     shr     cx, 1
        asm     pushf
        asm     mov     ax, 0
        asm     rep stosw
...
/* BEGIN INVRTZON.C */
void F0731_InvertZone(
int16_t P2215_i_ZoneIndex FINAL_SEPARATOR
{
        int16_t L2870_ai_XYZ[4];


        F0638_GetZone(P2215_i_ZoneIndex, L2870_ai_XYZ);
                F0698_InvertBox(L2870_ai_XYZ);
}
/* END INVRTZON.C */
