# Demon V2 family spec

## Intent
Create a bounded V2 creature family for **Demon** that is cleaner and smoother than the original presentation without changing perceived gameplay timing.
