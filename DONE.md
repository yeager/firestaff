...
- ✅ Hall champion mirror Z-order slice: `dm1_v1_champion_mirror_zorder_runtime` opens the DM1 V1 runtime, pixel-proves the north/east D1C champion mirror portraits, and checks west-facing Hall side poses do not leave a floating D1C portrait.
