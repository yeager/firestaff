...
- ✅ Source-lock verifier hardening: viewport/walls landable metadata, wall-clip source audit, D3/D2 wall-ornament order, D0/D1 visible-square draw-order, wall-alcove C2548, champion stat panel, and ambient dungeon sound gates now resolve current local code/source boundaries and reflect the closed no-ambient-loop source boundary.
