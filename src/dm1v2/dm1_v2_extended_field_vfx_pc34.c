 ...
 * - ReDMCSB DUNGEON.C:2243-2246 door raw type becomes side/front aspect.
 ...
 * - ReDMCSB DUNVIEW.C:6820-6827 pit rendering.
 * - ReDMCSB DUNVIEW.C:6828 field (teleporter/fluxcage) rendering.
 *
