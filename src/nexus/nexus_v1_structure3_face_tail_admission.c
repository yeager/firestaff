...
{
    Nexus_V1_Structure3FaceTailAdmissionReceipt receipt;
    ...
    receipt.tail_bound = receipt.no_draw_only = 1;
    ...
    receipt.tail_offset = face->face_offset + 8U;
    receipt.tail_fnv1a64 = fnv1a64(tail, sizeof(receipt.raw_bytes));
    memcpy(receipt.raw_bytes, tail, sizeof(receipt.raw_bytes));
    *out_receipt = receipt;
    return 1;
}
