...
static int Phase17_SubtypeToExplosionType(int subtype) {
    ...
    /* ReDMCSB PROJEXPL.C F0217:574-585 / F0213:149 preserves FF86. */
    case PROJECTILE_SUBTYPE_POISON_BOLT:       return C006_EXPLOSION_POISON_BOLT;
