    ...
    const redmcsb_f0928_print_os_error_callbacks_pc34_compat *callbacks)
{
    ...
    callbacks->console_write(callbacks->context, "Primative OS error:\a 0x");
...
{
    return "ReDMCSB PRIM1.C:423-445 defines F0928_PrintOSError: "
           "Cconws/PRINT emits \"Primative OS error:\\7 0x\", F0933 formats "
           ...
           "original value is returned; PRIM.H:286 maps the PC route to "
           "primError.";
}
