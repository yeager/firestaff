...
const unsigned char G9013_auc_VgaPaletteSpecial_Compat[VGA_PALETTE_PC34_SPECIAL_PALETTE_COUNT][16][3] = {
         ...
         * with the CSB dark-blue base, then sets only index 15 to white. CSBWin mirrors
         ...
         * ReDMCSB ENTRANCE.C:440 selects C28_ENTRANCE_CSB.  On VGA that
         * maps to VIDEODRV.C G8174, rather than DM's C07/G8148 row. */
        {
                {  0,   0,   0}, {109, 109, 109}, {142, 142, 142}, {142,  77,  12},
                {207, 174, 142}, { 77,  45,  45}, { 12, 142,  12}, { 12, 174,  12},
                {142, 109,  77}, {255,  12,  12}, {174, 142, 109}, {109,  77,  45},
                { 77,  77,  77}, {174, 174, 174}, {109,  45,  12}, {255, 255, 255}
        }
};
