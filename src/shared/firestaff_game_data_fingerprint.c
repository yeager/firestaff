...
const FirestaffGameDataFingerprint firestaff_fingerprint_table[FIRESTAFF_FINGERPRINT_COUNT] = {
    ...
    /* ReDMCSB ANIM.C lines 67-72 opens this hash-locked pair. The local
     * Atari ST 2.x source package and the Phase 0 provenance gate retain
     * the matching byte count and SHA-256 evidence for both files. */
    {MD5(41,74,D6,DE,53,84,32,30,72,B1,85,64,0E,D3,17,23), G_CSB, P_ST, L_EN, F_SCR, "2.0", "CSB Atari ST 2.0 ANIMATE.SCR"},
    /* ReDMCSB HINTLOAD.C / COMPILE.H identifies HINT.FTL as the Hint Oracle
    ...
    /* ReDMCSB CEDTDATA.C:394/397 loads the PORTRAIT directory's CMP files through the Utility
     * Disk. CEDT001.C F7000 writes the authenticated 508-byte CMP record. */
    {MD5(E2,A8,89,BD,B8,E1,92,3C,B7,F8,39,89,F9,2B,53,A2), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/ALEX.CMP"},
    {MD5(C5,33,46,C8,21,3D,85,62,2A,3F,9A,5C,41,CB,33,50), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/AZIZI.CMP"},
    {MD5(79,2D,80,0D,36,A3,E8,2F,53,1A,3D,EF,F4,DA,79,F5), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/AZIZI_2.CMP"},
    {MD5(3B,8A,39,75,2B,A4,C1,71,37,A5,E9,1A,EF,55,B3,EF), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/BORIS.CMP"},
    {MD5(77,DF,2C,39,F9,F3,A0,43,A3,CD,58,25,EC,73,92,87), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/CHANI.CMP"},
    {MD5(81,45,66,1D,83,DE,75,CE,BC,EB,EE,FB,E8,45,61,79), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/DAROOU.CMP"},
    {MD5(4E,C6,86,CD,A9,AA,87,0D,0E,E4,6B,A3,53,03,E7,23), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/ELIJA.CMP"},
    {MD5(54,1B,2B,BC,18,D8,2D,31,CD,8F,1B,88,AC,9C,91,1A), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/GANDO.CMP"},
    {MD5(D0,C5,B7,91,99,2C,25,BF,68,86,B5,59,EA,86,A2,E1), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/GOTHMOG.CMP"},
    {MD5(06,E6,22,DC,41,42,AF,DC,6B,7B,BB,80,BE,91,1E,49), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/HALK.CMP"},
    {MD5(24,47,78,F7,4E,80,71,3D,66,86,10,91,BA,27,DB,A9), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/HAWK.CMP"},
    {MD5(0B,57,42,29,36,6D,01,10,41,53,84,6B,50,CC,D0,EC), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/HISSSSA.CMP"},
    {MD5(D5,52,24,25,1E,EA,CD,F4,72,0F,0D,37,3D,DB,22,59), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/IAIDO.CMP"},
    {MD5(63,5D,F1,B1,C5,54,5E,7D,92,ED,7A,7E,76,39,B6,C6), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/LEIF.CMP"},
    {MD5(1E,80,B2,CA,4D,9E,70,41,10,D4,9D,76,06,B8,EB,69), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/LEYLA.CMP"},
    {MD5(4F,D8,1B,21,2D,1C,E4,13,86,2A,7E,49,F0,00,94,29), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/LINFLAS.CMP"},
    {MD5(5F,A0,32,44,6A,4F,59,EE,5C,DD,47,F7,DE,E4,69,17), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/MOPHUS.CMP"},
    {MD5(85,BD,13,B5,E6,85,77,E9,3E,8A,1A,50,42,87,E3,6E), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/NABI.CMP"},
    {MD5(D5,0A,B2,7D,7C,BC,70,73,09,95,FF,B0,9B,79,A3,30), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/SONJA.CMP"},
    {MD5(00,A0,02,E6,7E,F9,36,32,D7,BE,C1,F6,C6,ED,B2,D5), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/SONJA_2.CMP"},
    {MD5(FF,94,A1,C1,2F,80,3E,DB,1B,43,F5,22,E9,A6,6C,63), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/STAMM.CMP"},
    {MD5(84,6C,9E,E7,45,3E,08,AF,2E,E3,C9,84,CB,C5,59,28), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/SYRA.CMP"},
    {MD5(8A,26,FF,F4,70,CC,F7,A3,AD,A2,B1,20,F4,3D,B4,49), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/TIGGY.CMP"},
    {MD5(1F,1C,54,A7,59,2C,C6,7C,19,1B,A9,AB,BA,4B,9A,6A), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/WUTSE.CMP"},
    {MD5(7E,59,6F,DD,72,87,14,8F,FB,CA,B5,DF,17,48,D6,28), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/WUUF.CMP"},
    {MD5(2C,F2,E3,EF,A4,73,B2,6A,FE,36,26,4D,68,F8,77,86), G_CSB, P_ST, L_EN, F_CMP, "2.0", "CSB Atari ST 2.0 PORTRAIT/ZED.CMP"},
