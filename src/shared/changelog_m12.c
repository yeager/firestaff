...
static const char* const g_changelogLines[] = {
    ...
    "",
    "V3.0.188  (2026-07-30)",
    "  - Packages CSB V2.x presentation work for the supported Atari ST, Amiga and FM Towns retail lanes.",
    "  - The unproven CSBWin C040 modal panel remains fail-closed instead of being presented as a runtime HUD surface.",
    "",
    "V3.0.86  (2026-07-17)",
    ...
    "",
    "V3.0.21  (2026-07-03)",
    "  - Packages the post-v3.0.20 mainline gates for CSB runtime movement, quicksave/quickload/resume handoff, runtime viewport/input bridging, and chained party teleports through pits.",
    ...
    "    - CHM-04: F0319_CHAMPION_Kill auto-close-chest runtime helper.  DM1_V1_InventoryChestAutoCloseOnLeaderDeath_RunPc34 drives the F0319 -> F0355 -> F0334 -> F0318 chain against a live DM1 inventory state.  Source-locked to ReDMCSB CHAMPION.C:1552-1607, PANEL.C:2244-2310, CHEST.C:79-130, CHAMPION.C:1527-1551.  Test 3/3 PASS",
