...
static int dm1_v1_inventory_zone_to_xywh(
    int ok,
    const DM1_V1_InventorySlotBoxZonePc34* zone,
    int* outX,
    int* outY,
    int* outW,
    int* outH) {
...
int dm1_v1_inventory_source_slot_box_zone_xywh_pc34(
    ...
    int* outH) {
    DM1_V1_InventorySlotBoxZonePc34 zone;
    return dm1_v1_inventory_zone_to_xywh(
        dm1_v1_inventory_source_slot_box_zone_pc34(sourceSlotBoxIndex, &zone),
        &zone,
        outX,
        outY,
        outW,
