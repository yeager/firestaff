...
enum {
    ...
    DM1_D0L_ZONE_VIEW_FLOOR = 8,   /* Contract zone: C1500 + 0 * 11 + 8 = 1508 */
    DM1_D0R_ZONE_VIEW_FLOOR = 10,  /* Contract zone: C1500 + 0 * 11 + 10 = 1510 */
    DM1_D0_DEPTH = 0,
    DM1_D0L_LANE = -1,
    DM1_D0R_LANE = 1,
    DM1_FLOOR_ZONE_BASE = 1500,
    DM1_FLOOR_ZONE_STRIDE_PC34 = 11,
    DM1_D0L_CEILING_ZONE = 870,
    DM1_D0R_CEILING_ZONE = 872,
    DM1_CEILING_GRAPHIC_D0L_PC34 = 68,
    DM1_WALL_KEEP_OUT_ZONE_FIRST = 716,
    DM1_WALL_KEEP_OUT_ZONE_LAST = 717,
    DM1_MUTATION_GUARD_BEFORE = 0x729108u,
    DM1_MUTATION_GUARD_AFTER = 0x801927u
};
...
static const char s_source_evidence[] =
    ...
    "F0115:5211-5214 thing-pass cell ordering; DUNVIEW.C F0125:7960-8062 "
    "D0L side-row ceiling copy and C0x0002 F0115 pass; DUNVIEW.C "
    "F0126:8064-8162 D0R side-row flipped ceiling copy and C0x0001 F0115 "
    "pass; DUNVIEW.C F0128:8318-8541 dispatcher sweep anchor, with "
    "D0L/D0R at F0128:8536-8541; "
    ...
    "DEFS.H:2659-2660 cell orders; DEFS.H:4056-4057 C716/C717 wall "
    "zones; DEFS.H:4139-4153 cell-order zone band; DEFS.H:4217-4219 D0 "
    "ceiling zones; DEFS.H:4223 "
    "C1500_ZONE_FLOOR_ORNAMENT.";

static const DM1_V1_D0LD0RF0108SpecPc34 s_specs[] = {
    {
        DM1_V1_D0L_D0R_F0108_SIDE_D0L_PC34,
        "D0L floor+ceiling+ornament source-lock contract",
        "F0125_DUNGEONVIEW_DrawSquareD0L",
        DM1_D0_DEPTH,
        DM1_D0L_LANE,
        8536,
        DM1_D0L_VIEW_SQUARE,
        DM1_D0L_ZONE_VIEW_FLOOR,
        1508,
        DM1_FLOOR_ZONE_BASE,
        ...
        "DEFS.H:2088/2596-2611/2659-2660/4056-4057/4139-4153/4217-4219/4223"
    },
    {
        DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34,
        "D0R floor+ceiling+ornament source-lock contract",
        "F0126_DUNGEONVIEW_DrawSquareD0R",
        DM1_D0_DEPTH,
        DM1_D0R_LANE,
        8540,
        DM1_D0R_VIEW_SQUARE,
        DM1_D0R_ZONE_VIEW_FLOOR,
        1510,
        DM1_FLOOR_ZONE_BASE,
        DM1_FLOOR_ZONE_STRIDE_PC34,
        0,
...
static DM1_V1_D0LD0RF0108SelfTestResultPc34 s_last_self_test;
...
static int is_supported_context(DM1_V1_D0LD0RF0108ContextPc34 context)
{
    return context == DM1_V1_D0L_D0R_F0108_CONTEXT_CORRIDOR_PC34 ||
           context == DM1_V1_D0L_D0R_F0108_CONTEXT_OPEN_PIT_PC34 ||
           context == DM1_V1_D0L_D0R_F0108_CONTEXT_TELEPORTER_PC34 ||
           context == DM1_V1_D0L_D0R_F0108_CONTEXT_DOOR_SIDE_PC34 ||
           context == DM1_V1_D0L_D0R_F0108_CONTEXT_STAIRS_FRONT_PC34;
}

size_t dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_count_pc34(void)
{
    return sizeof(s_specs) / sizeof(s_specs[0]);
}

const DM1_V1_D0LD0RF0108SpecPc34 *
dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_at_pc34(size_t index)
{
    if (index >= dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_count_pc34()) {
        return NULL;
    }
...
const DM1_V1_D0LD0RF0108SpecPc34 *
dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_for_side_pc34(int side)
{
    size_t i;

    for (i = 0u; i < dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_count_pc34(); ++i) {
        if ((int)s_specs[i].side == side) return &s_specs[i];
    }
    return NULL;
}

bool dm1_v1_viewport_d0l_d0r_f0108_initial_state_pc34(
    DM1_V1_D0LD0RF0108SidePc34 side,
    DM1_V1_D0LD0RF0108ContextPc34 context,
    DM1_V1_D0LD0RF0108StatePc34 *out)
{
    const DM1_V1_D0LD0RF0108SpecPc34 *spec;

    if (!out) return false;
    memset(out, 0, sizeof(*out));
    spec = dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_for_side_pc34((int)side);
    if (!spec || !is_supported_context(context)) return false;

    out->side = side;
    out->context = context;
    out->floor_ornament_ordinal =
        side == DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34 ? 0x8006u : 0x8004u;
    out->floor_ornament_native_bitmap_index = 240 + spec->view_floor;
    out->destination_pixel =
        side == DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34 ? 0x32u : 0x31u;
    out->floor_pixel =
        side == DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34 ? 0x52u : 0x51u;
    out->ceiling_pixel =
        side == DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34 ? 0x72u : 0x71u;
    out->thing_pass_pixel = DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34;
    out->seed = side == DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34 ? 0x725102u : 0x725101u;
...
bool dm1_v1_viewport_d0l_d0r_f0108_decode_ordinal_pc34(
    unsigned int floor_ornament_ordinal,
    DM1_V1_D0LD0RF0108OrdinalPc34 *out)
{
    ...
    out->footprint_flag_set =
        (floor_ornament_ordinal & DM1_V1_D0L_D0R_F0108_FOOTPRINT_MASK_PC34) != 0u;
    cleared = floor_ornament_ordinal & ~DM1_V1_D0L_D0R_F0108_FOOTPRINT_MASK_PC34;
    ...
    if (out->recursive_footprints_draw) {
        out->recursive_footprints_index = DM1_V1_D0L_D0R_F0108_FOOTPRINT_INDEX_PC34;
        ++out->metadata_blit_count;
    }
    return true;
}

uint8_t dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(
    uint8_t destination_pixel,
    uint8_t source_pixel)
{
    return source_pixel == DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34 ?
        destination_pixel : source_pixel;
}

bool dm1_v1_viewport_d0l_d0r_f0108_compose_pc34(
    const DM1_V1_D0LD0RF0108StatePc34 *state,
    DM1_V1_D0LD0RF0108ResultPc34 *out)
{
    const DM1_V1_D0LD0RF0108SpecPc34 *spec;
    DM1_V1_D0LD0RF0108OrdinalPc34 ordinal;
    uint8_t pixel;

    if (!out) return false;
    memset(out, 0, sizeof(*out));
    if (!state) return false;
    spec = dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_for_side_pc34((int)state->side);
    out->spec = spec;
    if (!spec ||
    ...
    if (!dm1_v1_viewport_d0l_d0r_f0108_decode_ordinal_pc34(
    ...
    out->cell_order_band_ok =
        (spec->thing_pass_order == 0x0002 || spec->thing_pass_order == 0x0001) &&
    ...
    if (ordinal.has_input_ordinal) {
        ...
        if (ordinal.primary_draws) {
            pixel = dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(pixel, state->floor_pixel);
            if (state->floor_pixel == DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34) {
    ...
    pixel = dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(pixel, state->ceiling_pixel);
    if (state->ceiling_pixel == DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34) {
        ++out->c10_transparent_blits;
    }
    out->after_ceiling = pixel;

    out->thing_pass_calls = 1;
    pixel = dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(pixel, state->thing_pass_pixel);
    if (state->thing_pass_pixel == DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34) {
        ++out->c10_transparent_blits;
    }
...
int run_dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_self_test(void)
{
    static const DM1_V1_D0LD0RF0108ContextPc34 contexts[] = {
        DM1_V1_D0L_D0R_F0108_CONTEXT_CORRIDOR_PC34,
        DM1_V1_D0L_D0R_F0108_CONTEXT_OPEN_PIT_PC34,
        DM1_V1_D0L_D0R_F0108_CONTEXT_TELEPORTER_PC34,
        DM1_V1_D0L_D0R_F0108_CONTEXT_DOOR_SIDE_PC34,
        DM1_V1_D0L_D0R_F0108_CONTEXT_STAIRS_FRONT_PC34
    };
    ...
    self_check_contains(&c, s_source_evidence, "F0128:8318-8541");
    self_check_contains(&c, s_source_evidence, "F0128:8536-8541");
    ...
    self_check_contains(&c, s_source_evidence, "DEFS.H:2659-2660");
    self_check_contains(&c, s_source_evidence, "DEFS.H:4056-4057");
    self_check_contains(&c, s_source_evidence, "DEFS.H:4139-4153");
    self_check_contains(&c, s_source_evidence, "DEFS.H:4217-4219");
    ...
    self_check_eq(&c, (int)dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_count_pc34(), 2);
    self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_at_pc34(2) == NULL);
    self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_for_side_pc34(9) == NULL);
    ...
    for (side_index = 0; side_index < 2; ++side_index) {
        const int side = side_index == 0 ?
            ...
            DM1_V1_D0L_D0R_F0108_SIDE_D0R_PC34;
        const DM1_V1_D0LD0RF0108SpecPc34 *spec =
            dm1_v1_viewport_d0l_d0r_f0108_floor_ceiling_ornament_for_side_pc34(side);
        ...
        self_check_eq(&c, spec->ceiling_graphic, 68);
        ...
        if (side == DM1_V1_D0L_D0R_F0108_SIDE_D0L_PC34) {
            self_check_eq(&c, spec->relative_lateral, -1);
            self_check_eq(&c, spec->f0128_dispatch_line, 8536);
            self_check_eq(&c, spec->view_square, 1);
            self_check_eq(&c, spec->view_floor, 8);
            self_check_eq(&c, spec->floor_zone, 1508);
            self_check_eq(&c, spec->floor_flip_horizontal, 0);
            self_check_eq(&c, spec->ceiling_zone, DM1_D0L_CEILING_ZONE);
            self_check_eq(&c, spec->ceiling_flip_horizontal, 0);
            self_check_eq(&c, spec->thing_pass_order, 0x0002);
            self_check_eq(&c, spec->thing_pass_view_square, DM1_D0L_VIEW_SQUARE);
        } else {
            self_check_eq(&c, spec->relative_lateral, 1);
            self_check_eq(&c, spec->f0128_dispatch_line, 8540);
            self_check_eq(&c, spec->view_square, 2);
            self_check_eq(&c, spec->view_floor, 10);
            self_check_eq(&c, spec->floor_zone, 1510);
            self_check_eq(&c, spec->floor_flip_horizontal, 1);
            self_check_eq(&c, spec->ceiling_zone, DM1_D0R_CEILING_ZONE);
            self_check_eq(&c, spec->ceiling_flip_horizontal, 1);
            self_check_eq(&c, spec->thing_pass_order, 0x0001);
            self_check_eq(&c, spec->thing_pass_view_square, DM1_D0R_VIEW_SQUARE);
        }

        for (context_index = 0;
             context_index < (int)(sizeof(contexts) / sizeof(contexts[0]));
             ++context_index) {
            DM1_V1_D0LD0RF0108StatePc34 state;
            DM1_V1_D0LD0RF0108ResultPc34 result;
            DM1_V1_D0LD0RF0108OrdinalPc34 ordinal;

            self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_initial_state_pc34(
                (DM1_V1_D0LD0RF0108SidePc34)side, contexts[context_index], &state));
            ...
            self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_decode_ordinal_pc34(
                state.floor_ornament_ordinal, &ordinal));
            ...
            self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_compose_pc34(&state, &result));
            ...
            if (side == DM1_V1_D0L_D0R_F0108_SIDE_D0L_PC34) {
                ++s_last_self_test.d0l_floor_calls;
            } else {
                ++s_last_self_test.d0r_floor_calls;
            }
    ...
    self_check_eq(&c, s_last_self_test.d0l_floor_calls,
                  (int)(sizeof(contexts) / sizeof(contexts[0])));
    self_check_eq(&c, s_last_self_test.d0r_floor_calls,
                  (int)(sizeof(contexts) / sizeof(contexts[0])));
    ...
    self_check_eq(&c, s_last_self_test.thing_pass_calls,
                  (int)(sizeof(contexts) / sizeof(contexts[0])) * 2);
    self_check_eq(&c, dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(77, 10), 77);
    self_check_eq(&c, dm1_v1_viewport_d0l_d0r_f0108_blend_c10_pc34(77, 11), 11);
    self_check(&c, !dm1_v1_viewport_d0l_d0r_f0108_decode_ordinal_pc34(0, NULL));
    ...
    for (i = 0; i < 16; ++i) {
        ...
        state.floor_ornament_ordinal = ((next_lcg(&seed) & 7u) + 1u) |
            ((i & 1) ? DM1_V1_D0L_D0R_F0108_FOOTPRINT_MASK_PC34 : 0u);
        state.floor_pixel = (uint8_t)((next_lcg(&seed) & 0x7fu) + 0x20u);
        state.ceiling_pixel = (uint8_t)((next_lcg(&seed) & 0x7fu) + 0x40u);
        if ((i % 5) == 0) state.floor_pixel = DM1_V1_D0L_D0R_F0108_C10_COLOR_FLESH_PC34;
        self_check(&c, dm1_v1_viewport_d0l_d0r_f0108_compose_pc34(&state, &result));
        self_check_eq(&c, result.source_locked_contract_only, 1);
        self_check_eq(&c, result.no_game_data_load, 1);
...
const DM1_V1_D0LD0RF0108SelfTestResultPc34 *
dm1_v1_viewport_d0l_d0r_f0108_last_self_test_result_pc34(void)
{
    return &s_last_self_test;
}

const char *dm1_v1_viewport_d0l_d0r_f0108_source_evidence_pc34(void)
{
