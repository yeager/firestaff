...
dm1_v1_g0194_get_pc34(int entry_index)
{
    ...
    return (int)s_g0194[entry_index];
}
    ...
    DM1_V1_G0194ResultPc34 *out)
{
    ...
    for (i = 0; i < kTableSize; ++i) {
        out->tableEntries[i] = (int)s_g0194[i];
    }
    ...
    for (i = 0; i < kTableSize; ++i) {
        if (dm1_v1_g0194_get_pc34(i) != (int)s_g0194[i]) {
            lookup_function_correct = 0;
        }
    }
    out->lookupFunctionCorrect = lookup_function_correct;

    if (dm1_v1_g0194_get_pc34(-1) != kOutOfRange) lookup_out_of_range_returns_minus_one = 0;
    if (dm1_v1_g0194_get_pc34(kTableSize) != kOutOfRange) lookup_out_of_range_returns_minus_one = 0;
    if (dm1_v1_g0194_get_pc34(999) != kOutOfRange) lookup_out_of_range_returns_minus_one = 0;
