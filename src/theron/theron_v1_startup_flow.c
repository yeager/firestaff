...
Theron_StartupResult theron_v1_startup_flow_rebuild_from_facts_with_receipt(
    ...
    if (out_receipt &&
        !theron_v1_startup_state_receipt_from_flow(flow, out_receipt)) {
        return THERON_STARTUP_ERR_NULL;
    }
    return THERON_STARTUP_OK;
}
...
Theron_StartupResult theron_v1_startup_flow_rebuild_from_session_with_receipt(
    ...
    progression = &session->world->progression;
    return theron_v1_startup_flow_rebuild_from_facts_with_receipt(
        session->phase,
        session->selected_dungeon,
        session->selected_mirrors_mask,
        session->companion_count,
...
static void tqr_startup_input_receipt_init(
...
int theron_v1_startup_chapter_inspect_receipt_from_session(
    ...
    return theron_v1_startup_chapter_inspect_receipt_from_facts(
...
int theron_v1_startup_layout_build_from_session(
    ...
    return theron_v1_startup_layout_build_from_session_facts(
        session->phase,
        session->selected_dungeon,
        session->boot_profile,
        session->world,
        session->soul_cursor,
        session->continue_focus,
        session->resume_claim,
        session->tqsv_slot,
        session->srm_slot,
        session->srm_import_status,
        session->startup_text_prompt,
        session->startup_roster_names,
        session->startup_roster_titles,
    ...
    Theron_StartupAction *out_action)
{
    ...
    return theron_v1_startup_handle_pointer_from_layout_state(
        &state,
        soul_cursor,
        continue_focus,
        has_tqsv_continue || has_srm_continue,
        x,
        y,
        out_result,
        out_action);
...
int theron_v1_startup_handle_pointer_from_session_facts_with_receipt(
    ...
    return theron_v1_startup_handle_pointer_from_facts_with_receipt(
        phase,
        selected_dungeon,
        boot_profile,
        world,
...
int theron_v1_startup_handle_pointer_from_session_with_receipt(
    ...
    return theron_v1_startup_handle_pointer_from_session_facts_with_receipt(
        session->phase,
        session->selected_dungeon,
        session->boot_profile,
        session->world,
    ...
    Theron_StartupStateReceipt *out_state_receipt)
{
    ...
    return theron_v1_startup_execute_flow_plan_from_facts_with_host_receipts(
        plan,
        session->phase,
        session->selected_dungeon,
        session->selected_mirrors_mask,
    ...
    Theron_StartupRenderPlan *out_plan)
{
    ...
    element_count = theron_v1_startup_layout_build(
        ...
        elements,
        (int)(sizeof(elements) / sizeof(elements[0])));
    return theron_v1_startup_render_plan_build(&layout_state,
                                               elements,
                                               element_count,
                                               out_plan);
}
...
int theron_v1_startup_render_plan_build_from_session(
    ...
    return theron_v1_startup_render_plan_build_from_session_facts(
        session->phase,
        session->selected_dungeon,
        session->boot_profile,
        session->world,
...
int theron_v1_startup_render_rows_build_from_session(
    ...
    return theron_v1_startup_render_rows_build_from_session_facts(
        session->phase,
        session->selected_dungeon,
        session->boot_profile,
        session->world,
    ...
    Theron_StartupAction *out_action)
{
    ...
    return theron_v1_startup_handle_input_from_layout_state(&state,
                                                            input,
                                                            out_action);
}
    ...
    Theron_StartupInputReceipt *out_receipt)
{
    ...
    result = theron_v1_startup_handle_input_from_facts(
        phase,
        selected_dungeon,
        boot_profile,
        world,
    ...
    if (out_receipt) {
        ...
        if (result != THERON_STARTUP_OK) {
            ...
            out_receipt->status_scope = "STARTUP";
            out_receipt->status = theron_v1_startup_result_name(result);
        } else if (out_action->kind != THERON_STARTUP_ACTION_NONE) {
            out_receipt->input_result = THERON_STARTUP_INPUT_RESULT_REDRAW;
        }
    }
    return result == THERON_STARTUP_OK;
}
...
int theron_v1_startup_handle_input_from_session_facts_with_receipt(
    ...
    return theron_v1_startup_handle_input_from_facts_with_receipt(
        phase,
        selected_dungeon,
        boot_profile,
        world,
...
int theron_v1_startup_handle_input_from_session_with_receipt(
    ...
    return theron_v1_startup_handle_input_from_session_facts_with_receipt(
        session->phase,
        session->selected_dungeon,
        session->boot_profile,
        session->world,
