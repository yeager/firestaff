...
enum {
    ...
    CSB_ELEMENT_DOOR_FRONT = 17,    /* ReDMCSB DUNVIEW.C:7873 */
    CSB_D1C_REAR_F0115_ORDER = 0x0218,  /* ReDMCSB DUNVIEW.C:7875; DEFS.H:2669 */
    CSB_D1C_FRONT_F0115_ORDER = 0x0349, /* ReDMCSB DUNVIEW.C:7910,7937; DEFS.H:2672 */
    CSB_D1C_FRAME_TOP_ZONE = 733,   /* ReDMCSB DUNVIEW.C:7886; DEFS.H:4092 */
    CSB_D1C_FRAME_LEFT_ZONE = 726,  /* ReDMCSB DUNVIEW.C:7887; DEFS.H:4084 */
    CSB_D1C_FRAME_RIGHT_ZONE = 727, /* ReDMCSB DUNVIEW.C:7893; DEFS.H:4085 */
    CSB_D1C_DOOR_ZONE = 3790,       /* ReDMCSB DUNVIEW.C:7908; DEFS.H:4259 */
    CSB_TRANSPARENT_COLOR = 10,     /* ReDMCSB DUNVIEW.C:3144-3148,3217-3219; DEFS.H:2088 */
    CSB_FLIP_HORIZONTAL_MASK = 1    /* ReDMCSB DUNVIEW.C:3217-3219 */
};

static const char s_source_evidence[] =
    "Source-locked contract gate only; contract_only=1 and no real-asset "
    "parity is claimed. ReDMCSB DUNVIEW.C:F0124_DUNGEONVIEW_DrawSquareD1C:"
    "7873-7911 locks the D1C door-front route: F0108 floor ornament, "
    "F0115 rear object pass with C0x0218 at 7875, PC34/I34 door-frame "
    "top/left draws through F0104 at 7886-7887, right frame draws by "
    "F0105 horizontal flip of G2117_DoorFrameLeftD1C at 7893, then the "
    "F0111 D1C door bitmap at 7908 and the front F0115 order C0x0349 at "
    "7910/7937. ReDMCSB DUNVIEW.C:F0104:3113-3156 and F0105:3185-3238 "
    "lock C10 transparent frame blits and MASK0x0001 horizontal flip. "
    "DEFS.H:2669/2672 locks the rear/front F0115 orders; DEFS.H:"
    "4084-4093 locks C726/C727/C733 D1C frame zones; DEFS.H:4259 locks "
    "M631_ZONE_DOOR_D1C. DUNVIEW.C:F0128:8524-8533 dispatches D1L, D1R, "
    "then D1C, so this D1C door-frame/F0115 pairing does not cover the "
    "F0122 or F0123 side-door routes.";

static const CSB_V1_ViewportD1CF0115DoorFramePc34Contract s_contract = {
    CSB_PRESENT,
    CSB_VIEW_SQUARE_D1C,
    CSB_VIEW_DEPTH_D1,
    CSB_VIEW_LANE_CENTER,
    CSB_ELEMENT_DOOR_FRONT,
    CSB_D1C_REAR_F0115_ORDER,
    CSB_D1C_FRONT_F0115_ORDER,
    CSB_D1C_FRAME_TOP_ZONE,
    CSB_D1C_FRAME_LEFT_ZONE,
    CSB_D1C_FRAME_RIGHT_ZONE,
    CSB_D1C_DOOR_ZONE,
    CSB_TRANSPARENT_COLOR,
    CSB_FLIP_HORIZONTAL_MASK,
    CSB_PRESENT,
    CSB_PRESENT,
    CSB_PRESENT,
    CSB_PRESENT,
    ...
    int part)
{
    ...
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_TOP) return contract->frame_top_zone;
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_LEFT) return contract->frame_left_zone;
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_RIGHT) return contract->frame_right_zone;
    return -1;
}
...
{
    if (!contract) return -1;
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_RIGHT) {
        return contract->flip_horizontal_mask;
    }
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_TOP ||
        part == CSB_V1_D1C_DOOR_FRAME_PART_LEFT) {
        return 0;
    }
    return -1;
}
    ...
    int part)
{
    ...
    if (part == CSB_V1_D1C_DOOR_FRAME_PART_LEFT) {
