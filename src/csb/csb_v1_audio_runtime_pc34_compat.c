                                                ...
                                                int16_t volume)
{
    ...
    if (!runtime || !csb_v1_audio_valid_index(soundIndex) || volume <= 0) {
        return;
    }
...
{
    return csb_v1_audio_runtime_completed_play_details_at(runtime, sequence,
                                                           outSoundIndex, NULL);
}
