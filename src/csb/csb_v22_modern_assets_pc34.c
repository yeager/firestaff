 ...
 * CSB_V22_SHAPE_MISSING_PLACEHOLDER rather than crashing.
 */
...
/* CSB_V22_SHAPE_MISSING_PLACEHOLDER — returned by shape-fetching
...
static const uint32_t CSB_V22_SHAPE_MISSING_PLACEHOLDER_DATA[16 * 16] = {
