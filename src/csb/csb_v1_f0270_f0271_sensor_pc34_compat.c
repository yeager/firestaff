...
int csb_v1_f0270_f0271_sensor_receipt_pc34(const CSB_V1_RuntimeProfile *p,int effect,int x,int y,int cell,CSB_V1_F0270F0271ReceiptPc34 *out){
 ...
 if(effect==10){if(!p->party_state_valid||p->party_state.ChampionCount<=0)return 0;
  r.add_steal_xp=1;r.valid=1;r.source_evidence="ReDMCSB SENSOR.C F0270 C10 -> F0269 loaded party";*out=r;return 1;}
 ...
 if(g>=128||r.matching_sensor_count<2)return 0;
 r.valid=1;r.source_evidence="ReDMCSB SENSOR.C F0270/F0271 raw C03 rotation admission";*out=r;return 1;
}
