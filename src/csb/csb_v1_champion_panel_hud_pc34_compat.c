...
/* F31E/F31J retail GRAPHICS.DAT item 696, COORD.C F0639/F0635 C507..C536.
 * These are viewport-relative C017 pointer-box origins; they are identical
 * in the two authenticated F31 retail records and are not PC/Atari geometry. */
static const int s_inventorySlotX[30] = {
      6,  62,  34,  34,  34,  34,   6,  79,  62,  79,
      6,   6,  62,  66,  83, 100, 117, 134, 151, 168,
    185, 202,  83, 100, 117, 134, 151, 168, 185, 202,
};

static const int s_inventorySlotY[30] = {
     53, 53, 26, 46, 66, 86, 90, 73, 90, 90,
     33, 73, 73, 33, 16, 16, 16, 16, 16, 16,
