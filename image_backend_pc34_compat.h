...
void IMG3_Compat_ExpandOneCommandPadded(const unsigned char* P3000_puc_LocalPalette, unsigned short P3001_ui_VisibleWidth, unsigned short P3002_ui_LineStride, unsigned short* P3003_pui_DestinationOffset, unsigned short* P3004_pui_RemainingInLine);
