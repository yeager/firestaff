...
Scope: ReDMCSB source audit only, from `<redmcsb-source>/ReDMCSB_WIP20210206/Toolchains/Common/Source`, to narrow the validated original PC34 route for movement, viewport clicks, and wall handling without emulator guessing.
