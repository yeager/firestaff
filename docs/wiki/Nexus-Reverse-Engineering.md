...
| `RLOWFIX.BIN` | `RES*` directory with fixed low-memory resources including `CRET`, `TEXT4`, `TABL` and `FONT0–2` | `nexus_v1_creatures.c`, `nexus_v1_rlowfix_text.c`, `nexus_v1_res.c` |
