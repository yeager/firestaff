...
| [Chaos Strikes Back (CSB)](CSB-Reverse-Engineering) | Amiga, Atari ST, FM Towns; CSBWin source reference | ReDMCSB + CSBWin | [CSB RE](CSB-Reverse-Engineering) | Shared engine plus CSB DSA/save work | CSB-specific modules and receipts | No original DOS release or CSBWin runtime route; see repository corpus |
