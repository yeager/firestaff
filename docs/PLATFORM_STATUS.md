...
| Platform | Status | Current scope | Open boundary |
|---|---|---|---|
| Sega Saturn Japanese | **Verified route** | Authentic Track 1/DM.BIN, CUE-declared CDDA Track 02–09 BIN ownership, STABG source consumption, NBG1 palette-bank/origin capture receipt, DGN/DMDF/MNS/PRS3 parsing and bounded phase-launch tests. | Full gameplay, source-to-VDP material semantics, event/audio playback and public capture parity. |
