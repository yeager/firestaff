...
Scope: N2 only (`trv2@192.168.3.121`, `/home/trv2/work/firestaff`). This plan starts from worker head `752a3fa` on `worker/n2-dm1v1-evidence-capture-20260505` and uses ReDMCSB as the source oracle under `/home/trv2/.openclaw/data/firestaff-redmcsb-source/ReDMCSB_WIP20210206/Toolchains/Common/Source/`.
