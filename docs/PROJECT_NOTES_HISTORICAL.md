# Historical project notes (archived 2026-09-06)

Obsolete snapshot retained for reference only. Build, release, workflow,
priority and status statements below are NOT current instructions or proof of
parity. Follow [AGENTS.md](../AGENTS.md). Automatic release advice below is
superseded: releases require an explicit user request.
