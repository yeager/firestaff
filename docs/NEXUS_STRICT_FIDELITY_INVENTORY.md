...
| Saturns `FACE.BIN` | Verifierad 20-entry container; alla 20 verkliga PRS3-portraitrecords kan avkodas till deklarerade 56×56 pixelbuffertar | Porträttdata saknar fortfarande verifierad champion-index-/palett-/VDP-placement-bindning, så ingen rosterpresentation öppnas |
...
| Procedurbyggda save/champion-kommandon | Hostlogik finns, men M11-executorn har inga callbacks för text, ramar eller porträttplacering | Får inte ersätta Saturn-menygrafik |
...
| Källa/route | Status | Regel |
|---|---|---|
| Saturn HUD-yta från `STABG.BIN` | Finns lokalt; STMP-container, 11 kartor och DMWeb:s första 40×21-karta avkodad till 320×168 indexpixlar med filens 256-entry-palette | Ingen VDP1/VDP2-presentering eller runtime-bindning förrän placeringen är verifierad |
