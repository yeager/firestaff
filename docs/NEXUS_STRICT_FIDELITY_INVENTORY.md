...
| Menytextkonsument | `RLOWFIX.BIN` TEXT4 med 15 riktiga poster och TABL/FONT256-data finns verifierat. DM.BIN har dessutom en vardera av registerkonstanterna `0x25F00006` och `0x25F80000`, som nu byteverifieras | Hostens chrome-strängar är inte en Saturn textkonsument; `menu_text_consumer_bound` är 0 på riktiga engine-instanser och routes förblir stängda tills TEXT4/TABL/FONT256 samt register-/VDP2-användning är capture-bundna |
