...
| `MENU.BPK` capture-surface join | En capture-only-adapter jämför en explicit PRS3-yta rad för rad mot en Saturn-capture och binder dess 256 råa PALT/CRAM-ord | Detta öppnar inte menysemantik, VDP2-lagerägare eller normal launcher-rendering |
