...
| Menytextkonsument | `RLOWFIX.BIN` TEXT4 med 15 riktiga poster och TABL/FONT256-data finns verifierat, men hostens chrome-strängar är inte en Saturn textkonsument | `menu_text_consumer_bound` är 0 på riktiga engine-instanser; huvud-, save- och champion-menyroutes förblir stängda tills TEXT4/TABL/FONT256 och VDP2-textplacering är capture-bundna |
