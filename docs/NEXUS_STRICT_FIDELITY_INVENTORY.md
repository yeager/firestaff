...
| DM.BIN startup/menu-resursankare | Den riktiga europeiska `DM.BIN`-korpusen binder `MENU.BPK`, `yam\\menu.c`, `FONT256.S2D` och `STABG.BIN` vid `0x373B4`–`0x373D8`; pointer-receipten är 1/10/1/1 | Detta bevisar loaderns resursnamn och SH-2-adressreferenser, inte menyordning, textkonsument eller VDP1/VDP2-komposition |
