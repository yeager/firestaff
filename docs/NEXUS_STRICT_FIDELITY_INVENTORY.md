...
| Creature→MNS-filnamn i `nexus_v1_creature_names.c` | Byteverifierad källmetadata; full retailtestbindning vid `DM.BIN+0x0385F0` | Filnamn och indexordning är bevisade, men ingen produktionskonsument får därifrån uppfinna CRET-stats, AI eller modellplacering |
