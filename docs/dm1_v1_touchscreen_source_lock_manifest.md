...
| `F0371_COMMAND_ProcessType111To115_ClickInActionArea_CPSE` action-name/icon child routing | `CLIKMENU.C:529-582` | Action parent command enters pass/action rows or champion action icons depending on action-area state. | `action_area_routes_pc34_compat.c`; invariant checks action parent and child routes. |
