...
| DM Nexus | Active real-data bring-up | Saturn DMDF/DGN data, CUE-owned CDDA and STABG source selection, captured NBG1 palette-bank/origin hardware receipt, world/render/save/mechanics slices and V2 presentation | Source-to-VDP material semantics, native event/audio playback and full playability |
