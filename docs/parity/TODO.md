...
- [x] DM1 V1 runtime SFX event wiring source-locked for door rattle/button/sensor, combat action, and projectile impact/explosion lanes; party footsteps remain unsourced.
