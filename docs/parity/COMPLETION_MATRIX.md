...
| Theron V1 | 57% | 57/100 | `cmd_vm_classified_syscard_catalog_proven` | Original overlay regression, VRAM tile content source tracing, and track-to-dungeon audio mapping remain open. |
