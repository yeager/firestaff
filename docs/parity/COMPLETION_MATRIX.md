...
| Theron V1 | 50% | 50/100 | `disassembly_chain_verified_vdc_semantics_proven` | Audio trigger mapping, original overlay regression, and input command semantics remain open. |
