...
| WUUF-labelled Eye receipt | 2026-09-13 | local evidence | Corrected replay of the authentic PC 3.4 WUUF route with the source Eye hit area validates the held/released transition; the earlier wrong-coordinate attempt is retained only as a rejected diagnostic. No published pixels or local path |
