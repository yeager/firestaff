...
| Labelled Eye candidates | 2026-09-13; rechecked 2026-09-17 | local evidence | Candidate routes retain useful input provenance, but their three-frame observations do not meet the duplicate-safe Eye verifier: held/release frame duplication and insufficient panel deltas prevent promotion. The original source data hashes are valid; the capture observations are not. No published pixels or local path. |
