...
| 9 | Prove DM1 FM Towns audio and input | DM1 FM Towns | BIN/CUE in-memory track selection, CD-audio timing receipts and FM Towns-specific input-route tests. CTest now derives every actual CDDA range from the supplied CUE/BIN, proves representative PCM and track-20 silence; FM Towns-specific input routing remains open. | Partly actionable with supplied media |
