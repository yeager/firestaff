...
| 6 | Build CSB representative visual/audio comparisons | CSB Atari, Amiga, FM Towns | Original HUD, viewport, title, door and audio captures with native comparison gates. The supplied Amiga ADF now has a RAM-only IMG1 receipt across HUD, viewport, pit, stair, ornament and door source families; the FM Towns source ZIP supplies its CUE/IMG, ISO files, all 30 CDDA ranges, and native M11 startup for both language editions directly in RAM. Composed capture comparisons remain blocked. | **Blocked by missing captures** |
