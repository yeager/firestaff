...
| Savegame format (DM1, CSB) | ReDMCSB + dmweb | FIXED for DM1 (`dm1_v1_save_load.c`), PARTIAL for CSB — native Atari `MINI.DAT` is now admitted end-to-end through the regular M12 Continue row and F0435 (`csb_v1_atari_mini_menu_resume_archive`); broader CSBWin/DSA corpus compatibility remains open. |
