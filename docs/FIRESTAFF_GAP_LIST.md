...
25. Screen reader integration. — FIXED 2026-06-27/29: launcher-state manifest covers main view / settings / missing-data popup plus the four cell-by-cell extras views (bestiary, item encyclopedia, screenshot gallery, museum of lore) with stable element IDs (probe PASS 69/69), and M11 gameplay manifest coverage now has a headless probe for gameplay / inventory / map / dialog / entrance mirror / endgame / open chest surfaces. Remaining follow-up is the 14 still-fall-through launcher views (manual-docs / changelog / data-validator / audio-settings / accessibility / theme / save-browser / input-remap / custom-dungeon / campaign / spell-reference / map-viewer / touch-layout / presentation-preview) plus real assistive-technology smoke evidence beyond JSON shape.
