...
| Enhanced lighting/shadows/field/projectile VFX | PARTIAL / OPEN-LARGE — 2026-06-21 audit: `dm1_v2_lighting_dynamic_pc34`, `dm1_v2_lighting_dynamic_source_lock`, `dm1_v2_field_projectile_effect_metadata_pc34`, `dm1_v2_field_projectile_vfx_pc34`, and `dm1_v2_field_projectile_effect_metadata_source_lock` PASS 5/5. These gates cover source-palette lighting mirroring, deterministic fallback, additive light-map math, field/projectile metadata, spell-overlay/particle triggers, fluxcage-field routing, and presentation-only non-mutating boundaries. Remaining: finished enhanced shadows, broader runtime binding into the live M11 frame path, and real screenshot/material pixel gates. |
