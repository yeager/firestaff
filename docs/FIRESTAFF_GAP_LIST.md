...
| Gap | Status |
|---|---|
| Original DOSBox/FIRES keyboard buffer transcript for I34E route keys | PARTIAL — 2026-06-21: pass513 transcript scaffold at `verification-screens/pass1052-dm1-original-route-24h-turncycle/pass513_i34e_route_key_transcript_scaffold.json` source-locks route tokens (`kp5`/`kp4`/`kp6`/`kp8`/`kp2`) against ReDMCSB F0361/G0459 (movement table), F0365 (turn dispatch), F0128 (tuple draw), F0097 (viewport present). pass623/pass625/pass626 now CTest-lock the Firestaff-side readiness bridge plus one source-backed C002 turn-right transcript target row from queue pop through F0365, F0128 redraw tuple, and F0097/VIDRV present. Additional no-runtime handoff gates are CTest-wired: `dm1_v1_original_capture_route_handoff` proves the preflight + row-builder + transcript-writer chain can produce a synthetic transcript accepted by pass608, `dm1_v1_original_capture_live_row_gate` pins live-runner filenames to pass623 labels and Firestaff fixture hashes, and `dm1_v1_capture_runbook_consistency` keeps the runbook aligned with those gates. 3 scaffold rows still lack debugger-observed original runtime fields (partyBefore/After Map/X/Y/Dir, m527WasNonEmpty, f0361QueueSlot, g0433/434 Before/After, g2153 BeforeEnqueue/AfterEnqueue/BeforePop/AfterPop, f0128 Direction/MapX/MapY, f0097Presented, blockedOrNoopReason). True I34E debugger session needed to promote any row to PASS; current scaffold remains SCAFFOLD_ONLY_MISSING_ORIGINAL_RUNTIME_DEBUG_FIELDS. |
