...
| Paired original collision transcript | PARTIAL — 2026-06-21: pass1055 closed-door stasis capture: 3 byte-identical frames (`door_before`, `after_viewport_click`, `after_kp5`) all sha256=`a0d3a9cdbddc310e3ef195c9c7719508a5141fbd66e1acb6a8dbe4b14ebc0dd6` (raw 320x200 + 224x136 viewport crops). Status PASS1055_ORIGINAL_CLOSED_DOOR_STASIS_CAPTURED. Firestaff has matching `firestaff_dm1_v1_pass1055_closed_door_pair_probe` source-locked to ReDMCSB GROUP.C F0202 + MOVESENS.C F0275 + DUNVIEW.C F0128 + DRAWVIEW.C F0097. Remaining work (out of 24h scope): widen collision matrix to non-closed-door walls, party-occupied cells, and diagonal-approach blocked cases. |
