...
| Gap | Source | Status |
|---|---|---|
| IMG1/IMG2 RLE 16-color image decoder | ReDMCSB, sck, DMWeb DM Apple IIGS edition page | FIXED (`image_backend_pc34_compat.c` `IMG3_Compat_ExpandFromSource`); remaining Apple IIGS proof is PO/ProDOS media handoff for 2.0/2.1, not the bounded decoder itself |
