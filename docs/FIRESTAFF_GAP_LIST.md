...
| **Save game writing** | FIXED — 2026-08-01: dm2_v1_save_game_write() implements the skproject DM2_GAME_SAVE_MENU SUPPRESS-encoded save flow: 42-byte header with 0xBEEF/0xDEAD magic, SUPPRESS-encoded game state block, global flags/bytes/words, champion records, and timer entries. Source-locked against c_savegame.cpp:2087. |
