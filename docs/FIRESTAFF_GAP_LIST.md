...
| Full V1/V2 deterministic input scripts + screenshot/pixel gates | OPEN-BOUNDED — 2026-06-21: `dm1_v2_source_route_state_hash_pc34`, `dm1_v2_side_by_side_seed_pc34`, and `dm1_v2_v1_v2_side_by_side_seed_pc34` are now CTest-gated. They cover deterministic source-route hashing, canonical V1/gap/V2 seed layout, full-lane and D1C wall/portrait pixel-region parity, and presentation-disabled V1/V2 viewport parity across N/E/S/W. Remaining gap: real runtime screenshot-script artifacts for enhanced presentation modes. |
