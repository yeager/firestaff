...
| S2D font loader/renderer | PARTIAL — parser and bounded indexed-framebuffer renderer are CTest-gated; full real SCR section decode + runtime text layout/render capture remain open. |
