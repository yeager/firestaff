...
typedef enum TouchPointerSpacePc34Compat {
    ...
    TOUCH_POINTER_SPACE_SCALED_VIEWPORT_PC34_COMPAT = 4,
    TOUCH_POINTER_SPACE_DUNGEON_VIEWPORT_LOCAL_PC34_COMPAT = 5,
    TOUCH_POINTER_SPACE_SCALED_DUNGEON_VIEWPORT_PC34_COMPAT = 6
