...
typedef enum {
    ...
    M12_MENU_ENTRY_CSB_FMTOWNS_UTILITY
} M12_MenuEntryKind;
...
typedef enum {
    M12_STARTUP_SETTINGS_ROW_LANGUAGE = 0,
    M12_STARTUP_SETTINGS_ROW_GRAPHICS = 1,
    M12_STARTUP_SETTINGS_ROW_WINDOW_MODE = 3,
    M12_STARTUP_SETTINGS_ROW_SMOOTH_TURN_PAN = 14,
    M12_STARTUP_SETTINGS_ROW_DATA_DIR = 15,
    M12_STARTUP_SETTINGS_ROW_DATA_STATUS = 16,
    M12_STARTUP_SETTINGS_ROW_AUDIO_MUSIC = 20,
    M12_STARTUP_SETTINGS_ROW_RETROACHIEVEMENTS = 30,
...
typedef struct {
    ...
    int dm1HoCM12CaptureConsumerReady;
    ...
    int dm1HoCHostDrawUsesOwnedReceiptReady;
    ...
    int dm1HoCPresentedCapturePixelsReady;
    ...
    int dm1HoCHostCaptureRoutePackagedReady;
    unsigned int dm1HoCHostCaptureRouteMask;
    unsigned int dm1HoCHostCaptureRouteHash;
    int dm1HoCPresentedCaptureRoutePackagedReady;
...
typedef enum {
    ...
    M12_SETTINGS_TAB_ONLINE,
    M12_SETTINGS_TAB_COUNT
} M12_SettingsTab;

typedef struct M12_StartupMenuState {
    M12_MenuEntry entries[9];
    M12_GameCardArt cardArt[9];
    int selectedIndex;
    ...
    int csbFmtownsUtilityLaunchRequested;
    int activatedIndex;
    M12_MenuView view;
