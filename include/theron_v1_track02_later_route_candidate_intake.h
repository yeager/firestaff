...
int theron_v1_track02_later_route_candidate_intake(const char *trace_row, const char *source_trace_md5, const Theron_V1Track02CampaignMediaDiscoveryReceipt *media, const Theron_V1Track02LoaderTraceReplayConsistencyReceipt *replay, uint32_t layout_epoch, Theron_V1Track02LaterRouteCandidateReceipt *out);
#endif
