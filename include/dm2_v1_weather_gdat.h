...
typedef struct { int valid; uint8_t field; int width; int height; DM2_ImageFormat format; } DM2_V1_WeatherImageMetadata;
...
int dm2_v1_weather_gdat_image_metadata(const DM2_V1_AssetLoader *loader, uint8_t field, DM2_V1_WeatherImageMetadata *out);
#endif
