...
int dm2_v1_weather_gdat_overlay_plan(const DM2_V1_WeatherGdatReceipt *receipt,
                                     uint8_t cloud_level, uint8_t rain_level,
                                     DM2_V1_WeatherOverlayPlan *out);
int dm2_v1_weather_gdat_draw_plan(const DM2_V1_WeatherCommandReceipt *command,
                                  const DM2_V1_WeatherDrawContext *context,
                                  DM2_V1_WeatherDrawPlan *out);
int dm2_v1_weather_gdat_destination_clip(const uint8_t *rect_table,
