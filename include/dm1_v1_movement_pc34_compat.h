...
typedef struct {
    ...
    int16_t  step_cost;                /* caller-supplied F0310 result; 0 = unavailable */
 ...
 */
/* Set movement step cost from ReDMCSB CHAMPION.C F0310. Non-positive
 * values clear timing; movement then remains fail-closed. */
...
} DM1_V1_MovementOrchestratorRoutePlanPc34Compat;
