/*
 * dm2_v22_shape_cache_pc34.h
 *
 * DM2 V2.2 GPU render path: minimal per-cell V22 cache.
 *
 * DM2 does not yet have a full V22 shape book (csb_v22_shapes.h /
 ...
 *
 * This is intentionally a minimal scaffold. A full DM2 V22 shape
 * book (parallel to dm1_v22_shapes.h / dm2_v22_shapes.h / theron_v22_shapes.h)
 ...
 *
 * Source-lock: dm2_v22_modern_assets_pc34.c (sibling asset module),
 * include/dm2_v22_modern_assets_pc34.h (asset discovery + path),
 * include/dm2_v1_weather.c (raw cell type source).
 */

#ifndef FIRESTAFF_DM2_V22_SHAPE_CACHE_PC34_H
#define FIRESTAFF_DM2_V22_SHAPE_CACHE_PC34_H
...
/* Cell rectangle on the DM2 4x3 viewport (indoor T560 + outdoor T600) (1920x1080).
...
extern const DM2_V22_CellRect dm2_v22_kCellRects[3][3];
...
const Dm2_V22_ShapeRuntimeResult* dm2_v22_shape_cache_get(int depth,
                                                              int lateral);
...
#endif /* FIRESTAFF_DM2_V22_SHAPE_CACHE_PC34_H */
