 ...
 * then walks every map through READ_SKSAVE_DUNGEON. The temporary owner is
 * always discarded: this is evidence for the next possession-chain phase,
 * never a partial Resume session. */
