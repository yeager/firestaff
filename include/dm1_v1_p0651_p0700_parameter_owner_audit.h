#ifndef FIRESTAFF_DM1_V1_P0651_P0700_PARAMETER_OWNER_AUDIT_H
#define FIRESTAFF_DM1_V1_P0651_P0700_PARAMETER_OWNER_AUDIT_H

#include <stddef.h>
#include <stdint.h>

typedef struct DM1_V1_P0651P0700ParameterOwnerAudit {
    uint16_t parameter_number;
    uint16_t owner_function;
    const char *source_anchor;
    int standalone_port_forbidden;
} DM1_V1_P0651P0700ParameterOwnerAudit;
...
#endif /* FIRESTAFF_DM1_V1_P0651_P0700_PARAMETER_OWNER_AUDIT_H */
