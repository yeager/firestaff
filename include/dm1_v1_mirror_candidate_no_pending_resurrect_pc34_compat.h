...
typedef enum DM1_V1_MirrorCandidateNoPendingResurrectStepIdPc34Compat {
...
} DM1_V1_MirrorCandidateNoPendingResurrectStepIdPc34Compat;

typedef struct DM1_V1_MirrorCandidateNoPendingResurrectStepPc34Compat {
    DM1_V1_MirrorCandidateNoPendingResurrectStepIdPc34Compat id;
    const char *name;
    const char *redmcsb_anchor;
    const char *assertion;
} DM1_V1_MirrorCandidateNoPendingResurrectStepPc34Compat;

typedef struct DM1_V1_MirrorCandidateNoPendingResurrectContractPc34Compat {
    int contract_only;
...
} DM1_V1_MirrorCandidateNoPendingResurrectContractPc34Compat;

typedef enum DM1_V1_MirrorCandidateNoPendingResurrectStepIdPc34Compat
    Dm1V1MirrorCandidateNoPendingResurrectStepIdPc34Compat;
typedef DM1_V1_MirrorCandidateNoPendingResurrectStepPc34Compat
    Dm1V1MirrorCandidateNoPendingResurrectStepPc34Compat;
typedef DM1_V1_MirrorCandidateNoPendingResurrectContractPc34Compat
