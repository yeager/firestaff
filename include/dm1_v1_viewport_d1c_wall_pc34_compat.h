#ifndef FIRESTAFF_DM1_V1_VIEWPORT_D1C_WALL_PC34_COMPAT_H
#define FIRESTAFF_DM1_V1_VIEWPORT_D1C_WALL_PC34_COMPAT_H
...
typedef enum {
    DM1_V1_D1C_WALL_ROUTE_NATIVE_PC34 = 0,
    DM1_V1_D1C_WALL_ROUTE_FLIPPED_PC34 = 1
} DM1_V1_D1CWallRoutePc34;
...
typedef struct {
    ...
    int wall_index_pc34;
    int wall_zone_pc34;
    int native_wall_bitmap_index;
    int flipped_wall_bitmap_index;
    int view_wall_d1c_front_index;
    int frame_index;
    ...
    int visible_width;
    int visible_height;
    bool uses_f0100_wallset_c10_transparent_blit;
    bool uses_f0076_flipped_wall_footprints_bitmap;
    bool uses_f0104_pc34_native_zone_route;
    bool uses_f0765_pc34_opaque_center_path;
    bool uses_f0792_pc34_third_party_path;
    ...
    bool flipped_route_draws_in_alcove_thing_pass;
    const char *view_square_symbol;
    const char *wall_bitmap_symbol;
    const char *flipped_wall_bitmap_symbol;
    const char *wall_zone_symbol;
    const char *view_wall_symbol;
    const char *source_lines;
    const char *non_overlap_note;
} DM1_V1_D1CWallSpecPc34;
...
typedef struct {
    ...
    uint8_t pixel_after;
} DM1_V1_D1CWallPixelResultPc34;

#define DM1_V1_D1C_WALL_VIEWPORT_WIDTH_PC34 224
#define DM1_V1_D1C_WALL_VIEWPORT_HEIGHT_PC34 136
#define DM1_V1_D1C_WALL_SOURCE_WIDTH_PC34 128
#define DM1_V1_D1C_WALL_SOURCE_HEIGHT_PC34 111
#define DM1_V1_D1C_WALL_C10_COLOR_FLESH_PC34 10
...
#endif /* FIRESTAFF_DM1_V1_VIEWPORT_D1C_WALL_PC34_COMPAT_H */
