#ifndef FIRESTAFF_DM1_V1_PRINT_TEXT_MASKS2_PC34_COMPAT_H
#define FIRESTAFF_DM1_V1_PRINT_TEXT_MASKS2_PC34_COMPAT_H

/*
 * ReDMCSB source-lock pin for Graphics.dat item 562 init var
 * G0064_al_Graphic562_PrintTextMasks2[4].
 *
 * G0064 is the 4-entry 32-bit text-print mask table used by
...
#define DM1_V1_PRINT_TEXT_MASKS2_PC34_COMPAT_SIZE 4

typedef struct DM1_V1_PRINT_TEXT_MASKS2ResultPc34 {
    int accepted;
    int assertionCount;
    int tableEntries[DM1_V1_PRINT_TEXT_MASKS2_PC34_COMPAT_SIZE];
    int tableSize;
    int tableMatchesDeclaration;
    int lookupFunctionCorrect;
    int lookupOutOfRangeReturnsZero;
} DM1_V1_PRINT_TEXT_MASKS2ResultPc34;
