#ifndef FIRESTAFF_DM1_V1_MIRROR_CANDIDATE_C040_SPELL_AREA_CLICK_WHILE_PANEL_LIVE_PC34_COMPAT_H
#define FIRESTAFF_DM1_V1_MIRROR_CANDIDATE_C040_SPELL_AREA_CLICK_WHILE_PANEL_LIVE_PC34_COMPAT_H

typedef struct DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveStatePc34 {
    int contractOnly;
    int command;
    ...
    int rejectedNoCasterCount;
} DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveStatePc34;

typedef struct DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveResultPc34 {
    int accepted;
    int assertionCount;
    int partyCountBefore;
    int magicCasterBefore;
    ...
    int magicCasterAfterClear;
    int f0282Dispatched;
    int f0370CallsWhileLive;
    int f0370CallsAfterClear;
    int f0370CallsAfterCasterDrop;
    int rejectedWhileLive;
    int rejectedNoCaster;
} DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveResultPc34;

typedef struct DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveSpecPc34 {
    const char *sourceEvidence;
    const char *nonOverlap;
    const char *f0380Anchor;
    const char *f0370Anchor;
    ...
    int spellAreaClick;
} DM1_V1_MirrorCandidateC040SpellAreaClickWhilePanelLiveSpecPc34;
