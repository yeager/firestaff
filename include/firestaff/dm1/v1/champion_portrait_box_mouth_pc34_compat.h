 ...
 * G0048_ai_Graphic562_Box_Mouth[4].
 *
 * G0048 is the {X, Y, W, H} pixel-coordinate rectangle used by
 * CHAMDRAW.C to blit the champion-portrait mouth graphic on top of
 * the portrait area (when the champion is mid-action / mid-talk).
 * PC 3.4 init (DATA.C:423 + DATA.C:1095): { 55, 72, 12, 29 }.
 *
 * Read site:
 * - CHAMDRAW.C:914 F0294_CHAMPION_DrawChampionPortraitMouth — blit
 *   the mouth graphic into G0048's box with byte width C016_BYTE_WIDTH
...
typedef struct DM1_V1_ChampionPortraitBoxMouthResultPc34 {
    int accepted;
    int assertionCount;
    int tableEntries[4];
...
int
dm1_v1_champion_portrait_box_mouth_x_pc34(void);

int
dm1_v1_champion_portrait_box_mouth_y_pc34(void);

int
dm1_v1_champion_portrait_box_mouth_w_pc34(void);

int
dm1_v1_champion_portrait_box_mouth_h_pc34(void);
