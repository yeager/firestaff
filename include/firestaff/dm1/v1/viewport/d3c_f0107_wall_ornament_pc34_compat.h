#ifndef FIRESTAFF_DM1_V1_VIEWPORT_D3C_F0107_WALL_ORNAMENT_PC34_COMPAT_H
#define FIRESTAFF_DM1_V1_VIEWPORT_D3C_F0107_WALL_ORNAMENT_PC34_COMPAT_H
...
#define DM1_V1_D3C_F0107_FRAMEBUFFER_WIDTH_PC34 320
#define DM1_V1_D3C_F0107_FRAMEBUFFER_HEIGHT_PC34 200
#define DM1_V1_D3C_F0107_VIEWPORT_WIDTH_PC34 224
#define DM1_V1_D3C_F0107_VIEWPORT_HEIGHT_PC34 136
#define DM1_V1_D3C_F0107_C10_COLOR_FLESH_PC34 10
#define DM1_V1_D3C_F0107_ORDINAL_COUNT_PC34 6
#define DM1_V1_D3C_F0107_STEP_COUNT_PC34 8
#define DM1_V1_D3C_F0107_REJECTED_CONTRACT_COUNT_PC34 7

typedef enum {
    DM1_V1_D3C_F0107_STEP_F0128_D3L_DISPATCH_PC34 = 0,
    DM1_V1_D3C_F0107_STEP_F0128_D3R_DISPATCH_PC34,
    DM1_V1_D3C_F0107_STEP_F0128_D3C_DISPATCH_PC34,
    DM1_V1_D3C_F0107_STEP_F0118_D3C_BODY_PC34,
    DM1_V1_D3C_F0107_STEP_WALL_BODY_PC34,
    DM1_V1_D3C_F0107_STEP_F0107_FRONT_WALL_ORNAMENT_PC34,
    DM1_V1_D3C_F0107_STEP_F0108_KEEP_OUT_PC34,
    DM1_V1_D3C_F0107_STEP_SYNTHETIC_FRAMEBUFFER_PC34
} DM1_V1_D3CF0107StepKindPc34;

typedef struct {
    DM1_V1_D3CF0107StepKindPc34 step;
    int order_index;
    int expected_present;
    const char *name;
    const char *redmcsb_anchor;
} DM1_V1_D3CF0107StepPc34;
...
typedef struct {
    ...
    int reaches_d3c_f0107;
    const char *name;
    const char *redmcsb_anchor;
} DM1_V1_D3CF0107OrdinalPc34;
...
typedef struct {
    ...
    int wall_zone_first;
    int wall_zone_second;
    int view_wall_first;
    int view_wall_second;
    int x;
    int y;
    int width;
    int height;
    const char *redmcsb_anchor;
} DM1_V1_D3CF0107RejectedContractPc34;
...
typedef struct {
    ...
    int requested_wall_zone_note_is_mismatch;
    int f0128_d3l_draw_line;
    int f0128_d3r_draw_line;
    int f0128_d3c_draw_line;
    int f0128_after_d3l_d3r;
    int f0128_before_d2;
    ...
    int only_m552_reaches_d3c;
    int wall_ornament_zone_base;
    int wall_ornament_zone_stride;
    int wall_ornament_coordinate_set;
    int wall_ornament_zone_d3c_front;
    int source_locked_contract_only;
    int no_original_dos_pixel_parity;
    int no_graphics_dat_reads;
    DM1_V1_D3CF0107StepPc34 steps[DM1_V1_D3C_F0107_STEP_COUNT_PC34];
    DM1_V1_D3CF0107OrdinalPc34 ordinals[DM1_V1_D3C_F0107_ORDINAL_COUNT_PC34];
    DM1_V1_D3CF0107RejectedContractPc34 rejected[DM1_V1_D3C_F0107_REJECTED_CONTRACT_COUNT_PC34];
    DM1_V1_D3CF0107PixelPc34 pixels[DM1_V1_D3C_F0107_ORDINAL_COUNT_PC34];
    uint32_t deterministic_hash;
    const char *source_evidence;
    const char *disjointness_note;
} DM1_V1_D3CF0107WallOrnamentModelPc34;

typedef struct {
    int writes;
    int transparent_skips;
    int touched_pixels;
    int d3c_probe_overlaps_rejected_contract;
    int rejected_contract_pixels_changed;
    uint32_t framebuffer_hash;
} DM1_V1_D3CF0107FramebufferProbePc34;
