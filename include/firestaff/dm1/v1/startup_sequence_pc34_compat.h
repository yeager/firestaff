...
typedef struct DM1_V1_StartupSaveResumeCaptureFacts_PC34 {
    ...
    int observed_user_save_corpus_runtime_adopt_attempted;
    int observed_user_save_corpus_runtime_adopt_succeeded;
    int observed_user_save_corpus_runtime_adopt_failed;
...
typedef struct DM1_V1_StartupSaveResumeCaptureReceipt_PC34 {
    ...
    int user_save_corpus_runtime_adopt_attempted;
    int user_save_corpus_runtime_adopt_succeeded;
    int user_save_corpus_runtime_adopt_failed;
...
typedef struct DM1_V1_CompleteSupportReceipt_PC34 {
    ...
    int user_save_corpus_runtime_ready;
    int user_save_corpus_roundtrip_verified;
    int user_save_corpus_roundtrip_failed;
    unsigned int user_save_corpus_roundtrip_hash;
    int user_save_corpus_runtime_adopt_attempted;
