#ifndef FIRESTAFF_DM1_V1_G0486_PC34_COMPAT_H
#define FIRESTAFF_DM1_V1_G0486_PC34_COMPAT_H

/*
 * ReDMCSB source-lock pin for Graphics.dat item 560 init var
 * G0486_auc_Graphic560_...[6] (PC 3.4 EN init).
 *
 * G0486 is the uint8_t[6] for the symbol mana cost multiplier action/spell table.
 *
 * Disjoint from pass784+ non-mirror-candidate contract gates.
 * Disjoint from pass784-896.
 */

#define DM1_V1_G0486_PC34_COMPAT_SIZE 6

typedef struct DM1_V1_G0486ResultPc34 {
    int accepted;
    int assertionCount;
    int tableEntries[DM1_V1_G0486_PC34_COMPAT_SIZE];
    int tableSize;
    int tableMatchesDeclaration;
    int allInByteRange;
    int lookupFunctionCorrect;
    int lookupOutOfRangeReturnsMinusOne;
} DM1_V1_G0486ResultPc34;
