...
#define CHAMPION_SLOT_BACKPACK_9 21
#define CHAMPION_SLOT_BACKPACK_10 22
#define CHAMPION_SLOT_BACKPACK_11 23
#define CHAMPION_SLOT_BACKPACK_12 24
#define CHAMPION_SLOT_BACKPACK_13 25
#define CHAMPION_SLOT_BACKPACK_14 26
#define CHAMPION_SLOT_BACKPACK_15 27
#define CHAMPION_SLOT_BACKPACK_16 28
#define CHAMPION_SLOT_BACKPACK_17 29
#define CHAMPION_SLOT_ACTION_HAND CHAMPION_SLOT_HAND_RIGHT
...
struct PartyState_Compat {
    ...
    /* ReDMCSB LOADSAVE.C F0433/F0435 copies all four M516_CHAMPIONS
     * records even when PartyChampionCount is smaller. These opaque source
     * records preserve inactive slots for a PC34 export; they never make an
     * inactive champion live or enter Firestaff's native save format. */
