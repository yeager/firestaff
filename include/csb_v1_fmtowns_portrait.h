 ...
 * 464 bytes of 4bpp packed pixel data (32x29 portrait).
 *
 * Header layout:
 ...
 *   44-507: 4bpp packed pixels (32x29 = 928 pixels, 464 bytes)
 *
 * Pixel layout: high nibble first, row-major, 32 pixels per row.
 */
...
/* Decode a .CMP portrait to indexed 4bpp pixels (one byte per pixel).
 * indexed_pixels must have capacity for at least 928 bytes.
