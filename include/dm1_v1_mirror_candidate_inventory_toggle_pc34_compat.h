...
typedef enum DM1_V1_MirrorCandidateInventoryToggleRoutePc34Compat {
...
} DM1_V1_MirrorCandidateInventoryToggleRoutePc34Compat;

typedef struct DM1_V1_MirrorCandidateInventoryToggleInputPc34Compat {
    int command;
    unsigned int candidate_champion_ordinal;
    unsigned int party_champion_count;
    int current_inventory_champion_ordinal;
} DM1_V1_MirrorCandidateInventoryToggleInputPc34Compat;

typedef struct DM1_V1_MirrorCandidateInventoryToggleEvidencePc34Compat {
...
} DM1_V1_MirrorCandidateInventoryToggleEvidencePc34Compat;

typedef struct DM1_V1_MirrorCandidateInventoryToggleOutputPc34Compat {
    int should_dispatch_toggle;
    int target_champion_index;
    DM1_V1_MirrorCandidateInventoryToggleRoutePc34Compat route_taken;
    const DM1_V1_MirrorCandidateInventoryToggleEvidencePc34Compat *evidence;
    ...
    int contract_only;
} DM1_V1_MirrorCandidateInventoryToggleOutputPc34Compat;

typedef DM1_V1_MirrorCandidateInventoryToggleRoutePc34Compat
    Dm1V1MirrorCandidateInventoryToggleRoutePc34Compat;
typedef DM1_V1_MirrorCandidateInventoryToggleInputPc34Compat
    Dm1V1MirrorCandidateInventoryToggleInputPc34Compat;
typedef DM1_V1_MirrorCandidateInventoryToggleEvidencePc34Compat
    Dm1V1MirrorCandidateInventoryToggleEvidencePc34Compat;
typedef DM1_V1_MirrorCandidateInventoryToggleOutputPc34Compat
