...
typedef struct {
    ...
    uint64_t startup_bitmap_title_first_raw_offset;
    uint64_t startup_bitmap_title_last_raw_offset;
    uint64_t startup_bitmap_title_first_user_data_offset;
    uint64_t startup_bitmap_title_last_user_data_offset;
    uint64_t startup_bitmap_stage_first_raw_offset;
    uint64_t startup_bitmap_stage_last_raw_offset;
    uint64_t startup_bitmap_stage_first_user_data_offset;
    uint64_t startup_bitmap_stage_last_user_data_offset;
    uint64_t startup_bitmap_soul_room_first_raw_offset;
    uint64_t startup_bitmap_soul_room_last_raw_offset;
    uint64_t startup_bitmap_soul_room_first_user_data_offset;
    uint64_t startup_bitmap_soul_room_last_user_data_offset;
    uint64_t startup_bitmap_forcefield_first_raw_offset;
    uint64_t startup_bitmap_forcefield_last_raw_offset;
    uint64_t startup_bitmap_forcefield_first_user_data_offset;
    uint64_t startup_bitmap_forcefield_last_user_data_offset;
    uint32_t startup_bitmap_wide_route_mask;
    uint32_t startup_bitmap_wide_route_count;
    uint32_t startup_bitmap_wide_atlas_tile_count;
    uint32_t startup_bitmap_raw_route_mask;
    uint32_t startup_bitmap_raw_route_count;
    uint32_t startup_bitmap_raw_atlas_tile_count;
    uint32_t startup_bitmap_iso_route_mask;
    uint32_t startup_bitmap_iso_route_count;
    uint32_t startup_bitmap_iso_atlas_tile_count;
