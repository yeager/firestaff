/*
 * v1_swsh_intro_pathfinder_pc34_compat.h
 *
 * DM1/CSB V1 SWSH/FTL logo path finder for the runtime launcher handoff.
 *
 ...
 * the narrow path the older host-local search checked.
 *
 * Search order (mirrors the TITLE finder so the FTL and
...
#define FIRESTAFF_V1_SWSH_INTRO_PATHFINDER_PC34_COMPAT_H
 ...
 * branch is what makes the release path robust: the original
...
#endif /* FIRESTAFF_V1_SWSH_INTRO_PATHFINDER_PC34_COMPAT_H */
