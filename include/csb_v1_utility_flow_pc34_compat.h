...
typedef enum {
    ...
    CSB_V1_UTIL_INPUT_RESULT_PANEL_CONSUMED = 4
} CSB_V1_UtilInputResultKind;

typedef enum {
    CSB_V1_UTIL_ACTION_PLAN_IGNORE = 0,
    CSB_V1_UTIL_ACTION_PLAN_ENTRANCE_COMMAND = 1,
    CSB_V1_UTIL_ACTION_PLAN_STATUS_REDRAW = 2,
    CSB_V1_UTIL_ACTION_PLAN_IMPORT_READY =
        CSB_V1_UTIL_ACTION_PLAN_STATUS_REDRAW,
    CSB_V1_UTIL_ACTION_PLAN_VIEW_READY =
        CSB_V1_UTIL_ACTION_PLAN_STATUS_REDRAW
