...
static const TouchClickZonePc34Compat kTouchClickZones[] = {
    ...
    { 28u, 507u, TOUCH_CLICK_COORD_VIEWPORT_RELATIVE_PC34_COMPAT, TOUCH_CLICK_BUTTON_LEFT_PC34_COMPAT,    6,  53,  16,  16, "inventory.ready_hand",   "COMMAND.C:419 maps C028 to C507 inventory ready hand; layout-696 C105/C507 gives viewport-local slot" },
    { 29u, 508u, TOUCH_CLICK_COORD_VIEWPORT_RELATIVE_PC34_COMPAT, TOUCH_CLICK_BUTTON_LEFT_PC34_COMPAT,   62,  53,  16,  16, "inventory.action_hand",  "COMMAND.C:420 maps C029 to C508 inventory action hand; layout-696 C105/C508 gives viewport-local slot" },
