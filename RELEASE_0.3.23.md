...
### Bug Fix
- **Fix phantom alcove item sprites in viewport.** WALL-square items (champion alcove armour/weapons) no longer render as floor sprites in the 3D dungeon viewport in the legacy Hall-route fixture. Correction 2026-05-14: this is not evidence that ordinary DM1 launch starts in Hall of Champions.
