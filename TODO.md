...
- 🔧 CSB launch entry in menu — g_entryTemplate has CSB entry (gameId "csb"), m12_game_supported() filters launch with "RUNTIME NOT READY" message; **remaining**: CSB V1 runtime handoff (Phase 1+ of CSB V1)
