...
- 🔧 Viewport rendering hardening: broad wall/floor/ceiling/door/ornament/pit/stair/source routes are source-locked, and D2C/D2L, D1C/D1R, D0L, and D0L/D0R parity pixels now have concrete gates; remaining work is broader pixel-polish evidence (D2L2/D2R2, D3L2/D3R2) and capture-backed bug closure.
...
- 🔧 Phase 3 - Rendering parity hardening: D3/D2 wall tables, bitmap selection, grid routing, CSB-only D3L2/D3R2 and D2L2/D2R2 draw-order/frame gates, F0107 back-wall ornament routing, F0108/F0111 route gates, F0108 floor-blit metadata gates, F0111 door panel zone/clip gates, and initial viewport gates exist; remaining work includes actual ornament blits, F0115 creature/item/projectile pass, F0111 runtime door panel bitmap blits, and `CustomBackgrounds`.
