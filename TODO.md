...
- 🔧 Item identification — potion eye-panel power-prefix display and M11 leader-hand runtime wiring are source-locked for Priest > 1, including the original empty-flask quirk; weapon eye-panel name/attribute description formatting is source-locked for POISONED/BROKEN/CURSED (94094865); item weight line display is source-locked (35461e0b); armor BROKEN/CURSED, junk consumable/compass/waterskin state lines, scroll/container panel routes, and object-description panel layout (440eaca1) and M11 item eye object-description runtime rendering in source layout (48a05966) are source-locked; remaining item-identification polish is framebuffer/pixel parity and any non-description render integration
