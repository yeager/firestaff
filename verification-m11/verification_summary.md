...
PASS INV_GV_434A DM1 C080 viewport route includes the source C007 top-left edge
PASS INV_GV_434B DM1 C080 viewport route includes the source C007 bottom-right edge
PASS INV_GV_434C DM1 C080 viewport route stops outside C007 and does not leak into adjacent screen space
...
PASS INV_GV_407A0 non-portrait C007 viewport click follows C080 source routing and does not use Firestaff procedural turn shortcuts or open the mirror panel
PASS INV_GV_407A source portrait click center x111/y82 opens the mirror candidate panel when a mirror TextString is in the front cell
PASS INV_GV_407B source C160 resurrect center x130/y115 confirms the open mirror candidate panel
PASS INV_GV_407C source C161 reincarnate center x186/y115 confirms the open mirror candidate panel
...
PASS INV_GV_13 escape opens the source-style return confirmation and YES returns to the launcher
...
PASS INV_GV_13D debug sidebar save button writes a live quicksave without leaving the viewport
PASS INV_GV_13E sidebar load button restores the last live quicksave in-place
PASS INV_GV_13F debug sidebar menu header opens return confirmation and YES returns control to the launcher
...
PASS INV_GV_15P V1 status shield top border follows F0292 reverse draw stack (fire topmost)
PASS INV_GV_15P2 V1 status shield border stack draws party, spell, then fire like F0292 while-count order
...
PASS INV_GV_38AI focused viewport: D1L side-cell fireball explosion changes the corridor frame
PASS INV_GV_38AJ focused viewport: D1L side-cell fireball explosion clips inside the DM1 viewport rectangle
...
PASS INV_GV_114C2B relative viewport cells source-map through ReDMCSB F0115 G2028 rows
PASS INV_GV_114C2C floor ornament placement locks ReDMCSB G0206 set-0 zones/increments and excludes D3 far slivers
PASS INV_GV_114C3 object placement binds C2500 layout-696 source zone samples
PASS INV_GV_114C4 object raw C2500 rows 5..16 expose the full layout-696 side/deep source family
...
PASS INV_GV_362C V1 inventory leader-hand placement honors source AllowedSlots before slot mutation
...
PASS INV_GV_245G projectile raw C2900 rows 5..11 expose the full layout-696 side/deep source family
