...
static void test_ccm_constants(void)
{
    ...
    /* 2026-07-19 DM2-005 follow-up: source-aligned b_1a values
     * (skproject/SKULLWIN/c_creature.cpp:2930-3212 DM2_PROCEED_CCM). */
    PROBE_ASSERT(DM2_CCM_WALK_NOW == 0x01, "DM2_CCM_WALK_NOW == 0x01");
    PROBE_ASSERT(DM2_CCM_WALK_CONT == 0x02, "DM2_CCM_WALK_CONT == 0x02");
    PROBE_ASSERT(DM2_CCM_CCM03 == 0x03, "DM2_CCM_CCM03 == 0x03");
    PROBE_ASSERT(DM2_CCM_JUMPS == 0x05, "DM2_CCM_JUMPS == 0x05");
    PROBE_ASSERT(DM2_CCM_CCM06 == 0x06, "DM2_CCM_CCM06 == 0x06");
    PROBE_ASSERT(DM2_CCM_CREATURE_ATTACKS_PARTY == 0x08, "DM2_CCM_CREATURE_ATTACKS_PARTY == 0x08");
    PROBE_ASSERT(DM2_CCM_STEAL_FROM_CHAMPION == 0x0a, "DM2_CCM_STEAL_FROM_CHAMPION == 0x0a");
    PROBE_ASSERT(DM2_CCM_SHOOT_ITEM == 0x0e, "DM2_CCM_SHOOT_ITEM == 0x0e");
    PROBE_ASSERT(DM2_CCM_KILL_ON_TIMER_POS == 0x13, "DM2_CCM_KILL_ON_TIMER_POS == 0x13");
    PROBE_ASSERT(DM2_CCM_ROTATES_TARGET == 0x15, "DM2_CCM_ROTATES_TARGET == 0x15");
    PROBE_ASSERT(DM2_CCM_PLACE_MERCHANDISE == 0x17, "DM2_CCM_PLACE_MERCHANDISE == 0x17");
    PROBE_ASSERT(DM2_CCM_TAKE_MERCHANDISE == 0x18, "DM2_CCM_TAKE_MERCHANDISE == 0x18");
    PROBE_ASSERT(DM2_CCM_PUTS_DOWN_ITEM == 0x19, "DM2_CCM_PUTS_DOWN_ITEM == 0x19");
    PROBE_ASSERT(DM2_CCM_TAKES_ITEM == 0x1a, "DM2_CCM_TAKES_ITEM == 0x1a");
    PROBE_ASSERT(DM2_CCM_CAST_SPELL == 0x27, "DM2_CCM_CAST_SPELL == 0x27");
    PROBE_ASSERT(DM2_CCM_EXPLODE_OR_SUMMON == 0x3d, "DM2_CCM_EXPLODE_OR_SUMMON == 0x3d");
}
