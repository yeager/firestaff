...
append_trace_receipts() {
  ...
  for trace_var in \
    ...
    FIRESTAFF_NEXUS_TRACE_SH2_RAM_SOURCE_WRITES \
    FIRESTAFF_NEXUS_TRACE_CD_FIFO_WORDS; do
  ...
  for trace_var in \
    ...
    FIRESTAFF_NEXUS_TRACE_SH2_CACHED_RAM_READS \
    FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READS; do
    trace_path="${!trace_var:-}"
    if [[ -n "$trace_path" && -s "$trace_path" ]] &&
       ! grep -q "^${trace_var}_sha256=" "$manifest"; then
      printf '%s_sha256=%s\n' "$trace_var" \
...
launch_capture_process() {
  # The trace settings are assigned on the shell-function invocation below.
  # Bash makes them visible inside this function but does not reliably retain
  # their export attribute across the external setsid/python session wrapper.
  # Export every bounded Nexus capture setting before exec so the producer
  # observes the same filters on Linux and macOS.
  export "${!FIRESTAFF_NEXUS_@}"
...
if [[ -n "$mednafen_home" ]]; then
  ...
  FIRESTAFF_NEXUS_TRACE_INPUT_EVENTS="${FIRESTAFF_NEXUS_TRACE_INPUT_EVENTS:-}" \
  FIRESTAFF_NEXUS_TRACE_RENDER_DIR="${FIRESTAFF_NEXUS_TRACE_RENDER_DIR:-}" \
  FIRESTAFF_NEXUS_TRACE_RENDER_FRAMES="${FIRESTAFF_NEXUS_TRACE_RENDER_FRAMES:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REGS="${FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REGS:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REG_AT="${FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REG_AT:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REG_PC="${FIRESTAFF_NEXUS_TRACE_VDP1_WRITER_REG_PC:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITE_FRAME_MIN="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITE_FRAME_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITE_FRAME_MAX="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITE_FRAME_MAX:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE_FRAME_MIN="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE_FRAME_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE_FRAME_MAX="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_CODE_FRAME_MAX:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_FRAME_MIN="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_FRAME_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_FRAME_MAX="${FIRESTAFF_NEXUS_TRACE_VDP2_WRITER_FRAME_MAX:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_SOURCE_LBA_MIN="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_SOURCE_LBA_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_SOURCE_LBA_MAX="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_SOURCE_LBA_MAX:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_CD_FIFO_WORDS="${FIRESTAFF_NEXUS_TRACE_CD_FIFO_WORDS:-}" \
  FIRESTAFF_NEXUS_TRACE_CD_FIFO_WORD_LIMIT="${FIRESTAFF_NEXUS_TRACE_CD_FIFO_WORD_LIMIT:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READS="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READS:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_CACHED_RAM_READS="${FIRESTAFF_NEXUS_TRACE_SH2_CACHED_RAM_READS:-}" \
  ...
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC_MIN="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC_MAX="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_PC_MAX:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_FRAME_MIN="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_FRAME_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_FRAME_MAX="${FIRESTAFF_NEXUS_TRACE_SH2_RAM_READ_FRAME_MAX:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READS="${FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READS:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_BYTE_READ_REGISTER="${FIRESTAFF_NEXUS_TRACE_SH2_BYTE_READ_REGISTER:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READ_FRAME_MIN="${FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READ_FRAME_MIN:-}" \
  FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READ_FRAME_MAX="${FIRESTAFF_NEXUS_TRACE_SH2_INSTRUCTION_BYTE_READ_FRAME_MAX:-}" \
