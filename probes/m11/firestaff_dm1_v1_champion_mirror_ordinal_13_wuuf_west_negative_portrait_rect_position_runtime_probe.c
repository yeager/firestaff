 ...
 * PC34 C127 layout: ordinal 13 = (7,17)N).  The
...
static void check_positive_cross_check(M11_GameViewState* state,
    ...
    printf("\n[Group D] (7, 16) DIR_SOUTH cross-check — D1C cutout IS painted with ordinal %d (WUUF)\n",
    ...
    pctTarget = match_portrait_cell(portraits, fb, 10 /* ZED, the
                                     (7,13) SOUTH-route ordinal */);
    snprintf(msg, sizeof(msg),
             "(7,16) S D1C cutout does NOT match ordinal 10 (ZED) < %d%%%% "
