 ...
 * shipped with the public PC 3.4 English release (verified C127 map0
 * layout, DONE.md 2026-07-18: ordinal 1 at (7,8) south face): at
 * (7,9) facing NORTH, the front square (7,8) carries the C127 sensor
 * with sensorData=1 (HALK, mirror ordinal 1).  After
