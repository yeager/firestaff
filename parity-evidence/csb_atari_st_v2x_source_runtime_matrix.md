...
| --- | --- | ---: | --- | --- |
| Atari archive | `<firestaff-original-games>/Game,Chaos_Strikes_Back,Atari_ST,Software.7z` | 1669479 | `ce6e638622a099bbf15e6dacd7750ce811a52373a20b2d0f92ef6332cc47d7f5` | present |
| v2.0 game disk image | `<firestaff-original-games>/_extracted/csb-atari/Floppy Disks MSA/Chaos Strikes Back for Atari ST Game Disk v2.0 (English).msa` | 404254 | `e3d8dc75956ade33658b700e9ae2512dcef7a8dfa538116b8a717f4efaefe0b4` | present |
...
| v2.1 game disk image | `<firestaff-original-games>/_extracted/csb-atari/Floppy Disks STX/Chaos Strikes Back for Atari ST Game Disk v2.1 (English).stx` | 941828 | `aea724d663554e84393a77c45c010753c5bfb1a3a5a83d1264b5ef2af9aa5c6f` | present, not yet root-member parsed by verifier |
| Atari hard-disk candidate `GRAPHICS.DAT` | `<firestaff-original-games>/_canonical/csb/atari-GRAPHICS.DAT` | 319080 | `33f672bf644763411cc465e3553e0605de77e6128070dbd27868813e2a21d9af` | reference only; differs from v2.0 game-disk member |
| Atari hard-disk candidate `DUNGEON.DAT` | `<firestaff-original-games>/_canonical/csb/atari-DUNGEON.DAT` | 2098 | `3cafd2fb9f255df93e99ae27d4bf60ff22cc8e43cfa90de7d29c04172b2542ba` | reference only; matches Amiga canonical dungeon candidate |
| Amiga `Graphics.DAT` blocker | `<firestaff-original-games>/_canonical/csb/amiga-Graphics.DAT` | 435076 | `3af5396fa32af08af5e0581a6cdf5b30c8397834efa5b9e0c8c991219d256942` | explicit non-target lineage |
...
- `python3 tools/validate_csb_dm2_source_lock.py --root <firestaff-data>/firestaff-original-games/DM --markdown-out /tmp/csb_dm2_report.md --json-out /tmp/csb_dm2_report.json`
- `python3 scripts/verify_csb_dm2_source_lock_boundaries.py --repo <firestaff-repo> --redmcsb-source <redmcsb-source>/ReDMCSB_WIP20210206/Toolchains/Common/Source --original-dm <firestaff-data>/firestaff-original-games/DM`
