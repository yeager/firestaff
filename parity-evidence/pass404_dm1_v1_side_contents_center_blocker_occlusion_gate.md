...
## Firestaff guards
- `side contents gate before item/creature/projectile draws: tokens=m11_draw_dm1_side_contents_at_depth/blockingCenterDepth>=depth/m11_draw_dm1_f0115_floor_item_sprite (current m11_game_view.c:31294)`
- `F0128 per-depth interleave: side contents dispatch precedes the same-depth center contents route in m11_draw_viewport (current m11_game_view.c:42836)`
- `side explosion gate before deferred side explosion draw: tokens=m11_draw_dm1_deferred_explosion_pass/m11_dm1_nearest_blocking_center_depth_index/blockingCenterDepth>=depth/m11_draw_dm1_deferred_side_explosion (current m11_game_view.c:31632)`
