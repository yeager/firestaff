...
- `test_dm1_v1_input_command_queue_pc34_compat.c` — input queue probe covers keypad, PC-34 normalized arrow rows, shifted arrows, pending mouse replay, turn gate bypass, movement gate retention, and four-command queue capacity
