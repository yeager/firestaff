...
| 3 | `verification-screens/pass93-subagent-key-explore/image0003-raw.png` | `entrance_menu` | `` |  | dungeon entrance/menu controls still occupy the right column | `12d500d7b8d6` |
| 4 | `verification-screens/pass93-subagent-key-explore/image0004-raw.png` | `entrance_menu` | `` |  | dungeon entrance/menu controls still occupy the right column | `5ae7199a3df0` |
| 5 | `verification-screens/pass93-subagent-key-explore/image0005-raw.png` | `entrance_menu` | `` |  | dungeon entrance/menu controls still occupy the right column | `5ae7199a3df0` |
