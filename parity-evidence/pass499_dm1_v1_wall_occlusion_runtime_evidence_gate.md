...
- `wall_spec_table` ok=True line=1236
- `wall_spec_accessor_count` ok=True line=2813
- `wall_spec_accessor_by_square` ok=True line=2338
- `door_front_occlusion_specs` ok=True line=1010
...
- `public_wall_spec_type` ok=True line=730
- `public_door_front_spec_type` ok=True line=366
