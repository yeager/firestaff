...
- `wall_spec_table` ok=True line=1233
- `wall_spec_accessor_count` ok=True line=2810
- `wall_spec_accessor_by_square` ok=True line=2335
- `door_front_occlusion_specs` ok=True line=1007
...
- `public_wall_spec_type` ok=True line=721
- `public_door_front_spec_type` ok=True line=357
