...
- `wall_spec_table` ok=True line=1197
- `wall_spec_accessor_count` ok=True line=2774
- `wall_spec_accessor_by_square` ok=True line=2299
- `door_front_occlusion_specs` ok=True line=971
