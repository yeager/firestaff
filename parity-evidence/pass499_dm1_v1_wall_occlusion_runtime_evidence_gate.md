...
- `wall_spec_table` ok=True line=352
- `wall_spec_accessor_count` ok=True line=1095
- `wall_spec_accessor_by_square` ok=True line=1106
- `door_front_occlusion_specs` ok=True line=172
