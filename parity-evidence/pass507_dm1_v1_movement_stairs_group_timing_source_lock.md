...
- src/memory/memory_movement_pc34_compat.c:837 - empty-party exception and group block seam.
...
- src/memory/memory_sensor_execution_pc34_compat.c:388 - source-ordered enter/leave sensor walking.
