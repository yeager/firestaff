...
- src/memory/memory_movement_pc34_compat.c:849 - empty-party exception and group block seam.
...
- src/memory/memory_sensor_execution_pc34_compat.c:427 - source-ordered enter/leave sensor walking.
