...
- command: /usr/bin/python3 /home/trv2/work/firestaff-worktrees/pass601-dm1v1-gameplay-systems-source-lock-20260516/tools/verify_pass515_dm1_v1_d0_side_wall_occlusion_source_lock.py --check-only
  - returncode: 0
  - output tail:
~~~
PASS check-only
