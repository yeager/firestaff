...
- FAIL firestaff_existing_d0_side_wall_specs_cite_return_lines (dm1_v1_viewport_3d_pc34_compat.c:1185-1192)
  - Existing runtime metadata records direct D0 side-wall return evidence.

- FAIL firestaff_existing_d0_side_occlusion_orders_are_single_back_cells (dm1_v1_viewport_3d_pc34_compat.c:966-973)
  - Open D0 side lanes use one back cell each; wall is a separate return path.

- FAIL firestaff_viewport_test_covers_d0_side_wall_specs (test_dm1_v1_viewport_3d_pc34_compat.c:762-763)
