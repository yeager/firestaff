# Pass328 — DM1 V1 direct-PTY post-load route/timing probe

Status: `BLOCKED_PASS328_BREAKPOINT_ARMING_TIMING`
...
- Method: `direct PTY; run unarmed through load route; Alt+Pause post-load prompt; arm F0128 only after prompt`
- Direct hits: `{'f0128_23AD_40FE': False, 'f0097_2809_1EFF_after_f0128': False}`
- Blocker: `breakpoint arming timing`

Manifest: `parity-evidence/verification/pass328_dm1_v1_direct_pty_postload_route_timing/manifest.json`
