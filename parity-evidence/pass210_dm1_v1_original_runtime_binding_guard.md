...
- Stock FIRES: `$HOME/.openclaw/data/firestaff-original-games/DM/_canonical/dm1/DungeonMasterPC34/FIRES` size `94779` sha256 `ebf84045c3edbce7690b826eadbea2e278fbb4c0a3cc19a470552586f37712eb`.
...
## Artifacts
- Manifest: `<repo>/parity-evidence/verification/pass210_dm1_v1_original_runtime_binding_guard/manifest.json`
- Trace contract: `<repo>/parity-evidence/verification/pass210_dm1_v1_original_runtime_binding_guard/trace_binding_contract.json`
- Runtime trace template: `<repo>/parity-evidence/verification/pass210_dm1_v1_original_runtime_binding_guard/runtime_trace_template.json`
- Guarded runbook: `<repo>/parity-evidence/verification/pass210_dm1_v1_original_runtime_binding_guard/guarded_runtime_binding_runbook.md`
