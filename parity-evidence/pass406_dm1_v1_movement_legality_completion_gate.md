...
- `memory_movement_pc34_compat.c:462-547` / `F0702_MOVEMENT_TryMove_Compat` keeps the pre-step legality split.
- `memory_movement_pc34_compat.c:769-901` / `F0704_MOVEMENT_ResolvePostMoveEnvironment_Compat` keeps pit consequences post-step.
