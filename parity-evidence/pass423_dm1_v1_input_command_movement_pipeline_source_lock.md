...
- `cmake --build /dev/shm/firestaff-dm1 --target test_dm1_v1_input_command_queue_pc34_compat test_dm1_v1_movement_command_core_pc34_compat test_dm1_v1_command_movement_sensor_timing_pc34_compat -j2` — rc 0
- `ctest --test-dir /dev/shm/firestaff-dm1 --output-on-failure -R dm1_v1_input_command_queue_pc34_compat|dm1_v1_movement_command_core_pc34_compat|dm1_v1_command_movement_sensor_timing_pc34_compat` — rc 0
- `git diff --check` — rc 0
