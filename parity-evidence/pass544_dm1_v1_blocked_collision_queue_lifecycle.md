...
## Firestaff guards
- dm1_v1_input_command_queue_pc34_compat.c:526-568 pops and replays pending input before move dispatch.
- dm1_v1_input_command_queue_pc34_compat.c:294-321 preserves only reserved release/stop commands during discard and replays pending click after unlock.
- dm1_v1_movement_command_core_pc34_compat.c:410-617 returns from blocked collision before successful movement timing/cooldown.
