...
- tools: `{'dosbox': '/opt/homebrew/bin/dosbox', 'dosbox-debug': '/opt/homebrew/bin/dosbox-debug', 'dosbox-x': '/opt/homebrew/bin/dosbox-x', 'gdb': None, 'xvfb-run': None, 'xdotool': '/opt/homebrew/bin/xdotool'}`
