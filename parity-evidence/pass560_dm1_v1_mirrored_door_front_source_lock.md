...
- FAIL firestaff-mirrored-door-front-metadata (dm1_v1_viewport_3d_pc34_compat.c:283-290)

- FAIL firestaff-mirrored-door-front-runtime-test (test_dm1_v1_viewport_3d_pc34_compat.c:739-800)
...
- /opt/homebrew/opt/python@3.14/bin/python3.14 /Volumes/Extern-disk/firestaff-work/tools/verify_pass560_dm1_v1_mirrored_door_front_source_lock.py --check-only: rc=1
~~~
