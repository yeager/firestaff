...
- dm1_v1_movement_command_core_pc34_compat.c:447-533 keeps the same command-core blocked branch order.
- dm1_v1_movement_command_core_pc34_compat.c:80-123 records the source-locked self-damage request seam without claiming combat RNG/wound materialization.
