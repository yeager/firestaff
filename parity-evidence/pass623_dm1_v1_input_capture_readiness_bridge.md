...
- FAIL src/engine/m11_game_view.c:7106-7170 m11_input_maps_to_dm1_v1_commands - Firestaff route tokens enter the DM1 V1 queue as source command ids and process one compat tick
- FAIL src/engine/m11_game_view.c:7170-7305 m11_records_movement_pipeline_capture_state - capture rows can distinguish turn, step, blocked no-op, dirty viewport, and dequeued command
