...
- FAIL src/engine/m11_game_view.c:7295-7365 m11_input_maps_to_dm1_v1_commands - Firestaff route tokens enter the DM1 V1 queue as source command ids and process one compat tick
- FAIL src/engine/m11_game_view.c:7365-7510 m11_records_movement_pipeline_capture_state - capture rows can distinguish turn, step, blocked no-op, dirty viewport, and dequeued command
...
- PASS 01_start_south_1_3 inputs=[] commands=[] tuple={'map': 0, 'x': 1, 'y': 3, 'direction': 2} crop=01_start_south_1_3_viewport_224x136.ppm sha256=8d879bc0765ad6f20756b84630da78fa94c02eebdf61c8cf817ce02ada4dd712
