...
- Main worktree: `<firestaff-repo>`, branch `worker/n2-dm1v1-evidence-capture-20260505`, clean before this refresh.
...
- Required source/reference roots present:
  - `<redmcsb-source>/`
  - `<firestaff-original-games>/`
  - `<csbwin-source>/CSBWin/`
...
`0c7db4b test: fingerprint DM1 runtime symbol target` is **not** contained by current worker head; it lives on `<firestaff-repo>-pass228-original-runtime-trace-202605060015`, branch `worker/pass228-original-runtime-trace-202605060015`, ahead of `origin/main` by 4 commits.
