...
## Firestaff anchors
- m11_game_view.c:24252 firestaff_party_tuple_flip_predicate scope=whole-file-local-evidence status=FAIL
- m11_game_view.c:24258 firestaff_wallset_variant_binding_before_draw scope=whole-file-local-evidence status=FAIL
- m11_game_view.c:25043 firestaff_center_wall_flip_path scope=whole-file-local-evidence status=PASS
- m11_game_view.c:26296 firestaff_side_wall_lr_swap_path scope=whole-file-local-evidence status=FAIL
