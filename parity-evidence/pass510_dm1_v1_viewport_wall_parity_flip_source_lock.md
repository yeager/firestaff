...
## Firestaff anchors
- m11_game_view.c:12200 firestaff_party_tuple_flip_predicate scope=whole-file-local-evidence status=PASS
- m11_game_view.c:12206 firestaff_wallset_variant_binding_before_draw scope=whole-file-local-evidence status=PASS
- m11_game_view.c:12832 firestaff_center_wall_flip_path scope=whole-file-local-evidence status=PASS
- m11_game_view.c:13697 firestaff_side_wall_lr_swap_path scope=whole-file-local-evidence status=PASS
