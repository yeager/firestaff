...
- tools: `{'dosbox': '/opt/homebrew/bin/dosbox', 'dosbox-debug': None, 'dosbox-x': '/opt/homebrew/bin/dosbox-x', 'xvfb-run': None, 'xdotool': '/opt/homebrew/bin/xdotool', 'gdb': None, 'objdump': '/usr/bin/objdump', 'strings': '/usr/bin/strings'}`
