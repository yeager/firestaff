...
- If the legacy archive-cache fixture is retained for development research,
  replace its unavailable external-RAR premise with a self-contained
  development fixture. It is excluded from production builds; normal CSB
