...
| 5 | `verification-screens/pass212-n2-state-aware-movement-probe/image0005-raw.png` | `dungeon_gameplay` | `` |  | viewport content with mostly dark in-game right column | `48ed3743ab6a` |
| 6 | `verification-screens/pass212-n2-state-aware-movement-probe/image0006-raw.png` | `dungeon_gameplay` | `` |  | viewport content with mostly dark in-game right column | `48ed3743ab6a` |
