...
/* stripped for image frontend probe: #include "IMAGE3.C" */
/* stripped for image frontend probe: #include "FILLBOX.C" */
/* stripped for image frontend probe: #include "BLIT.C" */
/* stripped for image frontend probe: #include "EXPAND.C" */
...
/* stripped for image frontend probe: #include "DRAWVIEW.C" */
/* stripped for image frontend probe: #include "DRAWMSGA.C" */
...
/* END IMAGE.C frontend-only */

/* BEGIN byteops_pc34_compat.c */
#ifndef COMPILE_H
#include "COMPILE.H"
#endif
...
/* replaced by compat layer: #include "COPYBYTE.C" */
/* replaced by compat layer: #include "CLEARBYT.C" */
