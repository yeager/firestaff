...
Firestaff is an open-source engine project for **Dungeon Master** (1987), **Chaos Strikes Back** (1989), and **Dungeon Master II**, with planned **Dungeon Master Nexus** support after DM2. It preserves the feel and mechanics of the originals while making the engine portable, inspectable, testable, and ready for future enhanced presentations.
